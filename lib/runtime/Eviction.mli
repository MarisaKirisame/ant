...
val score_step : current_epoch:int -> State.step -> int
val trie_size : State.trie -> int
val memo_size : State.memo -> int
val stream_scores_from_trie : current_epoch:int -> kll:Kll.t -> State.trie -> unit
val stream_scores_from_memo : current_epoch:int -> kll:Kll.t -> State.memo -> unit
