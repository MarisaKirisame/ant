...
let int_list_Cons x0 x1 : Seq.seq =
  Seq.appends [ Seq.from_constructor 1; Seq.from_int x0; x1 ]
...
let rec list_incr =
 fun l ->
  match to_ocaml_int_list l with
  | Nil -> int_list_Nil
  | Cons (x, l) -> int_list_Cons (x + 1) (list_incr l)
