  ...
  add_exp
    (fun w_5 ->
      ...
      | c_17 when c_17 = tag_cont_17 ->
          ...
          push_env w_5 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_98; ctor_arg_97 ]);
          assert_env_length w_5 3;
          ignore (env_call w_5 [] 2);
          w_5.state.c <- pc_to_exp (int_to_pc 4);
          stepped w_5
      | c_17 when c_17 = tag_cont_18 ->
          ...
          push_env w_5 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_100; ctor_arg_99 ]);
          assert_env_length w_5 5;
          let ctor_arg_101 = pop_env w_5 in
          let ctor_arg_102 = pop_env w_5 in
          push_env w_5 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_102; ctor_arg_101 ]);
          assert_env_length w_5 4;
          ignore (env_call w_5 [] 2);
          w_5.state.c <- pc_to_exp (int_to_pc 4);
          stepped w_5
      | c_17 when c_17 = tag_cont_19 ->
          ...
          let ctor_arg_104 = pop_env w_5 in
          push_env w_5 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_104; ctor_arg_103 ]);
          assert_env_length w_5 1;
          drop_n w_5 1 0;
          assert_env_length w_5 1;
  ...
  add_exp
    (fun w_4 ->
      ...
      | c_2 when c_2 = tag_EMatchList ->
          ...
          let split2_1 = List.nth splits_16 2 in
          ignore (pop_env w_4);
  ...
  add_exp
    (fun w_6 ->
      ...
      | c_3 when c_3 = tag_VStuck ->
          let splits_18 = Memo.splits (snd x_3) in
          let split0_18 = List.nth splits_18 0 in
          ignore (pop_env w_6);
          push_env w_6 split0_18;
          assert_env_length w_6 4;
  ...
  add_exp
    (fun w_7 ->
      ...
      | c_4 when c_4 = tag_VStuck ->
          let splits_20 = Memo.splits (snd x_4) in
          let split0_20 = List.nth splits_20 0 in
          ignore (pop_env w_7);
          push_env w_7 split0_20;
          assert_env_length w_7 4;
  ...
  add_exp
    (fun w_8 ->
      ...
      | c_5 when c_5 = tag_VStuck ->
          let splits_22 = Memo.splits (snd x_5) in
          let split0_22 = List.nth splits_22 0 in
          ignore (pop_env w_8);
          push_env w_8 split0_22;
          assert_env_length w_8 4;
  ...
  add_exp
    (fun w_9 ->
      ...
      | c_6 when c_6 = tag_VStuck ->
          let splits_24 = Memo.splits (snd x_6) in
          let split0_24 = List.nth splits_24 0 in
          ignore (pop_env w_9);
          push_env w_9 split0_24;
          assert_env_length w_9 4;
  ...
  add_exp
    (fun w_10 ->
      ...
      | c_7 when c_7 = tag_VStuck ->
          let splits_26 = Memo.splits (snd x_7) in
          let split0_26 = List.nth splits_26 0 in
          ignore (pop_env w_10);
          push_env w_10 split0_26;
          assert_env_length w_10 4;
  ...
  add_exp
    (fun w_11 ->
      ...
      | c_8 when c_8 = tag_Some ->
          let splits_27 = Memo.splits (snd x_8) in
          let split0_27 = List.nth splits_27 0 in
          ignore (pop_env w_11);
          push_env w_11 split0_27;
          assert_env_length w_11 1;
  ...
  add_exp
    (fun w_12 ->
      ...
      | c_9 when c_9 = tag_VAbs ->
          ...
          let split1_11 = List.nth splits_28 1 in
          ignore (pop_env w_12);
      ...
      | c_9 when c_9 = tag_VFix ->
          ...
          let split1_12 = List.nth splits_29 1 in
          ignore (pop_env w_12);
      ...
      | c_9 when c_9 = tag_VStuck ->
          let splits_30 = Memo.splits (snd x_9) in
          let split0_30 = List.nth splits_30 0 in
          ignore (pop_env w_12);
          push_env w_12 split0_30;
          assert_env_length w_12 4;
          push_env w_12 (Dynarray.get w_12.state.e 3);
          assert_env_length w_12 5;
          push_env w_12 (Dynarray.get w_12.state.e 1);
  ...
  add_exp
    (fun w_13 ->
      ...
      | c_10 when c_10 = tag_VStuck ->
          let splits_31 = Memo.splits (snd x_10) in
          let split0_31 = List.nth splits_31 0 in
          ignore (pop_env w_13);
          push_env w_13 split0_31;
          assert_env_length w_13 4;
  ...
  add_exp
    (fun w_14 ->
      ...
      | c_11 when c_11 = tag_VCons ->
          ...
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_56; ctor_arg_55 ]);
          assert_env_length w_14 8;
          let ctor_arg_57 = pop_env w_14 in
          let ctor_arg_58 = pop_env w_14 in
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_58; ctor_arg_57 ]);
          assert_env_length w_14 7;
          ignore (env_call w_14 [] 2);
          w_14.state.c <- pc_to_exp (int_to_pc 4);
          stepped w_14
      | c_11 when c_11 = tag_VStuck ->
          let splits_33 = Memo.splits (snd x_11) in
          let split0_33 = List.nth splits_33 0 in
          ignore (pop_env w_14);
          push_env w_14 split0_33;
          assert_env_length w_14 4;
          push_env w_14 (Dynarray.get w_14.state.e 3);
          assert_env_length w_14 5;
          push_env w_14 (Dynarray.get w_14.state.e 1);
          ...
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_SMatchList; ctor_arg_61; ctor_arg_60; ctor_arg_59 ]);
          assert_env_length w_14 5;
          let ctor_arg_62 = pop_env w_14 in
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_62 ]);
          assert_env_length w_14 5;
          drop_n w_14 5 1;
          assert_env_length w_14 4;
          drop_n w_14 4 2;
      ...
      | vv ->
          ...
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_64; ctor_arg_63 ]);
          assert_env_length w_14 5;
          let ctor_arg_65 = pop_env w_14 in
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_65 ]);
          assert_env_length w_14 5;
          drop_n w_14 5 1;
          assert_env_length w_14 4;
          drop_n w_14 4 2;
...
let () =
  add_exp
    (fun w_16 ->
      ...
      push_env w_16 (Memo.appends [ Memo.from_constructor tag_VInt; ctor_arg_66 ]);
      assert_env_length w_16 5;
      drop_n w_16 5 1;
  ...
  add_exp
    (fun w_15 ->
      ...
      | c_12 when c_12 = tag_VStuck ->
          ...
          push_env w_15 (Memo.appends [ Memo.from_constructor tag_SAdd1; ctor_arg_68; ctor_arg_67 ]);
          assert_env_length w_15 5;
          let ctor_arg_69 = pop_env w_15 in
          push_env w_15 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_69 ]);
          assert_env_length w_15 5;
          drop_n w_15 5 1;
          assert_env_length w_15 4;
          drop_n w_15 4 1;
      ...
      | _ ->
          ...
          push_env w_15 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_71; ctor_arg_70 ]);
          assert_env_length w_15 4;
          let ctor_arg_72 = pop_env w_15 in
          push_env w_15 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_72 ]);
          assert_env_length w_15 4;
          drop_n w_15 4 1;
          assert_env_length w_15 3;
          drop_n w_15 3 1;
  ...
  add_exp
    (fun w_17 ->
      ...
      | c_13 when c_13 = tag_VStuck ->
          let splits_37 = Memo.splits (snd x_13) in
          let split0_37 = List.nth splits_37 0 in
          ignore (pop_env w_17);
          push_env w_17 split0_37;
          assert_env_length w_17 4;
          ...
          push_env w_17 (Memo.appends [ Memo.from_constructor tag_SGt1; ctor_arg_74; ctor_arg_73 ]);
          assert_env_length w_17 5;
          let ctor_arg_75 = pop_env w_17 in
          push_env w_17 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_75 ]);
          assert_env_length w_17 5;
          drop_n w_17 5 1;
          assert_env_length w_17 4;
          drop_n w_17 4 1;
      ...
      | _ ->
          ...
          push_env w_17 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_77; ctor_arg_76 ]);
          assert_env_length w_17 4;
  ...
  add_exp
    (fun w_19 ->
      ...
      | c_14 when c_14 = tag_VStuck ->
          let splits_39 = Memo.splits (snd x_14) in
          let split0_39 = List.nth splits_39 0 in
          ignore (pop_env w_19);
          push_env w_19 split0_39;
          assert_env_length w_19 4;
          ...
          push_env w_19 (Memo.appends [ Memo.from_constructor tag_SGt1; ctor_arg_80; ctor_arg_79 ]);
          assert_env_length w_19 5;
          let ctor_arg_81 = pop_env w_19 in
          push_env w_19 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_81 ]);
          assert_env_length w_19 5;
          drop_n w_19 5 1;
          assert_env_length w_19 4;
          drop_n w_19 4 1;
      ...
      | _ ->
          ...
          push_env w_19 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_83; ctor_arg_82 ]);
          assert_env_length w_19 4;
  ...
  add_exp
    (fun w_21 ->
      ...
      | c_15 when c_15 = tag_VStuck ->
          let splits_41 = Memo.splits (snd x_15) in
          let split0_41 = List.nth splits_41 0 in
          ignore (pop_env w_21);
          push_env w_21 split0_41;
          assert_env_length w_21 4;
          ...
          push_env w_21 (Memo.appends [ Memo.from_constructor tag_SGt1; ctor_arg_86; ctor_arg_85 ]);
          assert_env_length w_21 5;
          let ctor_arg_87 = pop_env w_21 in
          push_env w_21 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_87 ]);
          assert_env_length w_21 5;
          drop_n w_21 5 1;
          assert_env_length w_21 4;
          drop_n w_21 4 1;
      ...
      | _ ->
          ...
          push_env w_21 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_89; ctor_arg_88 ]);
          assert_env_length w_21 4;
  ...
  add_exp
    (fun w_23 ->
      ...
      | c_16 when c_16 = tag_VStuck ->
          let splits_43 = Memo.splits (snd x_16) in
          let split0_43 = List.nth splits_43 0 in
          ignore (pop_env w_23);
          push_env w_23 split0_43;
          assert_env_length w_23 4;
          ...
          push_env w_23 (Memo.appends [ Memo.from_constructor tag_SGt1; ctor_arg_92; ctor_arg_91 ]);
          assert_env_length w_23 5;
          let ctor_arg_93 = pop_env w_23 in
          push_env w_23 (Memo.appends [ Memo.from_constructor tag_VStuck; ctor_arg_93 ]);
          assert_env_length w_23 5;
          drop_n w_23 5 1;
          assert_env_length w_23 4;
          drop_n w_23 4 1;
      ...
      | _ ->
          ...
          push_env w_23 (Memo.appends [ Memo.from_constructor tag_STypeError; ctor_arg_95; ctor_arg_94 ]);
          assert_env_length w_23 4;
