...
let populate_state () =
  ...
  add_exp
    (fun w_109 ->
      ...
      | 56 (* tag_cont_0 *) ->
          ...
          restore_env_slots w_109 [ 0; 2 ] tl_0;
          set_env_slot w_109 1 ret_0;
  ...
  add_exp
    (fun w_105 ->
      ...
      let arg0_30 = get_env_slot w_105 2 in
  ...
  add_exp
    (fun w_106 ->
      ...
      assert_env_length w_106 3;
      let resolved_31 = resolve w_106 (Source.E 1) in
      let tag_17 = Word.get_value (fst resolved_31) in
      match tag_17 with
      | 1 (* tag_Z *) ->
          let rsh0_14 = get_env_slot w_106 0 in
          init_frame w_106 1 (Memo.from_int 0);
          set_env_slot w_106 0 rsh0_14;
      ...
      | 2 (* tag_S *) ->
          ...
          if List.length parts_49 = 1 then (
            ...
            let edge0_53 = get_env_slot w_106 2 in
            let edge1_44 = part0_49 in
            init_frame w_106 3 (Memo.from_int 0);
            set_env_slot w_106 2 edge0_53;
            set_env_slot w_106 0 edge1_44;
    ...
    (fun w_108 ->
      ...
      | 4 (* tag_Cons *) ->
          ...
          if List.length parts_50 = 2 then (
            ...
            let edge0_54 = get_env_slot w_108 1 in
            let edge1_45 = part0_50 in
            let edge2_21 = part1_16 in
            init_frame w_108 3 (Memo.from_int 0);
            set_env_slot w_108 1 edge0_54;
            set_env_slot w_108 0 edge1_45;
  ...
  add_exp
    (fun w_2 ->
      ...
      assert_env_length w_2 3;
      set_env_slot w_2 0 (Memo.appends [ Memo.from_constructor tag_SAdd1; get_env_slot w_2 2; get_env_slot w_2 0 ]);
      assert_env_length w_2 3;
  ...
  add_exp
    (fun w_3 ->
      ...
      assert_env_length w_3 2;
      set_env_slot w_3 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_3 1; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_3 2;
  ...
  add_exp
    (fun w_4 ->
      ...
      let arg1_0 = get_env_slot w_4 1 in
      assert_env_length w_4 4;
      w_4.state.k <- Memo.appends [ Memo.from_constructor tag_cont_0; collect_env_slots w_4 [ 0; 2 ]; w_4.state.k ];
  ...
  add_exp
    (fun w_7 ->
      ...
      assert_env_length w_7 3;
      set_env_slot w_7 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_7 2; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_7 3;
  ...
  add_exp
    (fun w_8 ->
      ...
      let arg1_1 = get_env_slot w_8 1 in
      assert_env_length w_8 3;
  ...
  add_exp
    (fun w_13 ->
      ...
      assert_env_length w_13 3;
      set_env_slot w_13 0 (Memo.appends [ Memo.from_constructor tag_SGt1; get_env_slot w_13 2; get_env_slot w_13 0 ]);
      assert_env_length w_13 3;
  ...
  add_exp
    (fun w_14 ->
      ...
      assert_env_length w_14 2;
      set_env_slot w_14 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_14 1; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_14 2;
  ...
  add_exp
    (fun w_15 ->
      ...
      let arg1_2 = get_env_slot w_15 1 in
      assert_env_length w_15 4;
      w_15.state.k <- Memo.appends [ Memo.from_constructor tag_cont_2; collect_env_slots w_15 [ 0; 2 ]; w_15.state.k ];
  ...
  add_exp
    (fun w_18 ->
      ...
      assert_env_length w_18 3;
      set_env_slot w_18 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_18 2; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_18 3;
  ...
  add_exp
    (fun w_19 ->
      ...
      let arg1_3 = get_env_slot w_19 1 in
      assert_env_length w_19 3;
  ...
  add_exp
    (fun w_24 ->
      ...
      assert_env_length w_24 3;
      set_env_slot w_24 0 (Memo.appends [ Memo.from_constructor tag_SGt1; get_env_slot w_24 2; get_env_slot w_24 0 ]);
      assert_env_length w_24 3;
  ...
  add_exp
    (fun w_25 ->
      ...
      assert_env_length w_25 2;
      set_env_slot w_25 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_25 1; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_25 2;
  ...
  add_exp
    (fun w_26 ->
      ...
      let arg1_4 = get_env_slot w_26 1 in
      assert_env_length w_26 4;
      w_26.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; collect_env_slots w_26 [ 0; 2 ]; w_26.state.k ];
  ...
  add_exp
    (fun w_29 ->
      ...
      assert_env_length w_29 3;
      set_env_slot w_29 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_29 2; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_29 3;
  ...
  add_exp
    (fun w_30 ->
      ...
      let arg1_5 = get_env_slot w_30 1 in
      assert_env_length w_30 3;
  ...
  add_exp
    (fun w_35 ->
      ...
      assert_env_length w_35 3;
      set_env_slot w_35 0 (Memo.appends [ Memo.from_constructor tag_SGt1; get_env_slot w_35 2; get_env_slot w_35 0 ]);
      assert_env_length w_35 3;
  ...
  add_exp
    (fun w_36 ->
      ...
      assert_env_length w_36 2;
      set_env_slot w_36 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_36 1; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_36 2;
  ...
  add_exp
    (fun w_37 ->
      ...
      let arg1_6 = get_env_slot w_37 1 in
      assert_env_length w_37 4;
      w_37.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; collect_env_slots w_37 [ 0; 2 ]; w_37.state.k ];
  ...
  add_exp
    (fun w_40 ->
      ...
      assert_env_length w_40 3;
      set_env_slot w_40 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_40 2; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_40 3;
  ...
  add_exp
    (fun w_41 ->
      ...
      let arg1_7 = get_env_slot w_41 1 in
      assert_env_length w_41 3;
  ...
  add_exp
    (fun w_46 ->
      ...
      assert_env_length w_46 3;
      set_env_slot w_46 0 (Memo.appends [ Memo.from_constructor tag_SGt1; get_env_slot w_46 2; get_env_slot w_46 0 ]);
      assert_env_length w_46 3;
  ...
  add_exp
    (fun w_47 ->
      ...
      assert_env_length w_47 2;
      set_env_slot w_47 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_47 1; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_47 2;
  ...
  add_exp
    (fun w_48 ->
      ...
      let arg1_8 = get_env_slot w_48 1 in
      assert_env_length w_48 4;
      w_48.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; collect_env_slots w_48 [ 0; 2 ]; w_48.state.k ];
  ...
  add_exp
    (fun w_51 ->
      ...
      assert_env_length w_51 3;
      set_env_slot w_51 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_51 2; Memo.from_constructor tag_VTInt ]);
      assert_env_length w_51 3;
  ...
  add_exp
    (fun w_52 ->
      ...
      let arg1_9 = get_env_slot w_52 1 in
      assert_env_length w_52 3;
  ...
  add_exp
    (fun w_56 ->
      ...
      let arg0_10 = get_env_slot w_56 1 in
      let arg1_10 = get_env_slot w_56 0 in
      assert_env_length w_56 2;
  ...
  add_exp
    (fun w_58 ->
      ...
      assert_env_length w_58 2;
      set_env_slot w_58 0 (Memo.appends [ Memo.from_constructor tag_VAbs; get_env_slot w_58 0; get_env_slot w_58 1 ]);
  ...
  add_exp
    (fun w_61 ->
      ...
      assert_env_length w_61 2;
      set_env_slot w_61 0 (Memo.appends [ Memo.from_constructor tag_VFix; get_env_slot w_61 0; get_env_slot w_61 1 ]);
  ...
  add_exp
    (fun w_67 ->
      ...
      assert_env_length w_67 3;
      set_env_slot w_67 0
        (Memo.appends [ Memo.from_constructor tag_STypeError; get_env_slot w_67 2; Memo.from_constructor tag_VTFunc ]);
      assert_env_length w_67 3;
  ...
  add_exp
    (fun w_68 ->
      ...
      let arg1_17 = get_env_slot w_68 1 in
      assert_env_length w_68 3;
  ...
  add_exp
    (fun w_73 ->
      ...
      let arg0_18 = get_env_slot w_73 0 in
      let arg1_18 = get_env_slot w_73 1 in
      assert_env_length w_73 2;
  ...
  add_exp
    (fun w_74 ->
      ...
      let arg1_19 = get_env_slot w_74 1 in
      assert_env_length w_74 3;
  ...
  add_exp
    (fun w_75 ->
      ...
      assert_env_length w_75 3;
      set_env_slot w_75 0
        (Memo.appends [ Memo.from_constructor tag_SIf; get_env_slot w_75 1; get_env_slot w_75 0; get_env_slot w_75 2 ]);
      assert_env_length w_75 3;
  ...
  add_exp
    (fun w_77 ->
      ...
      let arg1_20 = get_env_slot w_77 1 in
      assert_env_length w_77 4;
      w_77.state.k <-
  ...
  add_exp
    (fun w_80 ->
      ...
      let arg1_21 = get_env_slot w_80 1 in
      assert_env_length w_80 3;
  ...
  add_exp
    (fun w_83 ->
      ...
      let arg1_23 = get_env_slot w_83 1 in
      assert_env_length w_83 3;
  ...
  add_exp
    (fun w_89 ->
      ...
      let arg0_25 = get_env_slot w_89 0 in
      let arg1_25 = get_env_slot w_89 1 in
      assert_env_length w_89 2;
  ...
  add_exp
    (fun w_94 ->
      ...
      let arg0_26 = get_env_slot w_94 0 in
      let arg1_26 = get_env_slot w_94 1 in
      assert_env_length w_94 2;
  ...
  add_exp
    (fun w_96 ->
      ...
      let arg0_27 = get_env_slot w_96 0 in
      let arg1_27 = get_env_slot w_96 1 in
      assert_env_length w_96 2;
  ...
  add_exp
    (fun w_97 ->
      ...
      assert_env_length w_97 4;
      set_env_slot w_97 1 (Memo.appends [ Memo.from_constructor tag_Cons; get_env_slot w_97 3; get_env_slot w_97 1 ]);
      assert_env_length w_97 4;
      set_env_slot w_97 0 (Memo.appends [ Memo.from_constructor tag_Cons; get_env_slot w_97 0; get_env_slot w_97 1 ]);
      let arg0_28 = get_env_slot w_97 2 in
  ...
  add_exp
    (fun w_98 ->
      ...
      set_env_slot w_98 0
        (Memo.appends
           [ Memo.from_constructor tag_SMatchList; get_env_slot w_98 1; get_env_slot w_98 0; get_env_slot w_98 2 ]);
      assert_env_length w_98 3;
  ...
  add_exp
    (fun w_100 ->
      ...
      let arg1_29 = get_env_slot w_100 1 in
      assert_env_length w_100 4;
      w_100.state.k <-
    ...
    (fun w_103 ->
      ...
      | 7 (* tag_EInt *) ->
          ...
          if List.length parts_31 = 1 then (
            ...
            let edge0_35 = part0_31 in
            init_frame w_103 1 (Memo.from_int 0);
            set_env_slot w_103 0 edge0_35;
      ...
      | 8 (* tag_EPlus *) ->
          ...
          if List.length parts_32 = 2 then (
            ...
            let edge0_36 = get_env_slot w_103 1 in
            let edge1_28 = part0_32 in
            let edge2_10 = part1_5 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_36;
            set_env_slot w_103 2 edge1_28;
            set_env_slot w_103 0 edge2_10;
      ...
      | 9 (* tag_ELt *) ->
          ...
          if List.length parts_33 = 2 then (
            ...
            let edge0_37 = get_env_slot w_103 1 in
            let edge1_29 = part0_33 in
            let edge2_11 = part1_6 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_37;
            set_env_slot w_103 2 edge1_29;
            set_env_slot w_103 0 edge2_11;
      ...
      | 10 (* tag_ELe *) ->
          ...
          if List.length parts_34 = 2 then (
            ...
            let edge0_38 = get_env_slot w_103 1 in
            let edge1_30 = part0_34 in
            let edge2_12 = part1_7 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_38;
            set_env_slot w_103 2 edge1_30;
            set_env_slot w_103 0 edge2_12;
      ...
      | 11 (* tag_EGt *) ->
          ...
          if List.length parts_35 = 2 then (
            ...
            let edge0_39 = get_env_slot w_103 1 in
            let edge1_31 = part0_35 in
            let edge2_13 = part1_8 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_39;
            set_env_slot w_103 2 edge1_31;
            set_env_slot w_103 0 edge2_13;
      ...
      | 12 (* tag_EGe *) ->
          ...
          if List.length parts_36 = 2 then (
            ...
            let edge0_40 = get_env_slot w_103 1 in
            let edge1_32 = part0_36 in
            let edge2_14 = part1_9 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_40;
            set_env_slot w_103 2 edge1_32;
            set_env_slot w_103 0 edge2_14;
      ...
      | 13 (* tag_EVar *) ->
          ...
          if List.length parts_37 = 1 then (
            ...
            let edge0_41 = get_env_slot w_103 1 in
            let edge1_33 = part0_37 in
            init_frame w_103 2 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_41;
            set_env_slot w_103 0 edge1_33;
      ...
      | 14 (* tag_EAbs *) ->
          ...
          if List.length parts_38 = 1 then (
            ...
            let edge0_42 = get_env_slot w_103 1 in
            let edge1_34 = part0_38 in
            init_frame w_103 2 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_42;
            set_env_slot w_103 0 edge1_34;
      ...
      | 16 (* tag_ELet *) ->
          ...
          if List.length parts_39 = 2 then (
            ...
            let edge0_43 = get_env_slot w_103 1 in
            let edge1_35 = part0_39 in
            let edge2_15 = part1_10 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_43;
      ...
      | 26 (* tag_EFix *) ->
          ...
          if List.length parts_40 = 1 then (
            ...
            let edge0_44 = get_env_slot w_103 1 in
            let edge1_36 = part0_40 in
            init_frame w_103 2 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_44;
            set_env_slot w_103 0 edge1_36;
      ...
      | 15 (* tag_EApp *) ->
          ...
          if List.length parts_41 = 2 then (
            ...
            let edge0_45 = get_env_slot w_103 1 in
            let edge1_37 = part0_41 in
            let edge2_16 = part1_11 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_45;
            set_env_slot w_103 2 edge1_37;
            set_env_slot w_103 0 edge2_16;
      ...
      | 27 (* tag_EHole *) ->
          ...
          if List.length parts_42 = 1 then (
            ...
            let edge0_46 = part0_42 in
            init_frame w_103 1 (Memo.from_int 0);
            set_env_slot w_103 0 edge0_46;
      ...
      | 19 (* tag_EIf *) ->
          ...
          if List.length parts_43 = 3 then (
            ...
            let edge0_47 = get_env_slot w_103 1 in
            let edge1_38 = part0_43 in
            let edge2_17 = part1_12 in
            let edge3_8 = part2_0 in
            init_frame w_103 4 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_47;
            set_env_slot w_103 3 edge1_38;
            set_env_slot w_103 0 edge2_17;
      ...
      | 21 (* tag_ECons *) ->
          ...
          if List.length parts_44 = 2 then (
            ...
            let edge0_48 = get_env_slot w_103 1 in
            let edge1_39 = part0_44 in
            let edge2_18 = part1_13 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_48;
            set_env_slot w_103 2 edge1_39;
            set_env_slot w_103 0 edge2_18;
      ...
      | 23 (* tag_EPair *) ->
          ...
          if List.length parts_45 = 2 then (
            ...
            let edge0_49 = get_env_slot w_103 1 in
            let edge1_40 = part0_45 in
            let edge2_19 = part1_14 in
            init_frame w_103 3 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_49;
            set_env_slot w_103 2 edge1_40;
            set_env_slot w_103 0 edge2_19;
      ...
      | 24 (* tag_EZro *) ->
          ...
          if List.length parts_46 = 1 then (
            ...
            let edge1_41 = part0_46 in
            init_frame w_103 2 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_50;
            set_env_slot w_103 0 edge1_41;
      ...
      | 25 (* tag_EFst *) ->
          ...
          if List.length parts_47 = 1 then (
            ...
            let edge1_42 = part0_47 in
            init_frame w_103 2 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_51;
            set_env_slot w_103 0 edge1_42;
      ...
      | 22 (* tag_EMatchList *) ->
          ...
          if List.length parts_48 = 3 then (
            ...
            let edge1_43 = part0_48 in
            let edge2_20 = part1_15 in
            let edge3_9 = part2_1 in
            init_frame w_103 4 (Memo.from_int 0);
            set_env_slot w_103 1 edge0_52;
            set_env_slot w_103 3 edge1_43;
            set_env_slot w_103 0 edge2_20;
  ...
  add_exp
    (fun w_5 ->
      ...
      assert_env_length w_5 4;
      let resolved_2 = resolve w_5 (Source.E 1) in
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_0 = 1 then (
            ...
            let edge0_0 = get_env_slot w_5 0 in
            ...
            let rsh0_0 = get_env_slot w_5 1 in
            init_frame w_5 2 (Memo.from_int 0);
            set_env_slot w_5 1 rsh0_0;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_1 = 1 then (
            ...
            let edge0_1 = get_env_slot w_5 2 in
            let edge1_1 = part0_1 in
            init_frame w_5 3 (Memo.from_int 0);
            set_env_slot w_5 2 edge0_1;
    ...
    (fun w_9 ->
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_3 = 1 then (
            ...
            let edge0_3 = get_env_slot w_9 0 in
  ...
  add_exp
    (fun w_16 ->
      ...
      assert_env_length w_16 4;
      let resolved_7 = resolve w_16 (Source.E 1) in
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_4 = 1 then (
            ...
            let edge0_4 = get_env_slot w_16 0 in
            let edge1_4 = part0_4 in
            init_frame w_16 2 (Memo.from_int 0);
            set_env_slot w_16 0 edge0_4;
            set_env_slot w_16 1 edge1_4;
            w_16.state.c <- pc_to_exp (int_to_pc 14))
          else
            let rsh0_2 = get_env_slot w_16 1 in
            init_frame w_16 2 (Memo.from_int 0);
            set_env_slot w_16 1 rsh0_2;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_5 = 1 then (
            ...
            let edge0_5 = get_env_slot w_16 2 in
            let edge1_5 = part0_5 in
            init_frame w_16 3 (Memo.from_int 0);
            set_env_slot w_16 2 edge0_5;
    ...
    (fun w_20 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_6 = 1 then (
            ...
            let edge0_6 = get_env_slot w_20 1 in
            let edge1_6 = get_env_slot w_20 0 in
            let edge2_1 = get_env_slot w_20 2 in
            let edge3_1 = part0_6 in
            init_frame w_20 4 (Memo.from_int 0);
            set_env_slot w_20 1 edge0_6;
            set_env_slot w_20 3 edge1_6;
            set_env_slot w_20 2 edge2_1;
            set_env_slot w_20 0 edge3_1;
            w_20.state.c <- pc_to_exp (int_to_pc 19))
          else
            let rsh0_3 = get_env_slot w_20 2 in
            init_frame w_20 3 (Memo.from_int 0);
            set_env_slot w_20 2 rsh0_3;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_7 = 1 then (
            ...
            let edge0_7 = get_env_slot w_20 0 in
            let edge1_7 = part0_7 in
            init_frame w_20 2 (Memo.from_int 0);
            set_env_slot w_20 0 edge0_7;
  ...
  add_exp
    (fun w_27 ->
      ...
      assert_env_length w_27 4;
      let resolved_12 = resolve w_27 (Source.E 1) in
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_8 = 1 then (
            ...
            let edge0_8 = get_env_slot w_27 0 in
            let edge1_8 = part0_8 in
            init_frame w_27 2 (Memo.from_int 0);
            set_env_slot w_27 0 edge0_8;
            set_env_slot w_27 1 edge1_8;
            w_27.state.c <- pc_to_exp (int_to_pc 23))
          else
            let rsh0_4 = get_env_slot w_27 1 in
            init_frame w_27 2 (Memo.from_int 0);
            set_env_slot w_27 1 rsh0_4;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_9 = 1 then (
            ...
            let edge0_9 = get_env_slot w_27 2 in
            let edge1_9 = part0_9 in
            init_frame w_27 3 (Memo.from_int 0);
            set_env_slot w_27 2 edge0_9;
    ...
    (fun w_31 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_10 = 1 then (
            ...
            let edge0_10 = get_env_slot w_31 1 in
            let edge1_10 = get_env_slot w_31 0 in
            let edge2_2 = get_env_slot w_31 2 in
            let edge3_2 = part0_10 in
            init_frame w_31 4 (Memo.from_int 0);
            set_env_slot w_31 1 edge0_10;
            set_env_slot w_31 3 edge1_10;
            set_env_slot w_31 2 edge2_2;
            set_env_slot w_31 0 edge3_2;
            w_31.state.c <- pc_to_exp (int_to_pc 28))
          else
            let rsh0_5 = get_env_slot w_31 2 in
            init_frame w_31 3 (Memo.from_int 0);
            set_env_slot w_31 2 rsh0_5;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_11 = 1 then (
            ...
            let edge0_11 = get_env_slot w_31 0 in
            let edge1_11 = part0_11 in
            init_frame w_31 2 (Memo.from_int 0);
            set_env_slot w_31 0 edge0_11;
  ...
  add_exp
    (fun w_38 ->
      ...
      assert_env_length w_38 4;
      let resolved_17 = resolve w_38 (Source.E 1) in
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_12 = 1 then (
            ...
            let edge0_12 = get_env_slot w_38 0 in
            let edge1_12 = part0_12 in
            init_frame w_38 2 (Memo.from_int 0);
            set_env_slot w_38 0 edge0_12;
            set_env_slot w_38 1 edge1_12;
            w_38.state.c <- pc_to_exp (int_to_pc 32))
          else
            let rsh0_6 = get_env_slot w_38 1 in
            init_frame w_38 2 (Memo.from_int 0);
            set_env_slot w_38 1 rsh0_6;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_13 = 1 then (
            ...
            let edge0_13 = get_env_slot w_38 2 in
            let edge1_13 = part0_13 in
            init_frame w_38 3 (Memo.from_int 0);
            set_env_slot w_38 2 edge0_13;
    ...
    (fun w_42 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_14 = 1 then (
            ...
            let edge0_14 = get_env_slot w_42 1 in
            let edge1_14 = get_env_slot w_42 0 in
            let edge2_3 = get_env_slot w_42 2 in
            let edge3_3 = part0_14 in
            init_frame w_42 4 (Memo.from_int 0);
            set_env_slot w_42 1 edge0_14;
            set_env_slot w_42 3 edge1_14;
            set_env_slot w_42 2 edge2_3;
            set_env_slot w_42 0 edge3_3;
            w_42.state.c <- pc_to_exp (int_to_pc 37))
          else
            let rsh0_7 = get_env_slot w_42 2 in
            init_frame w_42 3 (Memo.from_int 0);
            set_env_slot w_42 2 rsh0_7;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_15 = 1 then (
            ...
            let edge0_15 = get_env_slot w_42 0 in
            let edge1_15 = part0_15 in
            init_frame w_42 2 (Memo.from_int 0);
            set_env_slot w_42 0 edge0_15;
  ...
  add_exp
    (fun w_49 ->
      ...
      assert_env_length w_49 4;
      let resolved_22 = resolve w_49 (Source.E 1) in
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_16 = 1 then (
            ...
            let edge0_16 = get_env_slot w_49 0 in
            let edge1_16 = part0_16 in
            init_frame w_49 2 (Memo.from_int 0);
            set_env_slot w_49 0 edge0_16;
            set_env_slot w_49 1 edge1_16;
            w_49.state.c <- pc_to_exp (int_to_pc 41))
          else
            let rsh0_8 = get_env_slot w_49 1 in
            init_frame w_49 2 (Memo.from_int 0);
            set_env_slot w_49 1 rsh0_8;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_17 = 1 then (
            ...
            let edge0_17 = get_env_slot w_49 2 in
            let edge1_17 = part0_17 in
            init_frame w_49 3 (Memo.from_int 0);
            set_env_slot w_49 2 edge0_17;
    ...
    (fun w_53 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          if List.length parts_18 = 1 then (
            ...
            let edge0_18 = get_env_slot w_53 1 in
            let edge1_18 = get_env_slot w_53 0 in
            let edge2_4 = get_env_slot w_53 2 in
            let edge3_4 = part0_18 in
            init_frame w_53 4 (Memo.from_int 0);
            set_env_slot w_53 1 edge0_18;
            set_env_slot w_53 3 edge1_18;
            set_env_slot w_53 2 edge2_4;
            set_env_slot w_53 0 edge3_4;
            w_53.state.c <- pc_to_exp (int_to_pc 46))
          else
            let rsh0_9 = get_env_slot w_53 2 in
            init_frame w_53 3 (Memo.from_int 0);
            set_env_slot w_53 2 rsh0_9;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_19 = 1 then (
            ...
            let edge0_19 = get_env_slot w_53 0 in
            let edge1_19 = part0_19 in
            init_frame w_53 2 (Memo.from_int 0);
            set_env_slot w_53 0 edge0_19;
    ...
    (fun w_57 ->
      ...
      | 6 (* tag_Some *) ->
          ...
          if List.length parts_20 = 1 then (
            ...
            let edge0_20 = part0_20 in
            init_frame w_57 1 (Memo.from_int 0);
            set_env_slot w_57 0 edge0_20;
    ...
    (fun w_69 ->
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_23 = 1 then (
            ...
            let edge0_23 = get_env_slot w_69 0 in
            let edge1_22 = part0_23 in
            init_frame w_69 2 (Memo.from_int 0);
            set_env_slot w_69 0 edge0_23;
  ...
  add_exp
    (fun w_78 ->
      ...
      match tag_12 with
      | 32 (* tag_VTrue *) ->
          let rsh0_11 = get_env_slot w_78 1 in
          let rsh1_0 = get_env_slot w_78 0 in
          init_frame w_78 2 (Memo.from_int 0);
          set_env_slot w_78 1 rsh0_11;
          set_env_slot w_78 0 rsh1_0;
          w_78.state.c <- pc_to_exp (int_to_pc 64)
      | 33 (* tag_VFalse *) ->
          let rsh0_12 = get_env_slot w_78 1 in
          let rsh1_1 = get_env_slot w_78 2 in
          init_frame w_78 3 (Memo.from_int 0);
          set_env_slot w_78 1 rsh0_12;
          set_env_slot w_78 2 rsh1_1;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_24 = 1 then (
            ...
            let edge0_25 = get_env_slot w_78 0 in
            let edge1_23 = get_env_slot w_78 2 in
            let edge2_7 = part0_24 in
            init_frame w_78 3 (Memo.from_int 0);
            set_env_slot w_78 0 edge0_25;
            set_env_slot w_78 2 edge1_23;
            set_env_slot w_78 1 edge2_7;
            w_78.state.c <- pc_to_exp (int_to_pc 66))
          else
            let edge0_24 = get_env_slot w_78 3 in
            init_frame w_78 1 (Memo.from_int 0);
            set_env_slot w_78 0 edge0_24;
  ...
  add_exp
    (fun w_81 ->
      ...
      let arg0_22 = get_env_slot w_81 0 in
      let arg1_22 = get_env_slot w_81 1 in
      assert_env_length w_81 3;
  ...
  add_exp
    (fun w_84 ->
      ...
      let arg0_24 = get_env_slot w_84 0 in
      let arg1_24 = get_env_slot w_84 1 in
      assert_env_length w_84 3;
    ...
    (fun w_90 ->
      ...
      | 36 (* tag_VPair *) ->
          ...
          if List.length parts_25 = 2 then (
            ...
            let edge0_27 = part0_25 in
            let edge1_24 = part1_2 in
            init_frame w_90 1 (Memo.from_int 0);
            set_env_slot w_90 0 edge0_27;
            set_env_slot w_90 0 edge1_24;
            w_90.state.c <- pc_to_exp (int_to_pc 72))
          else
            let edge0_26 = get_env_slot w_90 0 in
            init_frame w_90 1 (Memo.from_int 0);
            set_env_slot w_90 0 edge0_26;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_26 = 1 then (
            ...
            let edge0_28 = part0_26 in
            init_frame w_90 1 (Memo.from_int 0);
            set_env_slot w_90 0 edge0_28;
    ...
    (fun w_95 ->
      ...
      | 36 (* tag_VPair *) ->
          ...
          if List.length parts_27 = 2 then (
            ...
            let edge0_30 = part0_27 in
            let edge1_25 = part1_3 in
            init_frame w_95 1 (Memo.from_int 0);
            set_env_slot w_95 0 edge0_30;
            set_env_slot w_95 0 edge1_25;
            w_95.state.c <- pc_to_exp (int_to_pc 76))
          else
            let edge0_29 = get_env_slot w_95 0 in
            init_frame w_95 1 (Memo.from_int 0);
            set_env_slot w_95 0 edge0_29;
  ...
  add_exp
    (fun w_101 ->
      ...
      match tag_15 with
      | 34 (* tag_VNil *) ->
          let rsh0_13 = get_env_slot w_101 1 in
          let rsh1_2 = get_env_slot w_101 0 in
          init_frame w_101 2 (Memo.from_int 0);
          set_env_slot w_101 1 rsh0_13;
          set_env_slot w_101 0 rsh1_2;
      ...
      | 35 (* tag_VCons *) ->
          ...
          if List.length parts_29 = 2 then (
            ...
            let edge0_33 = get_env_slot w_101 1 in
            let edge1_26 = get_env_slot w_101 2 in
            let edge2_8 = part0_29 in
            let edge3_7 = part1_4 in
            init_frame w_101 4 (Memo.from_int 0);
            set_env_slot w_101 1 edge0_33;
            set_env_slot w_101 2 edge1_26;
            set_env_slot w_101 3 edge2_8;
            set_env_slot w_101 0 edge3_7;
            w_101.state.c <- pc_to_exp (int_to_pc 81))
          else
            let edge0_32 = get_env_slot w_101 3 in
            init_frame w_101 1 (Memo.from_int 0);
            set_env_slot w_101 0 edge0_32;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          if List.length parts_30 = 1 then (
            ...
            let edge0_34 = get_env_slot w_101 0 in
            let edge1_27 = get_env_slot w_101 2 in
            let edge2_9 = part0_30 in
            init_frame w_101 3 (Memo.from_int 0);
            set_env_slot w_101 0 edge0_34;
            set_env_slot w_101 2 edge1_27;
            set_env_slot w_101 1 edge2_9;
