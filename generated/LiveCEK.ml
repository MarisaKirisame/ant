...
let populate_state () =
  ...
  add_exp
    (fun w_3 ->
      ...
      | 56 (* tag_cont_1 *) ->
          ...
          restore_env w_3 0 tl_0;
          assert_env_length w_3 1;
          return_n w_3 0 (pc_to_exp (int_to_pc 0))
      | 57 (* tag_cont_2 *) ->
          w_3.state.k <- get_next_cont tl_0;
      ...
      | 63 (* tag_cont_8 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          Dynarray.set w_3.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_3.state.e 2; Dynarray.get w_3.state.e 0 ]);
          assert_env_length w_3 3;
          let keep_20 = env_call w_3 [] [ 1; 0 ] in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_21; keep_20; w_3.state.k ];
          w_3.state.c <- pc_to_exp (int_to_pc 3)
      | 64 (* tag_cont_9 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          assert_env_length w_3 3;
          w_3.state.c <- pc_to_exp (int_to_pc 10)
      | 65 (* tag_cont_10 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 3 tl_0;
          assert_env_length w_3 4;
          w_3.state.c <- pc_to_exp (int_to_pc 11)
      | 66 (* tag_cont_11 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          assert_env_length w_3 3;
          let keep_25 = env_call w_3 [ 2 ] [ 1; 0 ] in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_26; keep_25; w_3.state.k ];
          w_3.state.c <- pc_to_exp (int_to_pc 3)
      | 67 (* tag_cont_12 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          assert_env_length w_3 3;
          let keep_26 = env_call w_3 [ 2 ] [ 1; 0 ] in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_27; keep_26; w_3.state.k ];
          w_3.state.c <- pc_to_exp (int_to_pc 3)
      | 68 (* tag_cont_13 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 0 tl_0;
          assert_env_length w_3 1;
          w_3.state.c <- pc_to_exp (int_to_pc 12)
      | 69 (* tag_cont_14 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 0 tl_0;
          assert_env_length w_3 1;
          w_3.state.c <- pc_to_exp (int_to_pc 13)
      | 70 (* tag_cont_15 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 3 tl_0;
          assert_env_length w_3 4;
          w_3.state.c <- pc_to_exp (int_to_pc 14)
      | 71 (* tag_cont_16 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          assert_env_length w_3 3;
      ...
      | 77 (* tag_cont_22 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 2 tl_0;
          Dynarray.set w_3.state.e 1
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_3.state.e 2; Dynarray.get w_3.state.e 1 ]);
          assert_env_length w_3 3;
          let keep_29 = env_call w_3 [] [ 0; 1 ] in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_30; keep_29; w_3.state.k ];
          w_3.state.c <- pc_to_exp (int_to_pc 3)
      | 78 (* tag_cont_23 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 3 tl_0;
          Dynarray.set w_3.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_3.state.e 0; Dynarray.get w_3.state.e 2 ]);
          Dynarray.set w_3.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_3.state.e 3; Dynarray.get w_3.state.e 0 ]);
          assert_env_length w_3 4;
          let keep_30 = env_call w_3 [] [ 1; 0 ] in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_31; keep_30; w_3.state.k ];
          w_3.state.c <- pc_to_exp (int_to_pc 3)
      | 79 (* tag_cont_24 *) ->
          w_3.state.k <- get_next_cont tl_0;
          restore_env w_3 0 tl_0;
      ...
      | 81 (* tag_cont_26 *) ->
          ...
          Dynarray.set w_3.state.e 0
            (Memo.appends [ Memo.from_constructor tag_VCons; Dynarray.get w_3.state.e 0; Dynarray.get w_3.state.e 1 ]);
      ...
      | 82 (* tag_cont_27 *) ->
          ...
          restore_env w_3 1 tl_0;
          Dynarray.set w_3.state.e 0
            (Memo.appends [ Memo.from_constructor tag_VPair; Dynarray.get w_3.state.e 0; Dynarray.get w_3.state.e 1 ]);
          assert_env_length w_3 2;
          return_n w_3 0 (pc_to_exp (int_to_pc 0))
      | 83 (* tag_cont_28 *) ->
          w_3.state.k <- get_next_cont tl_0;
  ...
  add_exp
    (fun w_1 ->
      ...
      | 1 (* tag_Z *) ->
          Dynarray.set w_1.state.e 0 (Memo.appends [ Memo.from_constructor tag_Some; Dynarray.get w_1.state.e 0 ]);
      ...
      | 2 (* tag_S *) ->
          ...
          assert_env_length w_1 3;
          let keep_0 = env_call w_1 [] [ 2; 0 ] in
  ...
  add_exp
    (fun w_2 ->
      ...
      | 7 (* tag_EInt *) ->
          ...
          Dynarray.set w_2.state.e 0 (Memo.appends [ Memo.from_constructor tag_VInt; Dynarray.get w_2.state.e 0 ]);
          assert_env_length w_2 2;
      ...
      | 8 (* tag_EPlus *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_3;
          push_env w_2 split1_1;
          assert_env_length w_2 3;
          let keep_1 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_2; keep_1; w_2.state.k ];
      ...
      | 9 (* tag_ELt *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_4;
          push_env w_2 split1_2;
          assert_env_length w_2 3;
          let keep_2 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_3; keep_2; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 10 (* tag_ELe *) ->
          let splits_5 = Memo.splits (snd x_2) in
          let split0_5 = List.nth splits_5 0 in
          let split1_3 = List.nth splits_5 1 in
          Dynarray.set w_2.state.e 0 split0_5;
          push_env w_2 split1_3;
          assert_env_length w_2 3;
          let keep_3 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_3; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 11 (* tag_EGt *) ->
          let splits_6 = Memo.splits (snd x_2) in
          let split0_6 = List.nth splits_6 0 in
          let split1_4 = List.nth splits_6 1 in
          Dynarray.set w_2.state.e 0 split0_6;
          push_env w_2 split1_4;
          assert_env_length w_2 3;
          let keep_4 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_4; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 12 (* tag_EGe *) ->
          let splits_7 = Memo.splits (snd x_2) in
          let split0_7 = List.nth splits_7 0 in
          let split1_5 = List.nth splits_7 1 in
          Dynarray.set w_2.state.e 0 split0_7;
          push_env w_2 split1_5;
          assert_env_length w_2 3;
          let keep_5 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; keep_5; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 13 (* tag_EVar *) ->
          let splits_8 = Memo.splits (snd x_2) in
          let split0_8 = List.nth splits_8 0 in
          Dynarray.set w_2.state.e 0 split0_8;
          assert_env_length w_2 2;
          let keep_6 = env_call w_2 [] [ 1; 0 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_7; keep_6; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 1)
      | 14 (* tag_EAbs *) ->
          let splits_9 = Memo.splits (snd x_2) in
          let split0_9 = List.nth splits_9 0 in
          Dynarray.set w_2.state.e 0 split0_9;
          Dynarray.set w_2.state.e 0
            (Memo.appends [ Memo.from_constructor tag_VAbs; Dynarray.get w_2.state.e 0; Dynarray.get w_2.state.e 1 ]);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 16 (* tag_ELet *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_10;
          push_env w_2 split1_6;
          assert_env_length w_2 3;
          let keep_7 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; keep_7; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 26 (* tag_EFix *) ->
          let splits_11 = Memo.splits (snd x_2) in
          let split0_11 = List.nth splits_11 0 in
          Dynarray.set w_2.state.e 0 split0_11;
          Dynarray.set w_2.state.e 0
            (Memo.appends [ Memo.from_constructor tag_VFix; Dynarray.get w_2.state.e 0; Dynarray.get w_2.state.e 1 ]);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 15 (* tag_EApp *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_12;
          push_env w_2 split1_7;
          assert_env_length w_2 3;
          let keep_8 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_9; keep_8; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 27 (* tag_EHole *) ->
          let splits_13 = Memo.splits (snd x_2) in
          let split0_13 = List.nth splits_13 0 in
          Dynarray.set w_2.state.e 0 split0_13;
          Dynarray.set w_2.state.e 0 (Memo.appends [ Memo.from_constructor tag_SHole; Dynarray.get w_2.state.e 0 ]);
          Dynarray.set w_2.state.e 0 (Memo.appends [ Memo.from_constructor tag_VStuck; Dynarray.get w_2.state.e 0 ]);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 17 (* tag_ETrue *) ->
          Dynarray.set w_2.state.e 0 (Memo.from_constructor tag_VTrue);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 18 (* tag_EFalse *) ->
          Dynarray.set w_2.state.e 0 (Memo.from_constructor tag_VFalse);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 19 (* tag_EIf *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_14;
          push_env w_2 split1_8;
          push_env w_2 split2_0;
          assert_env_length w_2 4;
          let keep_9 = env_call w_2 [ 1; 2; 3 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_9; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 20 (* tag_ENil *) ->
          Dynarray.set w_2.state.e 0 (Memo.from_constructor tag_VNil);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
      | 21 (* tag_ECons *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_15;
          push_env w_2 split1_9;
          assert_env_length w_2 3;
          let keep_10 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_11; keep_10; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 23 (* tag_EPair *) ->
          let splits_16 = Memo.splits (snd x_2) in
          let split0_16 = List.nth splits_16 0 in
          let split1_10 = List.nth splits_16 1 in
          Dynarray.set w_2.state.e 0 split0_16;
          push_env w_2 split1_10;
          assert_env_length w_2 3;
          let keep_11 = env_call w_2 [ 1; 2 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_12; keep_11; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 24 (* tag_EZro *) ->
          let splits_17 = Memo.splits (snd x_2) in
          let split0_17 = List.nth splits_17 0 in
          Dynarray.set w_2.state.e 0 split0_17;
          assert_env_length w_2 2;
          let keep_12 = env_call w_2 [] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_13; keep_12; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 25 (* tag_EFst *) ->
          let splits_18 = Memo.splits (snd x_2) in
          let split0_18 = List.nth splits_18 0 in
          Dynarray.set w_2.state.e 0 split0_18;
          assert_env_length w_2 2;
          let keep_13 = env_call w_2 [] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_14; keep_13; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 22 (* tag_EMatchList *) ->
          ...
          Dynarray.set w_2.state.e 0 split0_19;
          push_env w_2 split1_11;
          push_env w_2 split2_1;
          assert_env_length w_2 4;
          let keep_14 = env_call w_2 [ 1; 2; 3 ] [ 0; 1 ] in
          w_2.state.k <- Memo.appends [ Memo.from_constructor tag_cont_15; keep_14; w_2.state.k ];
          w_2.state.c <- pc_to_exp (int_to_pc 3)
      | 28 (* tag_EUnit *) ->
          Dynarray.set w_2.state.e 0 (Memo.from_constructor tag_VUnit);
          assert_env_length w_2 2;
          return_n w_2 0 (pc_to_exp (int_to_pc 0))
  ...
  add_exp
    (fun w_4 ->
      let x_3 = resolve w_4 (Source.E 2) in
      match Word.get_value (fst x_3) with
      | 29 (* tag_VInt *) ->
          let splits_20 = Memo.splits (snd x_3) in
          let split0_20 = List.nth splits_20 0 in
          push_env w_4 split0_20;
          assert_env_length w_4 4;
          let keep_15 = env_call w_4 [ 2; 3 ] [ 1; 0 ] in
          w_4.state.k <- Memo.appends [ Memo.from_constructor tag_cont_16; keep_15; w_4.state.k ];
          w_4.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_21 = Memo.splits (snd x_3) in
          let split0_21 = List.nth splits_21 0 in
          Dynarray.set w_4.state.e 0 split0_21;
          Dynarray.set w_4.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SAdd0; Dynarray.get w_4.state.e 0; Dynarray.get w_4.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_4.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_4.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_5 ->
      let x_4 = resolve w_5 (Source.E 2) in
      match Word.get_value (fst x_4) with
      | 29 (* tag_VInt *) ->
          let splits_22 = Memo.splits (snd x_4) in
          let split0_22 = List.nth splits_22 0 in
          push_env w_5 split0_22;
          assert_env_length w_5 4;
          let keep_16 = env_call w_5 [ 2; 3 ] [ 1; 0 ] in
          w_5.state.k <- Memo.appends [ Memo.from_constructor tag_cont_17; keep_16; w_5.state.k ];
          w_5.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_23 = Memo.splits (snd x_4) in
          let split0_23 = List.nth splits_23 0 in
          Dynarray.set w_5.state.e 0 split0_23;
          Dynarray.set w_5.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt0; Dynarray.get w_5.state.e 0; Dynarray.get w_5.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_5.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_5.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_6 ->
      let x_5 = resolve w_6 (Source.E 2) in
      match Word.get_value (fst x_5) with
      | 29 (* tag_VInt *) ->
          let splits_24 = Memo.splits (snd x_5) in
          let split0_24 = List.nth splits_24 0 in
          push_env w_6 split0_24;
          assert_env_length w_6 4;
          let keep_17 = env_call w_6 [ 2; 3 ] [ 1; 0 ] in
          w_6.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_17; w_6.state.k ];
          w_6.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_25 = Memo.splits (snd x_5) in
          let split0_25 = List.nth splits_25 0 in
          Dynarray.set w_6.state.e 0 split0_25;
          Dynarray.set w_6.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt0; Dynarray.get w_6.state.e 0; Dynarray.get w_6.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_6.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_6.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_7 ->
      let x_6 = resolve w_7 (Source.E 2) in
      match Word.get_value (fst x_6) with
      | 29 (* tag_VInt *) ->
          let splits_26 = Memo.splits (snd x_6) in
          let split0_26 = List.nth splits_26 0 in
          push_env w_7 split0_26;
          assert_env_length w_7 4;
          let keep_18 = env_call w_7 [ 2; 3 ] [ 1; 0 ] in
          w_7.state.k <- Memo.appends [ Memo.from_constructor tag_cont_19; keep_18; w_7.state.k ];
          w_7.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_27 = Memo.splits (snd x_6) in
          let split0_27 = List.nth splits_27 0 in
          Dynarray.set w_7.state.e 0 split0_27;
          Dynarray.set w_7.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt0; Dynarray.get w_7.state.e 0; Dynarray.get w_7.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_7.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_7.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_8 ->
      let x_7 = resolve w_8 (Source.E 2) in
      match Word.get_value (fst x_7) with
      | 29 (* tag_VInt *) ->
          let splits_28 = Memo.splits (snd x_7) in
          let split0_28 = List.nth splits_28 0 in
          push_env w_8 split0_28;
          assert_env_length w_8 4;
          let keep_19 = env_call w_8 [ 2; 3 ] [ 1; 0 ] in
          w_8.state.k <- Memo.appends [ Memo.from_constructor tag_cont_20; keep_19; w_8.state.k ];
          w_8.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_29 = Memo.splits (snd x_7) in
          let split0_29 = List.nth splits_29 0 in
          Dynarray.set w_8.state.e 0 split0_29;
          Dynarray.set w_8.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt0; Dynarray.get w_8.state.e 0; Dynarray.get w_8.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_8.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_8.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_10 ->
      let x_9 = resolve w_10 (Source.E 2) in
      ...
      | 30 (* tag_VAbs *) ->
          ...
          Dynarray.set w_10.state.e 2 split0_31;
          push_env w_10 split1_12;
          assert_env_length w_10 4;
          let keep_21 = env_call w_10 [ 2; 3 ] [ 1; 0 ] in
          w_10.state.k <- Memo.appends [ Memo.from_constructor tag_cont_22; keep_21; w_10.state.k ];
      ...
      | 37 (* tag_VFix *) ->
          ...
          push_env w_10 split0_32;
          push_env w_10 split1_13;
          assert_env_length w_10 5;
          let keep_22 = env_call w_10 [ 2; 3; 4 ] [ 1; 0 ] in
          w_10.state.k <- Memo.appends [ Memo.from_constructor tag_cont_23; keep_22; w_10.state.k ];
          w_10.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_33 = Memo.splits (snd x_9) in
          let split0_33 = List.nth splits_33 0 in
          Dynarray.set w_10.state.e 0 split0_33;
          Dynarray.set w_10.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SApp; Dynarray.get w_10.state.e 0; Dynarray.get w_10.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_10.state.e 0 (Memo.from_constructor tag_VTFunc);
          Dynarray.set w_10.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_11 ->
      let x_10 = resolve w_11 (Source.E 3) in
      match Word.get_value (fst x_10) with
      | 32 (* tag_VTrue *) ->
          assert_env_length w_11 4;
          let keep_23 = env_call w_11 [] [ 1; 0 ] in
          w_11.state.k <- Memo.appends [ Memo.from_constructor tag_cont_24; keep_23; w_11.state.k ];
          w_11.state.c <- pc_to_exp (int_to_pc 3)
      | 33 (* tag_VFalse *) ->
          assert_env_length w_11 4;
          let keep_24 = env_call w_11 [] [ 2; 0 ] in
          w_11.state.k <- Memo.appends [ Memo.from_constructor tag_cont_25; keep_24; w_11.state.k ];
          w_11.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_34 = Memo.splits (snd x_10) in
          let split0_34 = List.nth splits_34 0 in
          Dynarray.set w_11.state.e 0 split0_34;
          Dynarray.set w_11.state.e 0
            (Memo.appends
               [
                 Memo.from_constructor tag_SIf;
                 Dynarray.get w_11.state.e 0;
                 Dynarray.get w_11.state.e 1;
                 Dynarray.get w_11.state.e 2;
               ]);
      ...
      | iv ->
          Dynarray.set w_11.state.e 0 (Memo.from_constructor tag_VTBool);
          Dynarray.set w_11.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_12 ->
      let x_11 = resolve w_12 (Source.E 0) in
      ...
      | 36 (* tag_VPair *) ->
          ...
          Dynarray.set w_12.state.e 0 split0_35;
          push_env w_12 split1_14;
      ...
      | 38 (* tag_VStuck *) ->
          ...
          Dynarray.set w_12.state.e 0 split0_36;
          Dynarray.set w_12.state.e 0 (Memo.appends [ Memo.from_constructor tag_SZro; Dynarray.get w_12.state.e 0 ]);
          ...
          return_n w_12 0 (pc_to_exp (int_to_pc 0))
      | pv ->
          push_env w_12 (Memo.from_constructor tag_VTPair);
          Dynarray.set w_12.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_13 ->
      let x_12 = resolve w_13 (Source.E 0) in
      ...
      | 36 (* tag_VPair *) ->
          ...
          Dynarray.set w_13.state.e 0 split0_37;
          push_env w_13 split1_15;
          assert_env_length w_13 2;
          return_n w_13 1 (pc_to_exp (int_to_pc 0))
      | 38 (* tag_VStuck *) ->
          let splits_38 = Memo.splits (snd x_12) in
          let split0_38 = List.nth splits_38 0 in
          Dynarray.set w_13.state.e 0 split0_38;
          Dynarray.set w_13.state.e 0 (Memo.appends [ Memo.from_constructor tag_SFst; Dynarray.get w_13.state.e 0 ]);
      ...
      | pv ->
          push_env w_13 (Memo.from_constructor tag_VTPair);
  ...
  add_exp
    (fun w_14 ->
      let x_13 = resolve w_14 (Source.E 3) in
      match Word.get_value (fst x_13) with
      | 34 (* tag_VNil *) ->
          assert_env_length w_14 4;
          let keep_27 = env_call w_14 [] [ 1; 0 ] in
          w_14.state.k <- Memo.appends [ Memo.from_constructor tag_cont_28; keep_27; w_14.state.k ];
          w_14.state.c <- pc_to_exp (int_to_pc 3)
      | 35 (* tag_VCons *) ->
          let splits_39 = Memo.splits (snd x_13) in
          let split0_39 = List.nth splits_39 0 in
          let split1_16 = List.nth splits_39 1 in
          Dynarray.set w_14.state.e 1 split0_39;
          Dynarray.set w_14.state.e 3 split1_16;
          Dynarray.set w_14.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_14.state.e 1; Dynarray.get w_14.state.e 0 ]);
          Dynarray.set w_14.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_14.state.e 3; Dynarray.get w_14.state.e 0 ]);
          assert_env_length w_14 4;
          let keep_28 = env_call w_14 [] [ 2; 0 ] in
          w_14.state.k <- Memo.appends [ Memo.from_constructor tag_cont_29; keep_28; w_14.state.k ];
          w_14.state.c <- pc_to_exp (int_to_pc 3)
      | 38 (* tag_VStuck *) ->
          let splits_40 = Memo.splits (snd x_13) in
          let split0_40 = List.nth splits_40 0 in
          Dynarray.set w_14.state.e 0 split0_40;
          Dynarray.set w_14.state.e 0
            (Memo.appends
               [
                 Memo.from_constructor tag_SMatchList;
                 Dynarray.get w_14.state.e 0;
                 Dynarray.get w_14.state.e 1;
                 Dynarray.get w_14.state.e 2;
               ]);
      ...
      | vv ->
          Dynarray.set w_14.state.e 0 (Memo.from_constructor tag_VTList);
          Dynarray.set w_14.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_15 ->
      ...
      | 38 (* tag_VStuck *) ->
          ...
          Dynarray.set w_15.state.e 1 split0_42;
          Dynarray.set w_15.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SAdd1; Dynarray.get w_15.state.e 0; Dynarray.get w_15.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_15.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_15.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_17 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          Dynarray.set w_17.state.e 0 split0_43;
          w_17.state.c <- pc_to_exp (int_to_pc 18)
      | 38 (* tag_VStuck *) ->
          let splits_44 = Memo.splits (snd x_15) in
          let split0_44 = List.nth splits_44 0 in
          Dynarray.set w_17.state.e 1 split0_44;
          Dynarray.set w_17.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt1; Dynarray.get w_17.state.e 0; Dynarray.get w_17.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_17.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_17.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_20 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          Dynarray.set w_20.state.e 0 split0_45;
          w_20.state.c <- pc_to_exp (int_to_pc 21)
      | 38 (* tag_VStuck *) ->
          let splits_46 = Memo.splits (snd x_16) in
          let split0_46 = List.nth splits_46 0 in
          Dynarray.set w_20.state.e 1 split0_46;
          Dynarray.set w_20.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt1; Dynarray.get w_20.state.e 0; Dynarray.get w_20.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_20.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_20.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_23 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          Dynarray.set w_23.state.e 0 split0_47;
          w_23.state.c <- pc_to_exp (int_to_pc 24)
      | 38 (* tag_VStuck *) ->
          let splits_48 = Memo.splits (snd x_17) in
          let split0_48 = List.nth splits_48 0 in
          Dynarray.set w_23.state.e 1 split0_48;
          Dynarray.set w_23.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt1; Dynarray.get w_23.state.e 0; Dynarray.get w_23.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_23.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_23.state.e 0
            (Memo.appends
  ...
  add_exp
    (fun w_26 ->
      ...
      | 29 (* tag_VInt *) ->
          ...
          Dynarray.set w_26.state.e 0 split0_49;
          w_26.state.c <- pc_to_exp (int_to_pc 27)
      | 38 (* tag_VStuck *) ->
          let splits_50 = Memo.splits (snd x_18) in
          let split0_50 = List.nth splits_50 0 in
          Dynarray.set w_26.state.e 1 split0_50;
          Dynarray.set w_26.state.e 0
            (Memo.appends [ Memo.from_constructor tag_SGt1; Dynarray.get w_26.state.e 0; Dynarray.get w_26.state.e 1 ]);
      ...
      | _ ->
          Dynarray.set w_26.state.e 0 (Memo.from_constructor tag_VTInt);
          Dynarray.set w_26.state.e 0
            (Memo.appends
  ...
  Words.set_constructor_degree 62 0;
  ...
  Words.set_constructor_degree 69 0;
  Words.set_constructor_degree 70 (-3);
