...
let rec length ?config (x0 : Value.seq) : exec_result =
  exec_cek ?config (pc_to_exp (int_to_pc 14)) (Dynarray.of_list [ x0 ]) (Memo.from_constructor tag_cont_done)

let rec half ?config (x0 : Value.seq) : exec_result =
  exec_cek ?config (pc_to_exp (int_to_pc 15)) (Dynarray.of_list [ x0 ]) (Memo.from_constructor tag_cont_done)

let rec take ?config (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek ?config (pc_to_exp (int_to_pc 17)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done)
...
let rec my_merge ?config (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek ?config (pc_to_exp (int_to_pc 20)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done)

let rec mergesort ?config (x0 : Value.seq) : exec_result =
  exec_cek ?config (pc_to_exp (int_to_pc 24)) (Dynarray.of_list [ x0 ]) (Memo.from_constructor tag_cont_done)
...
let populate_state () =
  ...
  add_exp
    (fun w_35 ->
      ...
      let hd_0, tl_0 = resolve w_35 K in
      match Word.get_value hd_0 with
      | 0 (* tag_cont_done *) -> exec_done w_35
      | 7 (* tag_cont_1 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 2 tl_0;
          Dynarray.set w_35.state.e 0
            (Memo.appends
               [
                 Memo.from_constructor tag_ConsP;
                 Dynarray.get w_35.state.e 0;
                 Dynarray.get w_35.state.e 1;
                 Dynarray.get w_35.state.e 2;
               ]);
          assert_env_length w_35 3;
          return_n w_35 0 (pc_to_exp (int_to_pc 0))
      | 8 (* tag_cont_2 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          Dynarray.set w_35.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_35.state.e 0; Dynarray.get w_35.state.e 1 ]);
      ...
      | 11 (* tag_cont_5 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          push_env w_35 (Memo.from_constructor tag_Nil);
          Dynarray.set w_35.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_35.state.e 0; Dynarray.get w_35.state.e 2 ]);
          assert_env_length w_35 3;
          ignore (env_call w_35 [] [ 1; 0 ]);
          w_35.state.c <- pc_to_exp (int_to_pc 8)
      | 12 (* tag_cont_6 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          Dynarray.set w_35.state.e 0
      ...
      | 13 (* tag_cont_7 *) ->
          ...
          restore_env w_35 1 tl_0;
          assert_env_length w_35 2;
          ignore (env_call w_35 [] [ 0; 1 ]);
          w_35.state.c <- pc_to_exp (int_to_pc 10)
      | 15 (* tag_cont_8 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 0 tl_0;
          Dynarray.set w_35.state.e 0 (Memo.appends [ Memo.from_constructor tag_S; Dynarray.get w_35.state.e 0 ]);
          assert_env_length w_35 1;
          return_n w_35 0 (pc_to_exp (int_to_pc 0))
      | 16 (* tag_cont_9 *) ->
          w_35.state.k <- get_next_cont tl_0;
      ...
      | 18 (* tag_cont_11 *) ->
          ...
          restore_env w_35 1 tl_0;
          assert_env_length w_35 2;
          let keep_18 = env_call w_35 [ 0 ] [ 1 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_19; keep_18; w_35.state.k ];
          w_35.state.c <- pc_to_exp (int_to_pc 15)
      | 19 (* tag_cont_12 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          Dynarray.set w_35.state.e 0
      ...
      | 25 (* tag_cont_18 *) ->
          ...
          restore_env w_35 2 tl_0;
          assert_env_length w_35 3;
          let keep_20 = env_call w_35 [ 0; 1 ] [ 2 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_21; keep_20; w_35.state.k ];
      ...
      | 26 (* tag_cont_19 *) ->
          ...
          assert_env_length w_35 2;
          ignore (env_call w_35 [] [ 1; 0 ]);
          w_35.state.c <- pc_to_exp (int_to_pc 17)
      | 27 (* tag_cont_20 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          assert_env_length w_35 2;
          let keep_21 = env_call w_35 [ 1 ] [ 0 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_22; keep_21; w_35.state.k ];
          w_35.state.c <- pc_to_exp (int_to_pc 24)
      | 28 (* tag_cont_21 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 2 tl_0;
          assert_env_length w_35 3;
          let keep_22 = env_call w_35 [ 0; 1; 2 ] [ 0; 1 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_23; keep_22; w_35.state.k ];
          w_35.state.c <- pc_to_exp (int_to_pc 29)
      | 29 (* tag_cont_22 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 1 tl_0;
          assert_env_length w_35 2;
          ignore (env_call w_35 [] [ 0; 1 ]);
          w_35.state.c <- pc_to_exp (int_to_pc 20)
      | 30 (* tag_cont_23 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 3 tl_0;
          assert_env_length w_35 4;
          let keep_23 = env_call w_35 [ 2; 3 ] [ 0; 1 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_24; keep_23; w_35.state.k ];
          w_35.state.c <- pc_to_exp (int_to_pc 26)
      | 31 (* tag_cont_24 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 2 tl_0;
          assert_env_length w_35 3;
          let keep_24 = env_call w_35 [ 0; 1 ] [ 2 ] in
          w_35.state.k <- Memo.appends [ Memo.from_constructor tag_cont_25; keep_24; w_35.state.k ];
          w_35.state.c <- pc_to_exp (int_to_pc 35)
      | 32 (* tag_cont_25 *) ->
          w_35.state.k <- get_next_cont tl_0;
          restore_env w_35 2 tl_0;
          assert_env_length w_35 3;
          let keep_25 = env_call w_35 [ 0 ] [ 1; 2 ] in
  ...
  add_exp
    (fun w_7 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          let keep_3 = env_call w_7 [ 0 ] [ 2; 1 ] in
          w_7.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_3; w_7.state.k ];
  ...
  add_exp
    (fun w_8 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          let keep_4 = env_call w_8 [ 0 ] [ 1 ] in
          w_8.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_4; w_8.state.k ];
  ...
  add_exp
    (fun w_11 ->
      ...
      if Word.get_value (fst cond_1) <> 0 then (
        ...
        assert_env_length w_11 5;
        let keep_5 = env_call w_11 [ 2 ] [ 0; 3 ] in
        w_11.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; keep_5; w_11.state.k ];
  ...
  add_exp
    (fun w_12 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          let keep_6 = env_call w_12 [ 0 ] [ 1 ] in
          w_12.state.k <- Memo.appends [ Memo.from_constructor tag_cont_7; keep_6; w_12.state.k ];
  ...
  add_exp
    (fun w_13 ->
      ...
      let x_8 = resolve w_13 (Source.E 0) in
      match Word.get_value (fst x_8) with
      | 1 (* tag_Nil *) ->
          Dynarray.set w_13.state.e 0 (Memo.from_constructor tag_Z);
          assert_env_length w_13 1;
      ...
      | 2 (* tag_Cons *) ->
          ...
          Dynarray.set w_13.state.e 0 split0_8;
          push_env w_13 split1_8;
          assert_env_length w_13 2;
          let keep_7 = env_call w_13 [] [ 1 ] in
          w_13.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; keep_7; w_13.state.k ];
  ...
  add_exp
    (fun w_15 ->
      ...
      | 5 (* tag_Z *) ->
          Dynarray.set w_15.state.e 0 (Memo.from_constructor tag_Z);
  ...
  add_exp
    (fun w_16 ->
      ...
      let x_11 = resolve w_16 (Source.E 0) in
      match Word.get_value (fst x_11) with
      | 5 (* tag_Z *) ->
          Dynarray.set w_16.state.e 0 (Memo.from_constructor tag_Nil);
          Dynarray.set w_16.state.e 0
            (Memo.appends [ Memo.from_constructor tag_P; Dynarray.get w_16.state.e 0; Dynarray.get w_16.state.e 1 ]);
          assert_env_length w_16 2;
          return_n w_16 0 (pc_to_exp (int_to_pc 0))
      | 6 (* tag_S *) ->
          let splits_11 = Memo.splits (snd x_11) in
          let split0_11 = List.nth splits_11 0 in
          Dynarray.set w_16.state.e 0 split0_11;
          assert_env_length w_16 2;
  ...
  add_exp
    (fun w_17 ->
      let x_12 = resolve w_17 (Source.E 1) in
      match Word.get_value (fst x_12) with
      | 1 (* tag_Nil *) ->
          Dynarray.set w_17.state.e 0 (Memo.from_constructor tag_Nil);
          Dynarray.set w_17.state.e 1 (Memo.from_constructor tag_Nil);
          Dynarray.set w_17.state.e 0
            (Memo.appends [ Memo.from_constructor tag_P; Dynarray.get w_17.state.e 0; Dynarray.get w_17.state.e 1 ]);
      ...
      | 2 (* tag_Cons *) ->
          ...
          let split1_9 = List.nth splits_12 1 in
          Dynarray.set w_17.state.e 1 split0_12;
          push_env w_17 split1_9;
          assert_env_length w_17 3;
          let keep_9 = env_call w_17 [ 1 ] [ 0; 2 ] in
          w_17.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_9; w_17.state.k ];
  ...
  add_exp
    (fun w_18 ->
      ...
      let keep_10 = env_call w_18 [ 0 ] [ 0 ] in
      w_18.state.k <- Memo.appends [ Memo.from_constructor tag_cont_11; keep_10; w_18.state.k ];
      w_18.state.c <- pc_to_exp (int_to_pc 14))
    19;
  add_exp
    (fun w_19 ->
      assert_env_length w_19 2;
      let x_13 = resolve w_19 (Source.E 0) in
      ...
      | 2 (* tag_Cons *) ->
          ...
          let split1_10 = List.nth splits_13 1 in
          push_env w_19 split0_13;
  ...
  add_exp
    (fun w_20 ->
      let x_14 = resolve w_20 (Source.E 1) in
      ...
      | 2 (* tag_Cons *) ->
          ...
          let split1_11 = List.nth splits_14 1 in
          push_env w_20 split0_14;
          push_env w_20 split1_11;
          w_20.state.c <- pc_to_exp (int_to_pc 22)
      | _ -> failwith "unreachable (24)")
    21;
  add_exp
    (fun w_21 ->
      assert_env_length w_21 6;
      let x0_3 = resolve w_21 (Source.E 2) in
      let x1_3 = resolve w_21 (Source.E 4) in
      push_env w_21 (Memo.from_int (if Word.get_value (fst x0_3) < Word.get_value (fst x1_3) then 1 else 0));
      w_21.state.c <- pc_to_exp (int_to_pc 23))
    22;
  add_exp
    (fun w_22 ->
      assert_env_length w_22 7;
      let cond_2 = resolve w_22 (Source.E 6) in
      if Word.get_value (fst cond_2) <> 0 then (
        assert_env_length w_22 7;
        let keep_11 = env_call w_22 [ 2 ] [ 3; 1 ] in
        w_22.state.k <- Memo.appends [ Memo.from_constructor tag_cont_12; keep_11; w_22.state.k ];
        w_22.state.c <- pc_to_exp (int_to_pc 20))
      else (
        assert_env_length w_22 7;
        let keep_12 = env_call w_22 [ 4 ] [ 0; 5 ] in
  ...
  add_exp
    (fun w_23 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          let split1_12 = List.nth splits_15 1 in
          push_env w_23 split0_15;
          push_env w_23 split1_12;
  ...
  add_exp
    (fun w_24 ->
      let x_16 = resolve w_24 (Source.E 2) in
      ...
      | 2 (* tag_Cons *) ->
          ...
          let split1_13 = List.nth splits_16 1 in
          Dynarray.set w_24.state.e 1 split0_16;
          Dynarray.set w_24.state.e 2 split1_13;
          assert_env_length w_24 3;
          let keep_13 = env_call w_24 [] [ 0 ] in
          w_24.state.k <- Memo.appends [ Memo.from_constructor tag_cont_14; keep_13; w_24.state.k ];
          w_24.state.c <- pc_to_exp (int_to_pc 19)
      | _ -> failwith "unreachable (26)")
    25;
  add_exp
    (fun w_25 ->
      assert_env_length w_25 2;
      let x_17 = resolve w_25 (Source.E 0) in
      match Word.get_value (fst x_17) with
      | 1 (* tag_Nil *) ->
          Dynarray.set w_25.state.e 0 (Memo.from_constructor tag_Nil);
          assert_env_length w_25 2;
          return_n w_25 0 (pc_to_exp (int_to_pc 0))
      | 2 (* tag_Cons *) ->
          let splits_17 = Memo.splits (snd x_17) in
          let split0_17 = List.nth splits_17 0 in
          let split1_14 = List.nth splits_17 1 in
          Dynarray.set w_25.state.e 0 split0_17;
          push_env w_25 split1_14;
  ...
  add_exp
    (fun w_26 ->
      ...
      let x0_4 = resolve w_26 (Source.E 0) in
      let x1_4 = resolve w_26 (Source.E 1) in
  ...
  add_exp
    (fun w_27 ->
      ...
      let cond_3 = resolve w_27 (Source.E 3) in
      if Word.get_value (fst cond_3) <> 0 then (
        assert_env_length w_27 4;
        let keep_14 = env_call w_27 [ 0 ] [ 2; 1 ] in
        w_27.state.k <- Memo.appends [ Memo.from_constructor tag_cont_15; keep_14; w_27.state.k ];
        w_27.state.c <- pc_to_exp (int_to_pc 26))
      else (
        assert_env_length w_27 4;
        ignore (env_call w_27 [] [ 2; 1 ]);
        w_27.state.c <- pc_to_exp (int_to_pc 26)))
    28;
  add_exp
    (fun w_28 ->
      ...
      | 1 (* tag_Nil *) ->
          Dynarray.set w_28.state.e 0 (Memo.from_constructor tag_Nil);
          assert_env_length w_28 2;
          return_n w_28 0 (pc_to_exp (int_to_pc 0))
      | 2 (* tag_Cons *) ->
          let splits_18 = Memo.splits (snd x_18) in
          let split0_18 = List.nth splits_18 0 in
          let split1_15 = List.nth splits_18 1 in
          Dynarray.set w_28.state.e 0 split0_18;
  ...
  add_exp
    (fun w_29 ->
      ...
      let x0_5 = resolve w_29 (Source.E 0) in
      let x1_5 = resolve w_29 (Source.E 1) in
      push_env w_29 (Memo.from_int (if Word.get_value (fst x0_5) = Word.get_value (fst x1_5) then 1 else 0));
      w_29.state.c <- pc_to_exp (int_to_pc 31))
    30;
  add_exp
    (fun w_30 ->
      assert_env_length w_30 4;
      let cond_4 = resolve w_30 (Source.E 3) in
      if Word.get_value (fst cond_4) <> 0 then (
        assert_env_length w_30 4;
        let keep_15 = env_call w_30 [ 0 ] [ 2; 1 ] in
        w_30.state.k <- Memo.appends [ Memo.from_constructor tag_cont_16; keep_15; w_30.state.k ];
        w_30.state.c <- pc_to_exp (int_to_pc 29))
      else (
        assert_env_length w_30 4;
        ignore (env_call w_30 [] [ 2; 1 ]);
        w_30.state.c <- pc_to_exp (int_to_pc 29)))
    31;
  add_exp
    (fun w_31 ->
      assert_env_length w_31 2;
      let x_19 = resolve w_31 (Source.E 0) in
      match Word.get_value (fst x_19) with
      | 1 (* tag_Nil *) ->
          Dynarray.set w_31.state.e 0 (Memo.from_constructor tag_Nil);
          assert_env_length w_31 2;
          return_n w_31 0 (pc_to_exp (int_to_pc 0))
      | 2 (* tag_Cons *) ->
          let splits_19 = Memo.splits (snd x_19) in
          let split0_19 = List.nth splits_19 0 in
          let split1_16 = List.nth splits_19 1 in
          Dynarray.set w_31.state.e 0 split0_19;
          push_env w_31 split1_16;
  ...
  add_exp
    (fun w_32 ->
      ...
      let x0_6 = resolve w_32 (Source.E 0) in
      let x1_6 = resolve w_32 (Source.E 1) in
      push_env w_32 (Memo.from_int (if Word.get_value (fst x0_6) < Word.get_value (fst x1_6) then 1 else 0));
      w_32.state.c <- pc_to_exp (int_to_pc 34))
    33;
  add_exp
    (fun w_33 ->
      assert_env_length w_33 4;
      let cond_5 = resolve w_33 (Source.E 3) in
      if Word.get_value (fst cond_5) <> 0 then (
        assert_env_length w_33 4;
        let keep_16 = env_call w_33 [ 0 ] [ 2; 1 ] in
        w_33.state.k <- Memo.appends [ Memo.from_constructor tag_cont_17; keep_16; w_33.state.k ];
        w_33.state.c <- pc_to_exp (int_to_pc 32))
      else (
        assert_env_length w_33 4;
        ignore (env_call w_33 [] [ 2; 1 ]);
        w_33.state.c <- pc_to_exp (int_to_pc 32)))
    34;
  add_exp
    (fun w_34 ->
      assert_env_length w_34 1;
      let x_20 = resolve w_34 (Source.E 0) in
      match Word.get_value (fst x_20) with
      | 1 (* tag_Nil *) ->
          Dynarray.set w_34.state.e 0 (Memo.from_constructor tag_Nil);
          assert_env_length w_34 1;
          return_n w_34 0 (pc_to_exp (int_to_pc 0))
      | 2 (* tag_Cons *) ->
          let splits_20 = Memo.splits (snd x_20) in
          let split0_20 = List.nth splits_20 0 in
          let split1_17 = List.nth splits_20 1 in
          push_env w_34 split0_20;
          push_env w_34 split1_17;
          assert_env_length w_34 3;
          let keep_17 = env_call w_34 [ 0; 1 ] [ 0; 1 ] in
          w_34.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_17; w_34.state.k ];
          w_34.state.c <- pc_to_exp (int_to_pc 32)
      | _ -> failwith "unreachable (36)")
    35;
  add_exp
    (fun w_36 ->
      let x_21 = resolve w_36 (Source.E 1) in
      match Word.get_value (fst x_21) with
      | 14 (* tag_P *) ->
          let splits_21 = Memo.splits (snd x_21) in
          let split0_21 = List.nth splits_21 0 in
          let split1_18 = List.nth splits_21 1 in
          Dynarray.set w_36.state.e 1 split0_21;
          push_env w_36 split1_18;
          Dynarray.set w_36.state.e 0
            (Memo.appends [ Memo.from_constructor tag_Cons; Dynarray.get w_36.state.e 0; Dynarray.get w_36.state.e 1 ]);
          Dynarray.set w_36.state.e 0
            (Memo.appends [ Memo.from_constructor tag_P; Dynarray.get w_36.state.e 0; Dynarray.get w_36.state.e 2 ]);
  ...
  add_exp
    (fun w_37 ->
      let x_22 = resolve w_37 (Source.E 0) in
      match Word.get_value (fst x_22) with
      | 14 (* tag_P *) ->
          let splits_22 = Memo.splits (snd x_22) in
          let split0_22 = List.nth splits_22 0 in
          let split1_19 = List.nth splits_22 1 in
          Dynarray.set w_37.state.e 0 split0_22;
          push_env w_37 split1_19;
          assert_env_length w_37 2;
          let keep_19 = env_call w_37 [ 1 ] [ 0 ] in
          w_37.state.k <- Memo.appends [ Memo.from_constructor tag_cont_20; keep_19; w_37.state.k ];
          w_37.state.c <- pc_to_exp (int_to_pc 24)
  ...
  Words.set_constructor_degree 21 0;
  ...
  Words.set_constructor_degree 28 (-2);
  Words.set_constructor_degree 29 (-1);
  Words.set_constructor_degree 30 (-3);
