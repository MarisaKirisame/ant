...
let rec concat memo (x0 : Value.seq) (x1 : Value.seq) : exec_result =
...
let populate_state () =
  ...
  add_exp
    (fun w_16 ->
      ...
      let hd_0, tl_0 = resolve w_16 K in
      match Word.get_value hd_0 with
      | 0 (* tag_cont_done *) -> exec_done w_16
      | 3 (* tag_cont_1 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 1 tl_0;
          assert_env_length w_16 2;
          let ctor_arg_0 = pop_env w_16 in
          let ctor_arg_1 = pop_env w_16 in
          push_env w_16 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_1; ctor_arg_0 ]);
          assert_env_length w_16 1;
          drop_n w_16 1 0;
          assert_env_length w_16 1;
      ...
      | 4 (* tag_cont_2 *) ->
          ...
          restore_env w_16 1 tl_0;
          assert_env_length w_16 2;
          let ctor_arg_2 = pop_env w_16 in
          let ctor_arg_3 = pop_env w_16 in
          push_env w_16 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_3; ctor_arg_2 ]);
          assert_env_length w_16 1;
          drop_n w_16 1 0;
          assert_env_length w_16 1;
          return_n w_16 1 (pc_to_exp (int_to_pc 0))
      | 5 (* tag_cont_3 *) ->
          ...
          restore_env w_16 1 tl_0;
          assert_env_length w_16 2;
          let ctor_arg_4 = pop_env w_16 in
          let ctor_arg_5 = pop_env w_16 in
          push_env w_16 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_5; ctor_arg_4 ]);
          assert_env_length w_16 1;
          drop_n w_16 1 0;
          assert_env_length w_16 1;
          return_n w_16 1 (pc_to_exp (int_to_pc 0))
      | 6 (* tag_cont_4 *) ->
          ...
          restore_env w_16 1 tl_0;
          assert_env_length w_16 2;
          let ctor_arg_6 = pop_env w_16 in
          let ctor_arg_7 = pop_env w_16 in
          push_env w_16 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_7; ctor_arg_6 ]);
          assert_env_length w_16 1;
          drop_n w_16 1 0;
          assert_env_length w_16 1;
          return_n w_16 1 (pc_to_exp (int_to_pc 0))
      | 7 (* tag_cont_5 *) ->
          ...
          let keep_5 = env_call w_16 [ 0; 1; 2 ] 2 in
          w_16.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; keep_5; w_16.state.k ];
          w_16.state.c <- pc_to_exp (int_to_pc 7)
      | 8 (* tag_cont_6 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 2 tl_0;
          assert_env_length w_16 3;
          let keep_6 = env_call w_16 [ 0; 1 ] 1 in
          w_16.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_6; w_16.state.k ];
          w_16.state.c <- pc_to_exp (int_to_pc 15)
      | 9 (* tag_cont_7 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 1 tl_0;
          assert_env_length w_16 2;
          ignore (env_call w_16 [] 2);
          w_16.state.c <- pc_to_exp (int_to_pc 1)
      | 10 (* tag_cont_8 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 3 tl_0;
          assert_env_length w_16 4;
          push_env w_16 (Dynarray.get w_16.state.e 0);
          assert_env_length w_16 5;
          push_env w_16 (Dynarray.get w_16.state.e 1);
          assert_env_length w_16 6;
          let keep_7 = env_call w_16 [ 2; 3 ] 2 in
          w_16.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_7; w_16.state.k ];
          w_16.state.c <- pc_to_exp (int_to_pc 3)
      | 11 (* tag_cont_9 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 2 tl_0;
          assert_env_length w_16 3;
          let keep_8 = env_call w_16 [ 2 ] 2 in
          w_16.state.k <- Memo.appends [ Memo.from_constructor tag_cont_7; keep_8; w_16.state.k ];
          w_16.state.c <- pc_to_exp (int_to_pc 1)
      | 12 (* tag_cont_10 *) ->
          w_16.state.k <- get_next_cont tl_0;
          restore_env w_16 2 tl_0;
          assert_env_length w_16 3;
          let keep_9 = env_call w_16 [ 2; 3 ] 1 in
          w_16.state.k <- Memo.appends [ Memo.from_constructor tag_cont_9; keep_9; w_16.state.k ];
          w_16.state.c <- pc_to_exp (int_to_pc 15)
  ...
  add_exp
    (fun w_1 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          let keep_0 = env_call w_1 [ 4 ] 2 in
  ...
  add_exp
    (fun w_2 ->
      ...
      w_2.state.c <- pc_to_exp (int_to_pc 6))
    3;
  add_exp
    (fun w_5 ->
      assert_env_length w_5 5;
      let cond_0 = resolve w_5 (Source.E 4) in
      ignore (pop_env w_5);
      if Word.get_value (fst cond_0) <> 0 then (
        ...
        let keep_1 = env_call w_5 [ 4 ] 2 in
  ...
  add_exp
    (fun w_4 ->
      ...
      let x0_0 = resolve w_4 (Source.E 4) in
      let x1_0 = resolve w_4 (Source.E 5) in
      ignore (pop_env w_4);
      ignore (pop_env w_4);
      push_env w_4 (Memo.from_int (if Word.get_value (fst x0_0) > Word.get_value (fst x1_0) then 1 else 0));
  ...
  add_exp
    (fun w_3 ->
      ...
      | 1 (* tag_Nil *) ->
          ...
          push_env w_3 (Memo.from_constructor tag_Nil);
          assert_env_length w_3 3;
  ...
  add_exp
    (fun w_9 ->
      ...
      let cond_1 = resolve w_9 (Source.E 4) in
      ignore (pop_env w_9);
      if Word.get_value (fst cond_1) <> 0 then (
        ...
        let keep_2 = env_call w_9 [ 4 ] 2 in
  ...
  add_exp
    (fun w_8 ->
      ...
      let x0_1 = resolve w_8 (Source.E 4) in
      let x1_1 = resolve w_8 (Source.E 5) in
      ignore (pop_env w_8);
      ignore (pop_env w_8);
  ...
  add_exp
    (fun w_7 ->
      ...
      | 2 (* tag_Cons *) ->
          ...
          ignore (pop_env w_7);
          push_env w_7 split0_2;
          push_env w_7 split1_2;
  ...
  add_exp
    (fun w_13 ->
      ...
      let cond_2 = resolve w_13 (Source.E 4) in
      ignore (pop_env w_13);
      if Word.get_value (fst cond_2) <> 0 then (
        ...
        let keep_3 = env_call w_13 [ 4 ] 2 in
        w_13.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_3; w_13.state.k ];
        w_13.state.c <- pc_to_exp (int_to_pc 11))
      else (
        assert_env_length w_13 4;
        push_env w_13 (Dynarray.get w_13.state.e 3);
        assert_env_length w_13 5;
  ...
  add_exp
    (fun w_12 ->
      ...
      let x0_2 = resolve w_12 (Source.E 4) in
      let x1_2 = resolve w_12 (Source.E 5) in
      ignore (pop_env w_12);
      ignore (pop_env w_12);
      push_env w_12 (Memo.from_int (if Word.get_value (fst x0_2) < Word.get_value (fst x1_2) then 1 else 0));
      w_12.state.c <- pc_to_exp (int_to_pc 12))
    13;
  add_exp
    (fun w_11 ->
      assert_env_length w_11 3;
      let last_3 = Source.E 2 in
      let x_3 = resolve w_11 last_3 in
      match Word.get_value (fst x_3) with
      | 1 (* tag_Nil *) ->
          ignore (pop_env w_11);
          assert_env_length w_11 2;
          push_env w_11 (Memo.from_constructor tag_Nil);
          assert_env_length w_11 3;
      ...
      | 2 (* tag_Cons *) ->
          ...
          ignore (pop_env w_11);
          push_env w_11 split0_3;
          push_env w_11 split1_3;
  ...
  add_exp
    (fun w_15 ->
      ...
      let x_4 = resolve w_15 last_4 in
      ...
      | 2 (* tag_Cons *) ->
          ...
          ignore (pop_env w_15);
          push_env w_15 split0_4;
          push_env w_15 split1_4;
          ...
          let keep_4 = env_call w_15 [ 0; 1 ] 2 in
          w_15.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; keep_4; w_15.state.k ];
          w_15.state.c <- pc_to_exp (int_to_pc 11)
  ...
  Words.set_constructor_degree 8 (-2);
  Words.set_constructor_degree 9 (-1);
  Words.set_constructor_degree 10 (-3);
  Words.set_constructor_degree 11 (-2);
