...
type symbol = SLambda | SDefine | SQuote | SEq | SCons | SCond | SAtom | SCar | SCdr | SNull
...
let rec eval memo (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 106)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done) memo

let () =
  add_exp
    (fun w_110 ->
      assert_env_length w_110 1;
      let hd_0, tl_0 = resolve w_110 K in
      match Word.get_value hd_0 with
      | c_83 when c_83 = tag_cont_done -> exec_done w_110
      | c_83 when c_83 = tag_cont_1 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          let ctor_arg_15 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_15 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          drop_n w_110 1 0;
      ...
      | c_83 when c_83 = tag_cont_2 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          let ctor_arg_16 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_16 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          return_n w_110 1 (pc_to_exp (int_to_pc 0))
      | c_83 when c_83 = tag_cont_3 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 111);
          stepped w_110
      | c_83 when c_83 = tag_cont_4 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 112);
          stepped w_110
      | c_83 when c_83 = tag_cont_5 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          ignore (env_call w_110 [] 3);
          w_110.state.c <- pc_to_exp (int_to_pc 97);
          stepped w_110
      | c_83 when c_83 = tag_cont_6 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 113);
          stepped w_110
      | c_83 when c_83 = tag_cont_7 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 114);
          stepped w_110
      | c_83 when c_83 = tag_cont_8 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          ...
          let keep_vals_12 = env_call w_110 [ 2 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_13; keep_vals_12; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 104);
          stepped w_110
      | c_83 when c_83 = tag_cont_9 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 5;
          let keep_vals_13 = env_call w_110 [ 0; 1; 2 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_14; keep_vals_13; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_10 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          let keep_vals_14 = env_call w_110 [ 0; 1 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_15; keep_vals_14; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_110
      | c_83 when c_83 = tag_cont_11 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          w_110.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_110
      | c_83 when c_83 = tag_cont_12 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          let ctor_arg_18 = pop_env w_110 in
          let ctor_arg_19 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_19; ctor_arg_18 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          return_n w_110 1 (pc_to_exp (int_to_pc 0))
      | c_83 when c_83 = tag_cont_13 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          let ctor_arg_20 = pop_env w_110 in
          let ctor_arg_21 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_21; ctor_arg_20 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          return_n w_110 1 (pc_to_exp (int_to_pc 0))
      | c_83 when c_83 = tag_cont_14 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Memo.from_constructor tag_Unit);
          assert_env_length w_110 5;
          let keep_vals_15 = env_call w_110 [ 0; 1; 2; 3 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_16; keep_vals_15; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 22);
          stepped w_110
      | c_83 when c_83 = tag_cont_15 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 118);
          stepped w_110
      | c_83 when c_83 = tag_cont_16 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 4 tl_0;
          assert_env_length w_110 5;
          let keep_vals_25 = env_call w_110 [ 0; 1; 2 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_26; keep_vals_25; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 80);
          stepped w_110
      | c_83 when c_83 = tag_cont_17 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          let ctor_arg_22 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_22 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          return_n w_110 1 (pc_to_exp (int_to_pc 0))
      | c_83 when c_83 = tag_cont_18 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          let keep_vals_26 = env_call w_110 [] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_27; keep_vals_26; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_19 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 1);
          assert_env_length w_110 4;
          let keep_vals_27 = env_call w_110 [ 0; 1 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_28; keep_vals_27; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_20 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          let keep_vals_28 = env_call w_110 [] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_29; keep_vals_28; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_21 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          let keep_vals_29 = env_call w_110 [] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_30; keep_vals_29; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_22 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 1);
          assert_env_length w_110 4;
          let keep_vals_30 = env_call w_110 [ 0; 1 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_31; keep_vals_30; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_23 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          ignore (env_call w_110 [] 2);
          w_110.state.c <- pc_to_exp (int_to_pc 105);
          stepped w_110
      | c_83 when c_83 = tag_cont_24 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          let keep_vals_31 = env_call w_110 [] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_32; keep_vals_31; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_25 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 119);
          stepped w_110
      | c_83 when c_83 = tag_cont_26 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 120);
          stepped w_110
      | c_83 when c_83 = tag_cont_27 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          ignore (env_call w_110 [] 1);
          w_110.state.c <- pc_to_exp (int_to_pc 93);
          stepped w_110
      | c_83 when c_83 = tag_cont_28 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_35 = env_call w_110 [ 1; 2 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_36; keep_vals_35; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_110
      | c_83 when c_83 = tag_cont_29 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          ignore (env_call w_110 [] 1);
          w_110.state.c <- pc_to_exp (int_to_pc 87);
          stepped w_110
      | c_83 when c_83 = tag_cont_30 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          ignore (env_call w_110 [] 1);
          ...
          stepped w_110
      | c_83 when c_83 = tag_cont_31 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_36 = env_call w_110 [ 1; 2 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_37; keep_vals_36; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_110
      | c_83 when c_83 = tag_cont_32 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          assert_env_length w_110 1;
          ignore (env_call w_110 [] 1);
          w_110.state.c <- pc_to_exp (int_to_pc 102);
          stepped w_110
      | c_83 when c_83 = tag_cont_33 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          let keep_vals_37 = env_call w_110 [ 0; 1 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_38; keep_vals_37; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_110
      | c_83 when c_83 = tag_cont_34 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          let keep_vals_38 = env_call w_110 [ 0; 1 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_39; keep_vals_38; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 13);
          stepped w_110
      | c_83 when c_83 = tag_cont_35 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          ...
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_36 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_39 = env_call w_110 [ 1 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_40; keep_vals_39; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_37 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_40 = env_call w_110 [ 1 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_41; keep_vals_40; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_38 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 122);
          stepped w_110
      | c_83 when c_83 = tag_cont_39 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 123);
          stepped w_110
      | c_83 when c_83 = tag_cont_40 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          ignore (env_call w_110 [] 2);
          w_110.state.c <- pc_to_exp (int_to_pc 95);
          stepped w_110
      | c_83 when c_83 = tag_cont_41 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          let ctor_arg_25 = pop_env w_110 in
          let ctor_arg_26 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_26; ctor_arg_25 ]);
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          drop_n w_110 1 0;
          assert_env_length w_110 1;
          return_n w_110 1 (pc_to_exp (int_to_pc 0))
      | c_83 when c_83 = tag_cont_42 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          let keep_vals_46 = env_call w_110 [ 0; 1 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_47; keep_vals_46; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 100);
          stepped w_110
      | c_83 when c_83 = tag_cont_43 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          let ctor_arg_27 = pop_env w_110 in
          let ctor_arg_28 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_28; ctor_arg_27 ]);
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_47 = env_call w_110 [ 0; 1; 2 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_48; keep_vals_47; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 45);
          stepped w_110
      | c_83 when c_83 = tag_cont_44 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 125);
          stepped w_110
      | c_83 when c_83 = tag_cont_45 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 126);
          stepped w_110
      | c_83 when c_83 = tag_cont_46 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 0 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 128);
          stepped w_110
      | c_83 when c_83 = tag_cont_47 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 4;
          let keep_vals_49 = env_call w_110 [ 0; 1; 2 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_50; keep_vals_49; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 49);
          stepped w_110
      | c_83 when c_83 = tag_cont_48 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          let keep_vals_50 = env_call w_110 [ 0; 1; 2 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_51; keep_vals_50; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_110
      | c_83 when c_83 = tag_cont_49 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          push_env w_110 (Dynarray.get w_110.state.e 1);
          ...
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 5;
          let keep_vals_51 = env_call w_110 [ 2; 3 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_52; keep_vals_51; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_110
      | c_83 when c_83 = tag_cont_50 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 5;
          let keep_vals_52 = env_call w_110 [ 1; 2; 3 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_53; keep_vals_52; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_110
      | c_83 when c_83 = tag_cont_51 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          w_110.state.c <- pc_to_exp (int_to_pc 129);
          stepped w_110
      | c_83 when c_83 = tag_cont_52 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 2 tl_0;
          assert_env_length w_110 3;
          let ctor_arg_39 = pop_env w_110 in
          let ctor_arg_40 = pop_env w_110 in
          push_env w_110 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_40; ctor_arg_39 ]);
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          ignore (env_call w_110 [] 2);
          w_110.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_110
      | c_83 when c_83 = tag_cont_53 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 5;
          let keep_vals_54 = env_call w_110 [ 0; 1; 2 ] 2 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_55; keep_vals_54; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 104);
          stepped w_110
      | c_83 when c_83 = tag_cont_54 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 0);
          assert_env_length w_110 3;
          let keep_vals_55 = env_call w_110 [ 1 ] 1 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_56; keep_vals_55; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_110
      | c_83 when c_83 = tag_cont_55 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 3 tl_0;
          assert_env_length w_110 4;
          push_env w_110 (Dynarray.get w_110.state.e 1);
          ...
          let keep_vals_56 = env_call w_110 [ 2 ] 3 in
          w_110.state.k <- Memo.appends [ Memo.from_constructor tag_cont_57; keep_vals_56; w_110.state.k ];
          w_110.state.c <- pc_to_exp (int_to_pc 97);
          stepped w_110
      | c_83 when c_83 = tag_cont_56 ->
          w_110.state.k <- get_next_cont tl_0;
          restore_env w_110 1 tl_0;
          assert_env_length w_110 2;
          push_env w_110 (Dynarray.get w_110.state.e 1);
...
let () =
  add_exp
    (fun w_22 ->
      ...
      push_env w_22 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_7 ]);
      assert_env_length w_22 2;
...
let () =
  add_exp
    (fun w_24 ->
      ...
      let x_11 = resolve w_24 last_11 in
      match Word.get_value (fst x_11) with
      | c_11 when c_11 = tag_MkEnv ->
      ...
      | c_11 -> failwith ("unreachable:" ^ string_of_int c_11 ^ "(25)"))
    25
  ...
  add_exp
    (fun w_26 ->
      ...
      | c_12 when c_12 = tag_MkEnv ->
          ...
          let ctor_arg_8 = pop_env w_26 in
          let ctor_arg_9 = pop_env w_26 in
          push_env w_26 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_9; ctor_arg_8 ]);
          assert_env_length w_26 4;
          let ctor_arg_10 = pop_env w_26 in
          push_env w_26 (Memo.appends [ Memo.from_constructor tag_MkEnv; ctor_arg_10 ]);
          assert_env_length w_26 4;
          drop_n w_26 4 1;
          assert_env_length w_26 3;
...
let () =
  add_exp
    (fun w_30 ->
      ...
      let x_15 = resolve w_30 last_15 in
      ...
      | c_15 -> failwith ("unreachable:" ^ string_of_int c_15 ^ "(29)"))
    29
...
let () =
  add_exp
    (fun w_39 ->
      ...
      | c_21 -> failwith ("unreachable:" ^ string_of_int c_21 ^ "(39)"))
    39
  ...
  add_exp
    (fun w_38 ->
      ...
      | c_20 when c_20 = tag_ECons ->
          ...
          stepped w_38
      | c_20 -> failwith ("unreachable:" ^ string_of_int c_20 ^ "(40)"))
    40
...
let () =
  add_exp
    (fun w_43 ->
      ...
      | c_24 -> failwith ("unreachable:" ^ string_of_int c_24 ^ "(42)"))
    42
  ...
  add_exp
    (fun w_42 ->
      ...
      | c_23 when c_23 = tag_ECons ->
          ...
          stepped w_42
      | c_23 -> failwith ("unreachable:" ^ string_of_int c_23 ^ "(43)"))
    43
  ...
  add_exp
    (fun w_41 ->
      ...
      | c_22 when c_22 = tag_ECons ->
          ...
          stepped w_41
      | c_22 -> failwith ("unreachable:" ^ string_of_int c_22 ^ "(44)"))
    44
...
let () =
  add_exp
    (fun w_47 ->
      ...
      | c_27 -> failwith ("unreachable:" ^ string_of_int c_27 ^ "(46)"))
    46
  ...
  add_exp
    (fun w_46 ->
      ...
      | c_26 when c_26 = tag_ECons ->
          ...
          stepped w_46
      | c_26 -> failwith ("unreachable:" ^ string_of_int c_26 ^ "(47)"))
    47
  ...
  add_exp
    (fun w_45 ->
      ...
      | c_25 when c_25 = tag_ECons ->
          ...
          stepped w_45
      | c_25 -> failwith ("unreachable:" ^ string_of_int c_25 ^ "(48)"))
    48
...
let () =
  add_exp
    (fun w_52 ->
      ...
      let last_31 = Source.E 7 in
      let x_31 = resolve w_52 last_31 in
      ...
      | c_31 -> failwith ("unreachable:" ^ string_of_int c_31 ^ "(50)"))
    50
  ...
  add_exp
    (fun w_59 ->
      ...
      | _ ->
          ...
          assert_env_length w_59 3;
          return_n w_59 3 (pc_to_exp (int_to_pc 0))
      | c_35 -> failwith ("unreachable:" ^ string_of_int c_35 ^ "(59)"))
    59
  ...
  add_exp
    (fun w_62 ->
      ...
      | _ ->
          ...
          assert_env_length w_62 3;
          return_n w_62 3 (pc_to_exp (int_to_pc 0))
      | c_38 -> failwith ("unreachable:" ^ string_of_int c_38 ^ "(62)"))
    62
...
let () =
  add_exp
    (fun w_63 ->
      ...
      let x_39 = resolve w_63 last_39 in
      ...
      | _ ->
          ...
          assert_env_length w_63 3;
          return_n w_63 3 (pc_to_exp (int_to_pc 0))
      | c_39 -> failwith ("unreachable:" ^ string_of_int c_39 ^ "(63)"))
    63
...
let () =
  add_exp
    (fun w_64 ->
      ...
      let x_40 = resolve w_64 last_40 in
      ...
      | _ ->
          ...
          assert_env_length w_64 3;
          return_n w_64 3 (pc_to_exp (int_to_pc 0))
      | c_40 -> failwith ("unreachable:" ^ string_of_int c_40 ^ "(64)"))
    64
...
let () =
  add_exp
    (fun w_65 ->
      ...
      let x_41 = resolve w_65 last_41 in
      match Word.get_value (fst x_41) with
      | c_41 when c_41 = tag_SAtom ->
          ignore (pop_env w_65);
...
let () =
  add_exp
    (fun w_66 ->
      ...
      let x_42 = resolve w_66 last_42 in
      match Word.get_value (fst x_42) with
      | c_42 when c_42 = tag_SCar ->
          ignore (pop_env w_66);
      ...
      | _ ->
          ...
          assert_env_length w_66 3;
          return_n w_66 3 (pc_to_exp (int_to_pc 0))
      | c_42 -> failwith ("unreachable:" ^ string_of_int c_42 ^ "(66)"))
    66
...
let () =
  add_exp
    (fun w_67 ->
      ...
      let x_43 = resolve w_67 last_43 in
      match Word.get_value (fst x_43) with
      | c_43 when c_43 = tag_SCdr ->
          ignore (pop_env w_67);
      ...
      | _ ->
          ...
          assert_env_length w_67 3;
          return_n w_67 3 (pc_to_exp (int_to_pc 0))
      | c_43 -> failwith ("unreachable:" ^ string_of_int c_43 ^ "(67)"))
    67
...
let () =
  add_exp
    (fun w_69 ->
      ...
      | c_44 when c_44 = tag_AVar ->
          let splits_35 = Memo.splits (snd x_44) in
      ...
      | c_44 when c_44 = tag_ASymbol ->
          ...
          stepped w_69
      | c_44 when c_44 = tag_ANIL ->
          ignore (pop_env w_69);
          assert_env_length w_69 2;
          push_env w_69 (Dynarray.get w_69.state.e 1);
          w_69.state.c <- pc_to_exp (int_to_pc 75);
          stepped w_69
      | c_44 -> failwith ("unreachable:" ^ string_of_int c_44 ^ "(76)"))
    76
...
let () =
  add_exp
    (fun w_78 ->
      ...
      | c_50 -> failwith ("unreachable:" ^ string_of_int c_50 ^ "(78)"))
    78
...
let () =
  add_exp
    (fun w_77 ->
      ...
      | c_49 when c_49 = tag_EAtom ->
          let splits_41 = Memo.splits (snd x_49) in
      ...
      | c_49 -> failwith ("unreachable:" ^ string_of_int c_49 ^ "(79)"))
    79
...
let () =
  add_exp
    (fun w_81 ->
      ...
      | c_52 -> failwith ("unreachable:" ^ string_of_int c_52 ^ "(82)"))
    82
...
let () =
  add_exp
    (fun w_83 ->
      ...
      | c_53 -> failwith ("unreachable:" ^ string_of_int c_53 ^ "(83)"))
    83
...
let () =
  add_exp
    (fun w_84 ->
      ...
      let x_54 = resolve w_84 last_54 in
      match Word.get_value (fst x_54) with
      | c_54 when c_54 = tag_VQuote ->
          let splits_49 = Memo.splits (snd x_54) in
      ...
      | c_54 -> failwith ("unreachable:" ^ string_of_int c_54 ^ "(84)"))
    84
...
let () =
  add_exp
    (fun w_85 ->
      ...
      let x_55 = resolve w_85 last_55 in
      ...
      | _ ->
          ...
          assert_env_length w_85 3;
          return_n w_85 3 (pc_to_exp (int_to_pc 0))
      | c_55 -> failwith ("unreachable:" ^ string_of_int c_55 ^ "(85)"))
    85
  ...
  add_exp
    (fun w_80 ->
      ...
      | c_51 when c_51 = tag_VSymbol ->
          let splits_46 = Memo.splits (snd x_51) in
      ...
      | c_51 when c_51 = tag_VQuote ->
          let splits_48 = Memo.splits (snd x_51) in
          ...
          stepped w_80
      | c_51 when c_51 = tag_VNIL ->
          ignore (pop_env w_80);
          assert_env_length w_80 2;
          push_env w_80 (Dynarray.get w_80.state.e 1);
          w_80.state.c <- pc_to_exp (int_to_pc 85);
          stepped w_80
      | c_51 when c_51 = tag_VCons ->
          let splits_50 = Memo.splits (snd x_51) in
      ...
      | c_51 when c_51 = tag_VClosure ->
          let splits_51 = Memo.splits (snd x_51) in
          let split0_51 = List.nth splits_51 0 in
          let split1_28 = List.nth splits_51 1 in
          let split2_0 = List.nth splits_51 2 in
          ignore (pop_env w_80);
          push_env w_80 split0_51;
          push_env w_80 split1_28;
          ...
          assert_env_length w_80 3;
          return_n w_80 3 (pc_to_exp (int_to_pc 0))
      | c_51 -> failwith ("unreachable:" ^ string_of_int c_51 ^ "(86)"))
    86
...
let () =
  add_exp
    (fun w_88 ->
      ...
      let x_57 = resolve w_88 last_57 in
      match Word.get_value (fst x_57) with
      | c_57 when c_57 = tag_ECons ->
          let splits_55 = Memo.splits (snd x_57) in
          let split0_55 = List.nth splits_55 0 in
          let split1_29 = List.nth splits_55 1 in
          ignore (pop_env w_88);
          push_env w_88 split0_55;
          push_env w_88 split1_29;
      ...
      | c_57 -> failwith ("unreachable:" ^ string_of_int c_57 ^ "(88)"))
    88
  ...
  add_exp
    (fun w_87 ->
      ...
      | c_56 when c_56 = tag_VNumber ->
          let splits_52 = Memo.splits (snd x_56) in
      ...
      | c_56 when c_56 = tag_VSymbol ->
          let splits_53 = Memo.splits (snd x_56) in
      ...
      | c_56 when c_56 = tag_VCons ->
          ...
          let split1_30 = List.nth splits_56 1 in
          ignore (pop_env w_87);
      ...
      | c_56 when c_56 = tag_VClosure ->
          ...
          let split1_31 = List.nth splits_57 1 in
          let split2_1 = List.nth splits_57 2 in
          ignore (pop_env w_87);
          push_env w_87 split0_57;
          push_env w_87 split1_31;
          push_env w_87 split2_1;
          failwith "car: cannot apply on CLOSURE"
      | c_56 -> failwith ("unreachable:" ^ string_of_int c_56 ^ "(89)"))
    89
...
let () =
  add_exp
    (fun w_91 ->
      ...
      let x_59 = resolve w_91 last_59 in
      match Word.get_value (fst x_59) with
      | c_59 when c_59 = tag_ECons ->
          let splits_61 = Memo.splits (snd x_59) in
          let split0_61 = List.nth splits_61 0 in
          let split1_32 = List.nth splits_61 1 in
          ignore (pop_env w_91);
          push_env w_91 split0_61;
          push_env w_91 split1_32;
  ...
  add_exp
    (fun w_90 ->
      ...
      | c_58 when c_58 = tag_VQuote ->
          let splits_60 = Memo.splits (snd x_58) in
      ...
      | c_58 when c_58 = tag_VClosure ->
          ...
          let split2_2 = List.nth splits_63 2 in
          ignore (pop_env w_90);
          push_env w_90 split0_63;
          push_env w_90 split1_34;
  ...
  add_exp
    (fun w_93 ->
      ...
      | c_60 when c_60 = tag_VQuote ->
          let splits_66 = Memo.splits (snd x_60) in
      ...
      | c_60 when c_60 = tag_VCons ->
          ...
          let split1_35 = List.nth splits_67 1 in
          ignore (pop_env w_93);
      ...
      | c_60 when c_60 = tag_VClosure ->
          ...
          let split1_36 = List.nth splits_68 1 in
          let split2_3 = List.nth splits_68 2 in
          ignore (pop_env w_93);
          push_env w_93 split0_68;
          push_env w_93 split1_36;
...
let () =
  add_exp
    (fun w_98 ->
      ...
      let last_62 = Source.E 5 in
      let x_62 = resolve w_98 last_62 in
      ...
      | c_62 when c_62 = tag_Cons ->
          ...
          let split1_38 = List.nth splits_70 1 in
          ignore (pop_env w_98);
          push_env w_98 split0_70;
          push_env w_98 split1_38;
          ...
          let ctor_arg_11 = pop_env w_98 in
          let ctor_arg_12 = pop_env w_98 in
          push_env w_98 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_12; ctor_arg_11 ]);
          assert_env_length w_98 10;
          ...
          stepped w_98
      | c_62 -> failwith ("unreachable:" ^ string_of_int c_62 ^ "(98)"))
    98
  ...
  add_exp
    (fun w_102 ->
      ...
      | _ ->
          ...
          stepped w_102
      | c_64 -> failwith ("unreachable:" ^ string_of_int c_64 ^ "(103)"))
    103
...
let () =
  add_exp
    (fun w_104 ->
      ...
      let x_65 = resolve w_104 last_65 in
      ...
      | c_65 when c_65 = tag_ECons ->
          ...
          let split1_40 = List.nth splits_73 1 in
          ignore (pop_env w_104);
          push_env w_104 split0_73;
          ...
          let keep_vals_7 = env_call w_104 [ 1; 3 ] 2 in
      ...
      | _ ->
          ...
          push_env w_104 (Memo.from_constructor tag_Nil);
          assert_env_length w_104 3;
...
let () =
  add_exp
    (fun w_106 ->
      ...
      | c_66 -> failwith ("unreachable:" ^ string_of_int c_66 ^ "(108)"))
    108
...
let () =
  add_exp
    (fun w_109 ->
      ...
      | c_68 when c_68 = tag_AVar ->
          let splits_76 = Memo.splits (snd x_68) in
      ...
      | c_68 when c_68 = tag_ANumber ->
          ...
          push_env w_109 (Dynarray.get w_109.state.e 3);
          assert_env_length w_109 5;
          let ctor_arg_13 = pop_env w_109 in
          push_env w_109 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_13 ]);
          assert_env_length w_109 5;
          drop_n w_109 5 1;
          assert_env_length w_109 4;
          drop_n w_109 4 1;
          assert_env_length w_109 3;
          return_n w_109 3 (pc_to_exp (int_to_pc 0))
      | c_68 when c_68 = tag_ASymbol ->
          let splits_78 = Memo.splits (snd x_68) in
          ...
          push_env w_109 (Dynarray.get w_109.state.e 3);
          assert_env_length w_109 5;
          let ctor_arg_14 = pop_env w_109 in
          push_env w_109 (Memo.appends [ Memo.from_constructor tag_VSymbol; ctor_arg_14 ]);
          assert_env_length w_109 5;
          drop_n w_109 5 1;
          assert_env_length w_109 4;
          drop_n w_109 4 1;
...
let () =
  add_exp
    (fun w_108 ->
      ...
      let x_67 = resolve w_108 last_67 in
      ...
      | c_67 when c_67 = tag_EAtom ->
          ...
          push_env w_108 split0_75;
          assert_env_length w_108 3;
          push_env w_108 (Dynarray.get w_108.state.e 2);
          w_108.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_108
      | c_67 when c_67 = tag_ECons ->
          let splits_79 = Memo.splits (snd x_67) in
          let split0_79 = List.nth splits_79 0 in
          let split1_42 = List.nth splits_79 1 in
          ignore (pop_env w_108);
          push_env w_108 split0_79;
          push_env w_108 split1_42;
          assert_env_length w_108 4;
          push_env w_108 (Dynarray.get w_108.state.e 0);
          assert_env_length w_108 5;
          let keep_vals_9 = env_call w_108 [ 0; 1 ] 1 in
          w_108.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_vals_9; w_108.state.k ];
          w_108.state.c <- pc_to_exp (int_to_pc 54);
          stepped w_108
...
let () =
  add_exp
    (fun w_111 ->
      ...
      let cond_0 = resolve w_111 (Source.E 0) in
      ignore (pop_env w_111);
      let if_kont_0 =
       fun _ ->
        assert_env_length w_111 1;
        return_n w_111 1 (pc_to_exp (int_to_pc 0))
      in
      if Word.get_value (fst cond_0) <> 0 then (
        assert_env_length w_111 0;
        push_env w_111 (Memo.from_constructor tag_Unit);
        assert_env_length w_111 1;
        ignore (env_call w_111 [] 1);
        w_111.state.c <- pc_to_exp (int_to_pc 23);
        stepped w_111)
      else (
        assert_env_length w_111 0;
        push_env w_111 (Memo.from_constructor tag_Unit);
        assert_env_length w_111 1;
        ignore (env_call w_111 [] 1);
        w_111.state.c <- pc_to_exp (int_to_pc 22);
        stepped w_111))
    111
  ...
  add_exp
    (fun w_112 ->
      ...
      | c_69 when c_69 = tag_Cons ->
          ...
          stepped w_112
      | c_69 -> failwith ("unreachable:" ^ string_of_int c_69 ^ "(112)"))
    112
...
let () =
  add_exp
    (fun w_113 ->
      ...
      let x_70 = resolve w_113 last_70 in
      match Word.get_value (fst x_70) with
      | c_70 when c_70 = tag_Some ->
          ...
          let keep_vals_11 = env_call w_113 [ 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_12; keep_vals_11; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 100);
          stepped w_113
      | _ ->
          ignore (pop_env w_113);
...
let () =
  add_exp
    (fun w_114 ->
      ...
      let cond_1 = resolve w_114 (Source.E 0) in
      ...
      if Word.get_value (fst cond_1) <> 0 then (
        ...
        assert_env_length w_114 1;
        ignore (env_call w_114 [] 1);
        w_114.state.c <- pc_to_exp (int_to_pc 22);
        stepped w_114))
    114
...
let () =
  add_exp
    (fun w_116 ->
      ...
      let cond_2 = resolve w_116 (Source.E 3) in
      ...
      if Word.get_value (fst cond_2) <> 0 then (
        ...
        w_116.state.c <- pc_to_exp (int_to_pc 8);
        stepped w_116)
      else (
        assert_env_length w_116 3;
        ...
        let ctor_arg_17 = pop_env w_116 in
        push_env w_116 (Memo.appends [ Memo.from_constructor tag_MkEnv; ctor_arg_17 ]);
        assert_env_length w_116 5;
        ignore (env_call w_116 [] 2);
        w_116.state.c <- pc_to_exp (int_to_pc 96);
        stepped w_116))
    115
...
let () =
  add_exp
    (fun w_115 ->
      ...
      let x0_4 = resolve w_115 (Source.E 3) in
      let x1_4 = resolve w_115 (Source.E 4) in
...
let () =
  add_exp
    (fun w_118 ->
      ...
      let x_72 = resolve w_118 last_72 in
      ...
      | c_72 when c_72 = tag_SQuote ->
          ...
          assert_env_length w_118 4;
          let keep_vals_16 = env_call w_118 [] 1 in
      ...
      | c_72 when c_72 = tag_SAtom ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_17 = env_call w_118 [ 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_vals_17; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | c_72 when c_72 = tag_SEq ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_18 = env_call w_118 [ 0; 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_19; keep_vals_18; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | c_72 when c_72 = tag_SCar ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_19 = env_call w_118 [ 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_20; keep_vals_19; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | c_72 when c_72 = tag_SCdr ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_20 = env_call w_118 [ 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_21; keep_vals_20; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | c_72 when c_72 = tag_SCons ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_21 = env_call w_118 [ 0; 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_22; keep_vals_21; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | c_72 when c_72 = tag_SCond ->
          ...
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_22 = env_call w_118 [ 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_23; keep_vals_22; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_118
      | c_72 when c_72 = tag_SNull ->
          ignore (pop_env w_118);
          assert_env_length w_118 3;
          push_env w_118 (Dynarray.get w_118.state.e 0);
          assert_env_length w_118 4;
          let keep_vals_23 = env_call w_118 [ 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_24; keep_vals_23; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 32);
          stepped w_118
      | _ ->
          ignore (pop_env w_118);
  ...
  add_exp
    (fun w_117 ->
      ...
      | c_71 when c_71 = tag_None ->
          ...
          assert_env_length w_117 3;
          let keep_vals_24 = env_call w_117 [ 0; 1 ] 1 in
          w_117.state.k <- Memo.appends [ Memo.from_constructor tag_cont_25; keep_vals_24; w_117.state.k ];
  ...
  add_exp
    (fun w_119 ->
      ...
      | c_73 when c_73 = tag_ECons ->
          let splits_83 = Memo.splits (snd x_73) in
          let split0_83 = List.nth splits_83 0 in
          let split1_44 = List.nth splits_83 1 in
          ignore (pop_env w_119);
          push_env w_119 split0_83;
          push_env w_119 split1_44;
          assert_env_length w_119 4;
          push_env w_119 (Dynarray.get w_119.state.e 0);
          assert_env_length w_119 5;
          let keep_vals_32 = env_call w_119 [ 0; 1 ] 1 in
...
let () =
  add_exp
    (fun w_120 ->
      ...
      let cond_3 = resolve w_120 (Source.E 3) in
      ...
      if Word.get_value (fst cond_3) <> 0 then (
        ...
        push_env w_120 (Dynarray.get w_120.state.e 2);
        assert_env_length w_120 4;
        ...
        assert_env_length w_120 4;
        let keep_vals_34 = env_call w_120 [ 0 ] 1 in
...
let () =
  add_exp
    (fun w_122 ->
      ...
      | c_75 when c_75 = tag_SLambda ->
          ignore (pop_env w_122);
          assert_env_length w_122 3;
          push_env w_122 (Dynarray.get w_122.state.e 0);
          assert_env_length w_122 4;
          let keep_vals_41 = env_call w_122 [ 0; 1 ] 1 in
          w_122.state.k <- Memo.appends [ Memo.from_constructor tag_cont_42; keep_vals_41; w_122.state.k ];
          w_122.state.c <- pc_to_exp (int_to_pc 45);
          stepped w_122
      | c_75 when c_75 = tag_SDefine ->
          ignore (pop_env w_122);
          assert_env_length w_122 3;
          push_env w_122 (Memo.from_constructor tag_SLambda);
          assert_env_length w_122 4;
          let ctor_arg_23 = pop_env w_122 in
          push_env w_122 (Memo.appends [ Memo.from_constructor tag_ASymbol; ctor_arg_23 ]);
          assert_env_length w_122 4;
          let ctor_arg_24 = pop_env w_122 in
          push_env w_122 (Memo.appends [ Memo.from_constructor tag_EAtom; ctor_arg_24 ]);
          assert_env_length w_122 4;
          push_env w_122 (Dynarray.get w_122.state.e 0);
          assert_env_length w_122 5;
          let keep_vals_42 = env_call w_122 [ 0; 1; 3 ] 1 in
          w_122.state.k <- Memo.appends [ Memo.from_constructor tag_cont_43; keep_vals_42; w_122.state.k ];
          w_122.state.c <- pc_to_exp (int_to_pc 41);
          stepped w_122
      | c_75 when c_75 = tag_SQuote ->
          ignore (pop_env w_122);
          failwith "unexpected function quote"
      | c_75 when c_75 = tag_SEq ->
          ignore (pop_env w_122);
          failwith "unexpected function eq"
      | c_75 when c_75 = tag_SCons ->
          ignore (pop_env w_122);
          failwith "unexpected function cons"
      | c_75 when c_75 = tag_SCond ->
          ignore (pop_env w_122);
          failwith "unexpected function cond"
      | c_75 when c_75 = tag_SAtom ->
          ignore (pop_env w_122);
          failwith "unexpected function atom"
      | c_75 when c_75 = tag_SCar ->
          ignore (pop_env w_122);
          failwith "unexpected function car"
      | c_75 when c_75 = tag_SCdr ->
          ignore (pop_env w_122);
          failwith "unexpected function cdr"
      | c_75 when c_75 = tag_SNull ->
          ignore (pop_env w_122);
          failwith "unexpected function null"
      | _ ->
          ignore (pop_env w_122);
          failwith "1"
      | c_75 -> failwith ("unreachable:" ^ string_of_int c_75 ^ "(121)"))
    121
...
let () =
  add_exp
    (fun w_121 ->
      ...
      let x_74 = resolve w_121 last_74 in
      match Word.get_value (fst x_74) with
      | c_74 when c_74 = tag_Some ->
          let splits_84 = Memo.splits (snd x_74) in
          let split0_84 = List.nth splits_84 0 in
          ignore (pop_env w_121);
          push_env w_121 split0_84;
          assert_env_length w_121 3;
          push_env w_121 (Dynarray.get w_121.state.e 2);
          w_121.state.c <- pc_to_exp (int_to_pc 121);
          stepped w_121
      | c_74 when c_74 = tag_None ->
          ignore (pop_env w_121);
          assert_env_length w_121 2;
          push_env w_121 (Dynarray.get w_121.state.e 0);
          assert_env_length w_121 3;
          let keep_vals_43 = env_call w_121 [] 1 in
          w_121.state.k <- Memo.appends [ Memo.from_constructor tag_cont_44; keep_vals_43; w_121.state.k ];
          w_121.state.c <- pc_to_exp (int_to_pc 35);
          stepped w_121
      | c_74 -> failwith ("unreachable:" ^ string_of_int c_74 ^ "(122)"))
    122
  ...
  add_exp
    (fun w_123 ->
      ...
      | c_76 when c_76 = tag_Some ->
          ...
          let keep_vals_44 = env_call w_123 [ 0 ] 2 in
          w_123.state.k <- Memo.appends [ Memo.from_constructor tag_cont_45; keep_vals_44; w_123.state.k ];
          w_123.state.c <- pc_to_exp (int_to_pc 96);
          stepped w_123
      | c_76 when c_76 = tag_None ->
          ...
          assert_env_length w_123 3;
          let keep_vals_45 = env_call w_123 [] 1 in
          w_123.state.k <- Memo.appends [ Memo.from_constructor tag_cont_46; keep_vals_45; w_123.state.k ];
          w_123.state.c <- pc_to_exp (int_to_pc 54);
          stepped w_123
...
let () =
  add_exp
    (fun w_124 ->
      ...
      let x_77 = resolve w_124 last_77 in
      ...
      | c_77 -> failwith ("unreachable:" ^ string_of_int c_77 ^ "(125)"))
    125
  ...
  add_exp
    (fun w_126 ->
      ...
      | c_79 when c_79 = tag_VClosure ->
          ...
          let split2_4 = List.nth splits_95 2 in
          ignore (pop_env w_126);
          push_env w_126 split0_95;
          push_env w_126 split1_47;
          push_env w_126 split2_4;
          ...
          assert_env_length w_126 8;
          let ctor_arg_29 = pop_env w_126 in
          let ctor_arg_30 = pop_env w_126 in
          let ctor_arg_31 = pop_env w_126 in
          push_env w_126 (Memo.appends [ Memo.from_constructor tag_VClosure; ctor_arg_31; ctor_arg_30; ctor_arg_29 ]);
          assert_env_length w_126 6;
          let ctor_arg_32 = pop_env w_126 in
          let ctor_arg_33 = pop_env w_126 in
          push_env w_126 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_33; ctor_arg_32 ]);
          assert_env_length w_126 5;
          push_env w_126 (Dynarray.get w_126.state.e 3);
          assert_env_length w_126 6;
          let keep_vals_48 = env_call w_126 [ 0; 2 ] 2 in
          w_126.state.k <- Memo.appends [ Memo.from_constructor tag_cont_49; keep_vals_48; w_126.state.k ];
          w_126.state.c <- pc_to_exp (int_to_pc 26);
          stepped w_126
  ...
  add_exp
    (fun w_127 ->
      ...
      | _ ->
          ignore (pop_env w_127);
          failwith "impossible"
      | c_80 -> failwith ("unreachable:" ^ string_of_int c_80 ^ "(128)"))
    128
...
let () =
  add_exp
    (fun w_129 ->
      ...
      let x_82 = resolve w_129 last_82 in
      ...
      | c_82 when c_82 = tag_Some ->
          ...
          let ctor_arg_34 = pop_env w_129 in
          let ctor_arg_35 = pop_env w_129 in
          let ctor_arg_36 = pop_env w_129 in
          push_env w_129 (Memo.appends [ Memo.from_constructor tag_VClosure; ctor_arg_36; ctor_arg_35; ctor_arg_34 ]);
          assert_env_length w_129 5;
          push_env w_129 (Dynarray.get w_129.state.e 3);
          assert_env_length w_129 6;
          push_env w_129 (Dynarray.get w_129.state.e 4);
          assert_env_length w_129 7;
          let ctor_arg_37 = pop_env w_129 in
          let ctor_arg_38 = pop_env w_129 in
          push_env w_129 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_38; ctor_arg_37 ]);
          assert_env_length w_129 6;
          push_env w_129 (Dynarray.get w_129.state.e 1);
          assert_env_length w_129 7;
          let keep_vals_53 = env_call w_129 [ 0 ] 2 in
          w_129.state.k <- Memo.appends [ Memo.from_constructor tag_cont_54; keep_vals_53; w_129.state.k ];
          w_129.state.c <- pc_to_exp (int_to_pc 26);
          stepped w_129
      | c_82 -> failwith ("unreachable:" ^ string_of_int c_82 ^ "(129)"))
    129
...
let () = Words.set_constructor_degree 27 (-2)
...
let () = Words.set_constructor_degree 45 (-4)
