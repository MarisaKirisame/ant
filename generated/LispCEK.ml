...
type symbol = SLambda | SDefine | SQuote | SEq | SIf | SDefvar | SCons | SCond | SAtom | SCar | SCdr | SNull | SError
...
let rec expr_eq memo (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 86)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done) memo
...
let rec pairlis memo (x0 : Value.seq) (x1 : Value.seq) (x2 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 106)) (Dynarray.of_list [ x0; x1; x2 ]) (Memo.from_constructor tag_cont_done) memo
...
let () =
  add_exp
    (fun w_120 ->
      ...
      | c_95 when c_95 = tag_cont_done -> exec_done w_120
      | c_95 when c_95 = tag_cont_1 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 122);
          stepped w_120
      | c_95 when c_95 = tag_cont_2 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 124);
          stepped w_120
      | c_95 when c_95 = tag_cont_3 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          let ctor_arg_16 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_16 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          drop_n w_120 1 0;
      ...
      | c_95 when c_95 = tag_cont_4 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          let ctor_arg_17 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_17 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          return_n w_120 1 (pc_to_exp (int_to_pc 0))
      | c_95 when c_95 = tag_cont_5 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 125);
          stepped w_120
      | c_95 when c_95 = tag_cont_6 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 126);
          stepped w_120
      | c_95 when c_95 = tag_cont_7 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          ignore (env_call w_120 [] 3);
          w_120.state.c <- pc_to_exp (int_to_pc 106);
          stepped w_120
      | c_95 when c_95 = tag_cont_8 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_120
      | c_95 when c_95 = tag_cont_9 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 128);
          stepped w_120
      | c_95 when c_95 = tag_cont_10 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          ...
          let keep_vals_14 = env_call w_120 [ 2 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_15; keep_vals_14; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 114);
          stepped w_120
      | c_95 when c_95 = tag_cont_11 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 5;
          let keep_vals_15 = env_call w_120 [ 0; 1; 2 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_16; keep_vals_15; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_12 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          let keep_vals_16 = env_call w_120 [ 0; 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_17; keep_vals_16; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_120
      | c_95 when c_95 = tag_cont_13 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_14 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          let ctor_arg_19 = pop_env w_120 in
          let ctor_arg_20 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_20; ctor_arg_19 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          return_n w_120 1 (pc_to_exp (int_to_pc 0))
      | c_95 when c_95 = tag_cont_15 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          let ctor_arg_21 = pop_env w_120 in
          let ctor_arg_22 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_22; ctor_arg_21 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          return_n w_120 1 (pc_to_exp (int_to_pc 0))
      | c_95 when c_95 = tag_cont_16 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Memo.from_constructor tag_Unit);
          assert_env_length w_120 5;
          let keep_vals_17 = env_call w_120 [ 0; 1; 2; 3 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_vals_17; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 24);
          stepped w_120
      | c_95 when c_95 = tag_cont_17 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 132);
          stepped w_120
      | c_95 when c_95 = tag_cont_18 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 4 tl_0;
          assert_env_length w_120 5;
          let keep_vals_29 = env_call w_120 [ 0; 1; 2 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_30; keep_vals_29; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 89);
          stepped w_120
      | c_95 when c_95 = tag_cont_19 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          let ctor_arg_23 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_23 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          return_n w_120 1 (pc_to_exp (int_to_pc 0))
      | c_95 when c_95 = tag_cont_20 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_30 = env_call w_120 [] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_31; keep_vals_30; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_21 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 1);
          assert_env_length w_120 4;
          let keep_vals_31 = env_call w_120 [ 0; 1 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_32; keep_vals_31; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_22 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_32 = env_call w_120 [] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_33; keep_vals_32; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_23 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_33 = env_call w_120 [] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_34; keep_vals_33; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_24 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_34 = env_call w_120 [ 0; 1; 2 ] 1 in
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_25 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 1);
          assert_env_length w_120 4;
          let keep_vals_35 = env_call w_120 [ 0; 1 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_36; keep_vals_35; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_26 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_27 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_36 = env_call w_120 [] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_37; keep_vals_36; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_28 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_37 = env_call w_120 [] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_38; keep_vals_37; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_29 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 133);
          stepped w_120
      | c_95 when c_95 = tag_cont_30 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 134);
          stepped w_120
      | c_95 when c_95 = tag_cont_31 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_32 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_41 = env_call w_120 [ 1; 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_42; keep_vals_41; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 30);
          stepped w_120
      | c_95 when c_95 = tag_cont_33 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          ignore (env_call w_120 [] 1);
          w_120.state.c <- pc_to_exp (int_to_pc 96);
          stepped w_120
      | c_95 when c_95 = tag_cont_34 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          ignore (env_call w_120 [] 1);
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_35 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 5;
          let keep_vals_42 = env_call w_120 [ 1; 2; 3 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_43; keep_vals_42; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_120
      | c_95 when c_95 = tag_cont_36 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_43 = env_call w_120 [ 1; 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_44; keep_vals_43; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 30);
          stepped w_120
      | c_95 when c_95 = tag_cont_37 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          ignore (env_call w_120 [] 1);
          w_120.state.c <- pc_to_exp (int_to_pc 112);
          stepped w_120
      | c_95 when c_95 = tag_cont_38 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          assert_env_length w_120 1;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 2;
          let keep_vals_44 = env_call w_120 [] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_45; keep_vals_44; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 22);
          stepped w_120
      | c_95 when c_95 = tag_cont_39 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          let keep_vals_45 = env_call w_120 [ 0; 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_46; keep_vals_45; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_120
      | c_95 when c_95 = tag_cont_40 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          let keep_vals_46 = env_call w_120 [ 0; 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_47; keep_vals_46; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 13);
          stepped w_120
      | c_95 when c_95 = tag_cont_41 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          ...
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_42 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_47 = env_call w_120 [ 1 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_48; keep_vals_47; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_43 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 1);
          ...
          let keep_vals_48 = env_call w_120 [ 0; 2; 3 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_49; keep_vals_48; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_44 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_49 = env_call w_120 [ 1 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_50; keep_vals_49; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_45 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 136);
          stepped w_120
      | c_95 when c_95 = tag_cont_46 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 138);
          stepped w_120
      | c_95 when c_95 = tag_cont_47 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 139);
          stepped w_120
      | c_95 when c_95 = tag_cont_48 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          ignore (env_call w_120 [] 2);
          w_120.state.c <- pc_to_exp (int_to_pc 104);
          stepped w_120
      | c_95 when c_95 = tag_cont_49 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          ...
          push_env w_120 (Memo.from_constructor tag_Unit);
          assert_env_length w_120 6;
          let keep_vals_56 = env_call w_120 [ 0; 1; 2; 4 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_57; keep_vals_56; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 24);
          stepped w_120
      | c_95 when c_95 = tag_cont_50 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          let ctor_arg_26 = pop_env w_120 in
          let ctor_arg_27 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_27; ctor_arg_26 ]);
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          drop_n w_120 1 0;
          assert_env_length w_120 1;
          return_n w_120 1 (pc_to_exp (int_to_pc 0))
      | c_95 when c_95 = tag_cont_51 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          let keep_vals_57 = env_call w_120 [ 0; 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_58; keep_vals_57; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_120
      | c_95 when c_95 = tag_cont_52 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          let ctor_arg_28 = pop_env w_120 in
          let ctor_arg_29 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_29; ctor_arg_28 ]);
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_58 = env_call w_120 [ 0; 1; 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_59; keep_vals_58; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 52);
          stepped w_120
      | c_95 when c_95 = tag_cont_53 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 1);
          assert_env_length w_120 4;
          let keep_vals_59 = env_call w_120 [ 0; 1 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_60; keep_vals_59; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_54 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 141);
          stepped w_120
      | c_95 when c_95 = tag_cont_55 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 142);
          stepped w_120
      | c_95 when c_95 = tag_cont_56 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 0 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 144);
          stepped w_120
      | c_95 when c_95 = tag_cont_57 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 4 tl_0;
          assert_env_length w_120 5;
          let keep_vals_61 = env_call w_120 [ 0; 1; 2 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_62; keep_vals_61; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 89);
          stepped w_120
      | c_95 when c_95 = tag_cont_58 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_62 = env_call w_120 [ 0; 1; 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_63; keep_vals_62; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_120
      | c_95 when c_95 = tag_cont_59 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          let keep_vals_63 = env_call w_120 [ 0; 1; 2 ] 1 in
          ...
          stepped w_120
      | c_95 when c_95 = tag_cont_60 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 4;
          let keep_vals_64 = env_call w_120 [ 0; 1; 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_65; keep_vals_64; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 52);
          stepped w_120
      | c_95 when c_95 = tag_cont_61 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 2 tl_0;
          assert_env_length w_120 3;
          let ctor_arg_30 = pop_env w_120 in
          let ctor_arg_31 = pop_env w_120 in
          push_env w_120 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_31; ctor_arg_30 ]);
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          ignore (env_call w_120 [] 2);
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_62 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 145);
          stepped w_120
      | c_95 when c_95 = tag_cont_63 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 5;
          let keep_vals_65 = env_call w_120 [ 1; 2; 3 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_66; keep_vals_65; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 63);
          stepped w_120
      | c_95 when c_95 = tag_cont_64 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 146);
          stepped w_120
      | c_95 when c_95 = tag_cont_65 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          ...
          w_120.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_120
      | c_95 when c_95 = tag_cont_66 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 5;
          let keep_vals_68 = env_call w_120 [ 0; 1; 2 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_69; keep_vals_68; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 114);
          stepped w_120
      | c_95 when c_95 = tag_cont_67 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_69 = env_call w_120 [ 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_70; keep_vals_69; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_120
      | c_95 when c_95 = tag_cont_68 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          w_120.state.c <- pc_to_exp (int_to_pc 147);
          stepped w_120
      | c_95 when c_95 = tag_cont_69 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 3 tl_0;
          assert_env_length w_120 4;
          push_env w_120 (Dynarray.get w_120.state.e 1);
      ...
      | c_95 when c_95 = tag_cont_70 ->
          ...
          w_120.state.c <- pc_to_exp (int_to_pc 116);
          stepped w_120
      | c_95 when c_95 = tag_cont_71 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
          assert_env_length w_120 3;
          let keep_vals_72 = env_call w_120 [ 1 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_73; keep_vals_72; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_120
      | c_95 when c_95 = tag_cont_72 ->
          w_120.state.k <- get_next_cont tl_0;
          restore_env w_120 1 tl_0;
          assert_env_length w_120 2;
          push_env w_120 (Dynarray.get w_120.state.e 0);
...
let () =
  add_exp
    (fun w_64 ->
      ...
      w_64.state.c <- pc_to_exp (int_to_pc 77);
      stepped w_64)
    65
  ...
  add_exp
    (fun w_65 ->
      ...
      | c_39 when c_39 = tag_SCdr ->
          ...
          stepped w_65
      | c_39 -> failwith ("unreachable:" ^ string_of_int c_39 ^ "(77)"))
    77
...
let () =
  add_exp
    (fun w_77 ->
      ...
      w_77.state.c <- pc_to_exp (int_to_pc 85);
      stepped w_77)
    78
...
let () =
  add_exp
    (fun w_80 ->
      ...
      let x0_1 = resolve w_80 (Source.E 4) in
      let x1_1 = resolve w_80 (Source.E 5) in
      ignore (pop_env w_80);
      ignore (pop_env w_80);
      push_env w_80 (Memo.from_int (if Word.get_value (fst x0_1) = Word.get_value (fst x1_1) then 1 else 0));
...
let () =
  add_exp
    (fun w_79 ->
      ...
      | c_52 when c_52 = tag_AVar ->
          let splits_42 = Memo.splits (snd x_52) in
          let split0_42 = List.nth splits_42 0 in
          ignore (pop_env w_79);
          push_env w_79 split0_42;
          assert_env_length w_79 4;
      ...
      | c_52 -> failwith ("unreachable:" ^ string_of_int c_52 ^ "(80)"))
    80
...
let () =
  add_exp
    (fun w_82 ->
      ...
      let x0_2 = resolve w_82 (Source.E 4) in
      let x1_2 = resolve w_82 (Source.E 5) in
      ignore (pop_env w_82);
      ignore (pop_env w_82);
      push_env w_82 (Memo.from_int (if Word.get_value (fst x0_2) = Word.get_value (fst x1_2) then 1 else 0));
...
let () =
  add_exp
    (fun w_81 ->
      ...
      let last_53 = Source.E 3 in
      let x_53 = resolve w_81 last_53 in
      match Word.get_value (fst x_53) with
      | c_53 when c_53 = tag_ANumber ->
          let splits_44 = Memo.splits (snd x_53) in
          let split0_44 = List.nth splits_44 0 in
          ignore (pop_env w_81);
          push_env w_81 split0_44;
          assert_env_length w_81 4;
      ...
      | c_53 -> failwith ("unreachable:" ^ string_of_int c_53 ^ "(82)"))
    82
...
let () =
  add_exp
    (fun w_83 ->
      ...
      let last_54 = Source.E 3 in
      let x_54 = resolve w_83 last_54 in
      match Word.get_value (fst x_54) with
      | c_54 when c_54 = tag_ASymbol ->
          let splits_46 = Memo.splits (snd x_54) in
          let split0_46 = List.nth splits_46 0 in
          ignore (pop_env w_83);
          push_env w_83 split0_46;
          assert_env_length w_83 4;
          ...
          w_83.state.c <- pc_to_exp (int_to_pc 65);
          stepped w_83
      | _ ->
          ignore (pop_env w_83);
      ...
      | c_54 -> failwith ("unreachable:" ^ string_of_int c_54 ^ "(83)"))
    83
...
let () =
  add_exp
    (fun w_84 ->
      ...
      let x_55 = resolve w_84 last_55 in
      ...
      | _ ->
          ...
          assert_env_length w_84 3;
          return_n w_84 3 (pc_to_exp (int_to_pc 0))
      | c_55 -> failwith ("unreachable:" ^ string_of_int c_55 ^ "(84)"))
    84
...
let () =
  add_exp
    (fun w_78 ->
      ...
      | c_51 when c_51 = tag_AVar ->
          let splits_41 = Memo.splits (snd x_51) in
          let split0_41 = List.nth splits_41 0 in
          ignore (pop_env w_78);
          push_env w_78 split0_41;
          assert_env_length w_78 3;
          push_env w_78 (Dynarray.get w_78.state.e 1);
          w_78.state.c <- pc_to_exp (int_to_pc 80);
          stepped w_78
      | c_51 when c_51 = tag_ANumber ->
          let splits_43 = Memo.splits (snd x_51) in
          let split0_43 = List.nth splits_43 0 in
          ignore (pop_env w_78);
          push_env w_78 split0_43;
          assert_env_length w_78 3;
          push_env w_78 (Dynarray.get w_78.state.e 1);
          w_78.state.c <- pc_to_exp (int_to_pc 82);
          stepped w_78
      | c_51 when c_51 = tag_ASymbol ->
          ...
          assert_env_length w_78 3;
          push_env w_78 (Dynarray.get w_78.state.e 1);
          w_78.state.c <- pc_to_exp (int_to_pc 83);
          stepped w_78
      | c_51 when c_51 = tag_ANIL ->
          ignore (pop_env w_78);
...
let () =
  add_exp
    (fun w_85 ->
      ...
      w_85.state.c <- pc_to_exp (int_to_pc 88);
      stepped w_85)
    86
...
let () =
  add_exp
    (fun w_87 ->
      ...
      let x_57 = resolve w_87 last_57 in
      match Word.get_value (fst x_57) with
      | c_57 when c_57 = tag_EAtom ->
          let splits_48 = Memo.splits (snd x_57) in
          let split0_48 = List.nth splits_48 0 in
          ignore (pop_env w_87);
          push_env w_87 split0_48;
          assert_env_length w_87 4;
          push_env w_87 (Dynarray.get w_87.state.e 2);
          assert_env_length w_87 5;
          push_env w_87 (Dynarray.get w_87.state.e 3);
          assert_env_length w_87 6;
          ignore (env_call w_87 [] 2);
          w_87.state.c <- pc_to_exp (int_to_pc 78);
          stepped w_87
      | _ ->
          ignore (pop_env w_87);
      ...
      | c_57 -> failwith ("unreachable:" ^ string_of_int c_57 ^ "(87)"))
    87
...
let () =
  add_exp
    (fun w_86 ->
      ...
      | c_56 -> failwith ("unreachable:" ^ string_of_int c_56 ^ "(88)"))
    88
...
let () =
  add_exp
    (fun w_88 ->
      ...
      w_88.state.c <- pc_to_exp (int_to_pc 95);
      stepped w_88)
    89
...
let () =
  add_exp
    (fun w_91 ->
      ...
      let x0_3 = resolve w_91 (Source.E 4) in
      let x1_3 = resolve w_91 (Source.E 5) in
      ignore (pop_env w_91);
      ignore (pop_env w_91);
      push_env w_91 (Memo.from_int (if Word.get_value (fst x0_3) = Word.get_value (fst x1_3) then 1 else 0));
  ...
  add_exp
    (fun w_90 ->
      ...
      | c_59 when c_59 = tag_VQuote ->
          let splits_52 = Memo.splits (snd x_59) in
          let split0_52 = List.nth splits_52 0 in
          ignore (pop_env w_90);
          push_env w_90 split0_52;
          assert_env_length w_90 4;
          push_env w_90 (Dynarray.get w_90.state.e 3);
          assert_env_length w_90 5;
          let keep_vals_0 = env_call w_90 [ 2 ] 1 in
          w_90.state.k <- Memo.appends [ Memo.from_constructor tag_cont_1; keep_vals_0; w_90.state.k ];
          w_90.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_90
      | _ ->
          ignore (pop_env w_90);
      ...
      | c_59 -> failwith ("unreachable:" ^ string_of_int c_59 ^ "(91)"))
    91
...
let () =
  add_exp
    (fun w_92 ->
      ...
      | c_60 -> failwith ("unreachable:" ^ string_of_int c_60 ^ "(92)"))
    92
...
let () =
  add_exp
    (fun w_93 ->
      ...
      let x_61 = resolve w_93 last_61 in
      match Word.get_value (fst x_61) with
      | c_61 when c_61 = tag_VQuote ->
          let splits_56 = Memo.splits (snd x_61) in
          let split0_56 = List.nth splits_56 0 in
          ignore (pop_env w_93);
          push_env w_93 split0_56;
          assert_env_length w_93 4;
          ...
          ignore (env_call w_93 [] 2);
          w_93.state.c <- pc_to_exp (int_to_pc 86);
          stepped w_93
      | c_61 when c_61 = tag_VNumber ->
          let splits_57 = Memo.splits (snd x_61) in
          ...
          push_env w_93 (Dynarray.get w_93.state.e 2);
          assert_env_length w_93 5;
          let keep_vals_1 = env_call w_93 [ 3 ] 1 in
          w_93.state.k <- Memo.appends [ Memo.from_constructor tag_cont_2; keep_vals_1; w_93.state.k ];
          w_93.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_93
      | _ ->
          ignore (pop_env w_93);
...
let () =
  add_exp
    (fun w_94 ->
      ...
      let x_62 = resolve w_94 last_62 in
      ...
      | _ ->
          ...
          assert_env_length w_94 3;
          return_n w_94 3 (pc_to_exp (int_to_pc 0))
      | c_62 -> failwith ("unreachable:" ^ string_of_int c_62 ^ "(94)"))
    94
...
let () =
  add_exp
    (fun w_89 ->
      ...
      let x_58 = resolve w_89 last_58 in
      match Word.get_value (fst x_58) with
      | c_58 when c_58 = tag_VNumber ->
          let splits_50 = Memo.splits (snd x_58) in
...
let () =
  add_exp
    (fun w_97 ->
      ...
      let x_64 = resolve w_97 last_64 in
      match Word.get_value (fst x_64) with
      | c_64 when c_64 = tag_ECons ->
          let splits_63 = Memo.splits (snd x_64) in
          let split0_63 = List.nth splits_63 0 in
          let split1_33 = List.nth splits_63 1 in
          ignore (pop_env w_97);
          push_env w_97 split0_63;
          push_env w_97 split1_33;
          assert_env_length w_97 4;
          push_env w_97 (Dynarray.get w_97.state.e 1);
          assert_env_length w_97 5;
          let keep_vals_2 = env_call w_97 [] 1 in
          w_97.state.k <- Memo.appends [ Memo.from_constructor tag_cont_3; keep_vals_2; w_97.state.k ];
          w_97.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_97
      | _ ->
          ignore (pop_env w_97);
          failwith "car: PAIR expected"
      | c_64 -> failwith ("unreachable:" ^ string_of_int c_64 ^ "(97)"))
    97
...
let () =
  add_exp
    (fun w_100 ->
      ...
      let x_66 = resolve w_100 last_66 in
      match Word.get_value (fst x_66) with
      | c_66 when c_66 = tag_ECons ->
          let splits_69 = Memo.splits (snd x_66) in
          let split0_69 = List.nth splits_69 0 in
          let split1_36 = List.nth splits_69 1 in
          ignore (pop_env w_100);
          push_env w_100 split0_69;
          push_env w_100 split1_36;
          assert_env_length w_100 4;
          push_env w_100 (Dynarray.get w_100.state.e 1);
          assert_env_length w_100 5;
          let keep_vals_3 = env_call w_100 [] 1 in
          w_100.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_vals_3; w_100.state.k ];
          w_100.state.c <- pc_to_exp (int_to_pc 63);
          stepped w_100
      | _ ->
          ignore (pop_env w_100);
          failwith "cdr: PAIR expected"
      | c_66 -> failwith ("unreachable:" ^ string_of_int c_66 ^ "(100)"))
    100
...
let () =
  add_exp
    (fun w_99 ->
      ...
      | c_65 -> failwith ("unreachable:" ^ string_of_int c_65 ^ "(101)"))
    101
...
let () =
  add_exp
    (fun w_102 ->
      ...
      let x_67 = resolve w_102 last_67 in
      match Word.get_value (fst x_67) with
      | c_67 when c_67 = tag_VNumber ->
          let splits_72 = Memo.splits (snd x_67) in
          let split0_72 = List.nth splits_72 0 in
          ignore (pop_env w_102);
          push_env w_102 split0_72;
          assert_env_length w_102 2;
          push_env w_102 (Memo.from_constructor tag_Unit);
          assert_env_length w_102 3;
          ignore (env_call w_102 [] 1);
          w_102.state.c <- pc_to_exp (int_to_pc 25);
          stepped w_102
      | c_67 when c_67 = tag_VSymbol ->
          let splits_73 = Memo.splits (snd x_67) in
          let split0_73 = List.nth splits_73 0 in
          ignore (pop_env w_102);
          push_env w_102 split0_73;
          assert_env_length w_102 2;
          push_env w_102 (Memo.from_constructor tag_Unit);
          assert_env_length w_102 3;
          ignore (env_call w_102 [] 1);
      ...
      | c_67 when c_67 = tag_VQuote ->
          let splits_74 = Memo.splits (snd x_67) in
          let split0_74 = List.nth splits_74 0 in
          ignore (pop_env w_102);
          push_env w_102 split0_74;
          assert_env_length w_102 2;
          push_env w_102 (Memo.from_constructor tag_Unit);
          assert_env_length w_102 3;
          ignore (env_call w_102 [] 1);
      ...
      | c_67 when c_67 = tag_VClosure ->
          ...
          w_102.state.c <- pc_to_exp (int_to_pc 25);
          stepped w_102
      | c_67 -> failwith ("unreachable:" ^ string_of_int c_67 ^ "(103)"))
    103
...
let () =
  add_exp
    (fun w_103 ->
      ...
      let keep_vals_4 = env_call w_103 [] 2 in
      w_103.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_vals_4; w_103.state.k ];
      w_103.state.c <- pc_to_exp (int_to_pc 89);
      stepped w_103)
    104
...
let () =
  add_exp
    (fun w_104 ->
      ...
      let keep_vals_5 = env_call w_104 [ 0 ] 1 in
      w_104.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; keep_vals_5; w_104.state.k ];
      w_104.state.c <- pc_to_exp (int_to_pc 26);
      stepped w_104)
    105
...
let () =
  add_exp
    (fun w_107 ->
      ...
      let last_69 = Source.E 5 in
      let x_69 = resolve w_107 last_69 in
      ...
      | c_69 when c_69 = tag_Cons ->
          let splits_78 = Memo.splits (snd x_69) in
          let split0_78 = List.nth splits_78 0 in
          let split1_42 = List.nth splits_78 1 in
          ignore (pop_env w_107);
          push_env w_107 split0_78;
          push_env w_107 split1_42;
          assert_env_length w_107 7;
          push_env w_107 (Dynarray.get w_107.state.e 4);
          assert_env_length w_107 8;
          push_env w_107 (Dynarray.get w_107.state.e 6);
          assert_env_length w_107 9;
          push_env w_107 (Dynarray.get w_107.state.e 3);
          assert_env_length w_107 10;
          push_env w_107 (Dynarray.get w_107.state.e 5);
          assert_env_length w_107 11;
          let ctor_arg_12 = pop_env w_107 in
          let ctor_arg_13 = pop_env w_107 in
          push_env w_107 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_13; ctor_arg_12 ]);
          assert_env_length w_107 10;
          push_env w_107 (Dynarray.get w_107.state.e 2);
          assert_env_length w_107 11;
          let keep_vals_6 = env_call w_107 [ 7; 8 ] 2 in
          w_107.state.k <- Memo.appends [ Memo.from_constructor tag_cont_7; keep_vals_6; w_107.state.k ];
          w_107.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_107
      | c_69 -> failwith ("unreachable:" ^ string_of_int c_69 ^ "(107)"))
    107
...
let () =
  add_exp
    (fun w_106 ->
      ...
      let x_68 = resolve w_106 last_68 in
      match Word.get_value (fst x_68) with
      | c_68 when c_68 = tag_Nil ->
          ignore (pop_env w_106);
          assert_env_length w_106 3;
          push_env w_106 (Dynarray.get w_106.state.e 2);
          assert_env_length w_106 4;
          return_n w_106 4 (pc_to_exp (int_to_pc 0))
      | c_68 when c_68 = tag_Cons ->
          let splits_77 = Memo.splits (snd x_68) in
          let split0_77 = List.nth splits_77 0 in
          let split1_41 = List.nth splits_77 1 in
          ignore (pop_env w_106);
          push_env w_106 split0_77;
          ...
          stepped w_106
      | c_68 -> failwith ("unreachable:" ^ string_of_int c_68 ^ "(108)"))
    108
...
let () =
  add_exp
    (fun w_110 ->
      ...
      let x_71 = resolve w_110 last_71 in
      match Word.get_value (fst x_71) with
      | c_71 when c_71 = tag_ANIL ->
          ignore (pop_env w_110);
          assert_env_length w_110 2;
          push_env w_110 (Memo.from_constructor tag_Nil);
          assert_env_length w_110 3;
          drop_n w_110 3 1;
          assert_env_length w_110 2;
      ...
      | c_71 -> failwith ("unreachable:" ^ string_of_int c_71 ^ "(110)"))
    110
...
let () =
  add_exp
    (fun w_109 ->
      ...
      let x_70 = resolve w_109 last_70 in
      match Word.get_value (fst x_70) with
      | c_70 when c_70 = tag_ECons ->
          let splits_79 = Memo.splits (snd x_70) in
          let split0_79 = List.nth splits_79 0 in
          let split1_43 = List.nth splits_79 1 in
          ...
          let keep_vals_7 = env_call w_109 [ 2 ] 1 in
          w_109.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; keep_vals_7; w_109.state.k ];
          w_109.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_109
      | c_70 when c_70 = tag_EAtom ->
          let splits_80 = Memo.splits (snd x_70) in
          let split0_80 = List.nth splits_80 0 in
          ignore (pop_env w_109);
          push_env w_109 split0_80;
          assert_env_length w_109 2;
          push_env w_109 (Dynarray.get w_109.state.e 1);
          w_109.state.c <- pc_to_exp (int_to_pc 110);
          stepped w_109
      | c_70 -> failwith ("unreachable:" ^ string_of_int c_70 ^ "(111)"))
    111
...
let () =
  add_exp
    (fun w_112 ->
      ...
      let x_72 = resolve w_112 last_72 in
      match Word.get_value (fst x_72) with
      | c_72 when c_72 = tag_VQuote ->
          let splits_81 = Memo.splits (snd x_72) in
          let split0_81 = List.nth splits_81 0 in
          ignore (pop_env w_112);
          push_env w_112 split0_81;
          assert_env_length w_112 2;
          push_env w_112 (Dynarray.get w_112.state.e 1);
          assert_env_length w_112 3;
          let keep_vals_8 = env_call w_112 [] 1 in
          w_112.state.k <- Memo.appends [ Memo.from_constructor tag_cont_9; keep_vals_8; w_112.state.k ];
          w_112.state.c <- pc_to_exp (int_to_pc 19);
          stepped w_112
      | _ ->
          ignore (pop_env w_112);
          ...
          stepped w_112
      | c_72 -> failwith ("unreachable:" ^ string_of_int c_72 ^ "(113)"))
    113
...
let () =
  add_exp
    (fun w_113 ->
      ...
      w_113.state.c <- pc_to_exp (int_to_pc 117);
      stepped w_113)
    114
...
let () =
  add_exp
    (fun w_114 ->
      ...
      let x_73 = resolve w_114 last_73 in
      ...
      | c_73 when c_73 = tag_ECons ->
          ...
          let split1_44 = List.nth splits_82 1 in
          ignore (pop_env w_114);
          push_env w_114 split0_82;
          ...
          let keep_vals_9 = env_call w_114 [ 1; 3 ] 2 in
          w_114.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_vals_9; w_114.state.k ];
      ...
      | _ ->
          ...
          assert_env_length w_114 3;
          return_n w_114 3 (pc_to_exp (int_to_pc 0))
      | c_73 -> failwith ("unreachable:" ^ string_of_int c_73 ^ "(117)"))
    117
...
let () =
  add_exp
    (fun w_116 ->
      ...
      let x_74 = resolve w_116 last_74 in
      ...
      | c_74 when c_74 = tag_ECons ->
          ...
          push_env w_116 split0_83;
          push_env w_116 split1_45;
          assert_env_length w_116 4;
          push_env w_116 (Dynarray.get w_116.state.e 2);
          assert_env_length w_116 5;
          let keep_vals_10 = env_call w_116 [ 1; 2; 3 ] 1 in
          w_116.state.k <- Memo.appends [ Memo.from_constructor tag_cont_11; keep_vals_10; w_116.state.k ];
          w_116.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_116
      | _ ->
          ignore (pop_env w_116);
          failwith "no cond clause matched"
      | c_74 -> failwith ("unreachable:" ^ string_of_int c_74 ^ "(118)"))
    118
  ...
  add_exp
    (fun w_119 ->
      ...
      | c_76 when c_76 = tag_AVar ->
          ...
          w_119.state.c <- pc_to_exp (int_to_pc 105);
          stepped w_119
      | c_76 when c_76 = tag_ANumber ->
          let splits_86 = Memo.splits (snd x_76) in
          let split0_86 = List.nth splits_86 0 in
          ignore (pop_env w_119);
          push_env w_119 split0_86;
          assert_env_length w_119 4;
          push_env w_119 (Dynarray.get w_119.state.e 3);
          assert_env_length w_119 5;
          let ctor_arg_14 = pop_env w_119 in
          push_env w_119 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_14 ]);
          assert_env_length w_119 5;
          drop_n w_119 5 1;
          assert_env_length w_119 4;
          drop_n w_119 4 1;
      ...
      | c_76 when c_76 = tag_ASymbol ->
          let splits_87 = Memo.splits (snd x_76) in
          let split0_87 = List.nth splits_87 0 in
          ignore (pop_env w_119);
          push_env w_119 split0_87;
          assert_env_length w_119 4;
          push_env w_119 (Dynarray.get w_119.state.e 3);
          assert_env_length w_119 5;
          let ctor_arg_15 = pop_env w_119 in
          push_env w_119 (Memo.appends [ Memo.from_constructor tag_VSymbol; ctor_arg_15 ]);
          assert_env_length w_119 5;
          drop_n w_119 5 1;
          assert_env_length w_119 4;
          drop_n w_119 4 1;
      ...
      | c_76 -> failwith ("unreachable:" ^ string_of_int c_76 ^ "(119)"))
    119
...
let () =
  add_exp
    (fun w_118 ->
      ...
      let x_75 = resolve w_118 last_75 in
      ...
      | c_75 when c_75 = tag_ECons ->
          ...
          let keep_vals_11 = env_call w_118 [ 0; 1 ] 1 in
          w_118.state.k <- Memo.appends [ Memo.from_constructor tag_cont_12; keep_vals_11; w_118.state.k ];
          w_118.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_118
      | c_75 -> failwith ("unreachable:" ^ string_of_int c_75 ^ "(120)"))
    120
...
let () =
  add_exp
    (fun w_122 ->
      ...
      let x0_4 = resolve w_122 (Source.E 2) in
      let x1_4 = resolve w_122 (Source.E 3) in
      ignore (pop_env w_122);
      ignore (pop_env w_122);
      push_env w_122 (Memo.from_int (if Word.get_value (fst x0_4) = Word.get_value (fst x1_4) then 1 else 0));
  ...
  add_exp
    (fun w_121 ->
      ...
      | c_77 when c_77 = tag_Some ->
          ...
          stepped w_121
      | c_77 -> failwith ("unreachable:" ^ string_of_int c_77 ^ "(122)"))
    122
...
let () =
  add_exp
    (fun w_124 ->
      ...
      let x0_5 = resolve w_124 (Source.E 2) in
      let x1_5 = resolve w_124 (Source.E 3) in
      ignore (pop_env w_124);
      ignore (pop_env w_124);
      push_env w_124 (Memo.from_int (if Word.get_value (fst x0_5) = Word.get_value (fst x1_5) then 1 else 0));
  ...
  add_exp
    (fun w_123 ->
      ...
      | c_78 when c_78 = tag_Some ->
          ...
          stepped w_123
      | c_78 -> failwith ("unreachable:" ^ string_of_int c_78 ^ "(124)"))
    124
...
let () =
  add_exp
    (fun w_125 ->
      ...
      let cond_0 = resolve w_125 (Source.E 0) in
      ...
      if Word.get_value (fst cond_0) <> 0 then (
        assert_env_length w_125 0;
        push_env w_125 (Memo.from_constructor tag_Unit);
        assert_env_length w_125 1;
        ignore (env_call w_125 [] 1);
        w_125.state.c <- pc_to_exp (int_to_pc 25);
        stepped w_125)
      else (
        assert_env_length w_125 0;
        push_env w_125 (Memo.from_constructor tag_Unit);
        assert_env_length w_125 1;
        ignore (env_call w_125 [] 1);
        w_125.state.c <- pc_to_exp (int_to_pc 24);
        stepped w_125))
    125
...
let () =
  add_exp
    (fun w_126 ->
      ...
      let x_79 = resolve w_126 last_79 in
      ...
      | c_79 when c_79 = tag_Cons ->
          ...
          let split1_47 = List.nth splits_91 1 in
          ignore (pop_env w_126);
          push_env w_126 split0_91;
          push_env w_126 split1_47;
          assert_env_length w_126 3;
          push_env w_126 (Dynarray.get w_126.state.e 1);
          assert_env_length w_126 4;
          let keep_vals_12 = env_call w_126 [ 0; 1; 2 ] 1 in
          w_126.state.k <- Memo.appends [ Memo.from_constructor tag_cont_13; keep_vals_12; w_126.state.k ];
          w_126.state.c <- pc_to_exp (int_to_pc 6);
          stepped w_126
      | c_79 -> failwith ("unreachable:" ^ string_of_int c_79 ^ "(126)"))
    126
...
let () =
  add_exp
    (fun w_127 ->
      ...
      let x_80 = resolve w_127 last_80 in
      ...
      | c_80 when c_80 = tag_Some ->
          ...
          let keep_vals_13 = env_call w_127 [ 2 ] 1 in
          w_127.state.k <- Memo.appends [ Memo.from_constructor tag_cont_14; keep_vals_13; w_127.state.k ];
          w_127.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_127
      | _ ->
          ignore (pop_env w_127);
          failwith "destruct_names: impossible, names must be int literals"
      | c_80 -> failwith ("unreachable:" ^ string_of_int c_80 ^ "(127)"))
    127
...
let () =
  add_exp
    (fun w_128 ->
      ...
      let cond_1 = resolve w_128 (Source.E 0) in
      ...
      if Word.get_value (fst cond_1) <> 0 then (
        assert_env_length w_128 0;
        push_env w_128 (Memo.from_constructor tag_Unit);
        assert_env_length w_128 1;
        ignore (env_call w_128 [] 1);
...
let () =
  add_exp
    (fun w_130 ->
      ...
      let cond_2 = resolve w_130 (Source.E 3) in
      ...
      if Word.get_value (fst cond_2) <> 0 then (
        ...
        w_130.state.c <- pc_to_exp (int_to_pc 8);
        stepped w_130)
      else (
        assert_env_length w_130 3;
        ...
        let ctor_arg_18 = pop_env w_130 in
        push_env w_130 (Memo.appends [ Memo.from_constructor tag_MkEnv; ctor_arg_18 ]);
        assert_env_length w_130 5;
        ignore (env_call w_130 [] 2);
...
let () =
  add_exp
    (fun w_129 ->
      ...
      let x0_6 = resolve w_129 (Source.E 3) in
      let x1_6 = resolve w_129 (Source.E 4) in
      ignore (pop_env w_129);
      ignore (pop_env w_129);
      push_env w_129 (Memo.from_int (if Word.get_value (fst x0_6) = Word.get_value (fst x1_6) then 1 else 0));
...
let () =
  add_exp
    (fun w_132 ->
      ...
      let last_82 = Source.E 3 in
      let x_82 = resolve w_132 last_82 in
      match Word.get_value (fst x_82) with
      | c_82 when c_82 = tag_SQuote ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_18 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_19; keep_vals_18; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SAtom ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_19 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_20; keep_vals_19; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SEq ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_20 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_21; keep_vals_20; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SCar ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_21 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_22; keep_vals_21; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SCdr ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_22 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_23; keep_vals_22; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SIf ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_23 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_24; keep_vals_23; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SCons ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_24 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_25; keep_vals_24; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SCond ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_25 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_26; keep_vals_25; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 63);
          stepped w_132
      | c_82 when c_82 = tag_SNull ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_26 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_27; keep_vals_26; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | c_82 when c_82 = tag_SError ->
          ignore (pop_env w_132);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_27 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_28; keep_vals_27; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 39);
          stepped w_132
      | _ ->
          ignore (pop_env w_132);
          failwith "invalid symbol here"
      | c_82 -> failwith ("unreachable:" ^ string_of_int c_82 ^ "(131)"))
    131
  ...
  add_exp
    (fun w_131 ->
      ...
      | c_81 when c_81 = tag_None ->
          ...
          assert_env_length w_131 3;
          let keep_vals_28 = env_call w_131 [ 0; 1 ] 1 in
          w_131.state.k <- Memo.appends [ Memo.from_constructor tag_cont_29; keep_vals_28; w_131.state.k ];
          w_131.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_131
  ...
  add_exp
    (fun w_133 ->
      ...
      | _ ->
          ...
          push_env w_133 (Dynarray.get w_133.state.e 0);
          assert_env_length w_133 3;
          let keep_vals_39 = env_call w_133 [ 0; 1 ] 1 in
          w_133.state.k <- Memo.appends [ Memo.from_constructor tag_cont_40; keep_vals_39; w_133.state.k ];
          w_133.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_133
      | c_83 -> failwith ("unreachable:" ^ string_of_int c_83 ^ "(133)"))
    133
...
let () =
  add_exp
    (fun w_134 ->
      ...
      let cond_3 = resolve w_134 (Source.E 3) in
      ...
      if Word.get_value (fst cond_3) <> 0 then (
        ...
        ignore (env_call w_134 [] 2);
        w_134.state.c <- pc_to_exp (int_to_pc 115);
        stepped w_134)
      else (
        assert_env_length w_134 3;
        push_env w_134 (Dynarray.get w_134.state.e 1);
        assert_env_length w_134 4;
        let keep_vals_40 = env_call w_134 [ 0 ] 1 in
        w_134.state.k <- Memo.appends [ Memo.from_constructor tag_cont_41; keep_vals_40; w_134.state.k ];
        w_134.state.c <- pc_to_exp (int_to_pc 39);
        stepped w_134))
    134
...
let () =
  add_exp
    (fun w_136 ->
      let err_0 = resolve w_136 (Source.E 1) in
...
let () =
  add_exp
    (fun w_135 ->
      ...
      let x_84 = resolve w_135 last_84 in
      ...
      | c_84 when c_84 = tag_Some ->
          let splits_95 = Memo.splits (snd x_84) in
          let split0_95 = List.nth splits_95 0 in
          ignore (pop_env w_135);
          push_env w_135 split0_95;
          assert_env_length w_135 1;
          ...
          stepped w_135
      | c_84 -> failwith ("unreachable:" ^ string_of_int c_84 ^ "(136)"))
    136
...
let () =
  add_exp
    (fun w_138 ->
      ...
      let x_86 = resolve w_138 last_86 in
      match Word.get_value (fst x_86) with
      | c_86 when c_86 = tag_SLambda ->
          ignore (pop_env w_138);
          assert_env_length w_138 3;
          push_env w_138 (Dynarray.get w_138.state.e 0);
          assert_env_length w_138 4;
          let keep_vals_50 = env_call w_138 [ 0; 1 ] 1 in
          w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_51; keep_vals_50; w_138.state.k ];
          w_138.state.c <- pc_to_exp (int_to_pc 52);
          stepped w_138
      | c_86 when c_86 = tag_SDefine ->
          ignore (pop_env w_138);
          assert_env_length w_138 3;
          push_env w_138 (Memo.from_constructor tag_SLambda);
          assert_env_length w_138 4;
          let ctor_arg_24 = pop_env w_138 in
          push_env w_138 (Memo.appends [ Memo.from_constructor tag_ASymbol; ctor_arg_24 ]);
          assert_env_length w_138 4;
          let ctor_arg_25 = pop_env w_138 in
          push_env w_138 (Memo.appends [ Memo.from_constructor tag_EAtom; ctor_arg_25 ]);
          assert_env_length w_138 4;
          push_env w_138 (Dynarray.get w_138.state.e 0);
          assert_env_length w_138 5;
          let keep_vals_51 = env_call w_138 [ 0; 1; 3 ] 1 in
          w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_52; keep_vals_51; w_138.state.k ];
          w_138.state.c <- pc_to_exp (int_to_pc 48);
          stepped w_138
      | c_86 when c_86 = tag_SDefvar ->
          ignore (pop_env w_138);
          assert_env_length w_138 3;
          push_env w_138 (Dynarray.get w_138.state.e 0);
          assert_env_length w_138 4;
          let keep_vals_52 = env_call w_138 [ 0; 1 ] 1 in
          w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_53; keep_vals_52; w_138.state.k ];
          w_138.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_138
      | c_86 when c_86 = tag_SQuote ->
          ignore (pop_env w_138);
          failwith "unexpected function quote"
      | c_86 when c_86 = tag_SEq ->
          ignore (pop_env w_138);
          failwith "unexpected function eq"
      | c_86 when c_86 = tag_SCons ->
          ignore (pop_env w_138);
          failwith "unexpected function cons"
      | c_86 when c_86 = tag_SIf ->
          ignore (pop_env w_138);
          failwith "unexpected function if"
      | c_86 when c_86 = tag_SCond ->
          ignore (pop_env w_138);
          failwith "unexpected function cond"
      | c_86 when c_86 = tag_SAtom ->
          ignore (pop_env w_138);
          failwith "unexpected function atom"
      | c_86 when c_86 = tag_SCar ->
          ignore (pop_env w_138);
          failwith "unexpected function car"
      | c_86 when c_86 = tag_SCdr ->
          ignore (pop_env w_138);
          failwith "unexpected function cdr"
      | c_86 when c_86 = tag_SNull ->
          ignore (pop_env w_138);
          failwith "unexpected function null"
      | c_86 when c_86 = tag_SError ->
          ignore (pop_env w_138);
          failwith "unexpected function error"
      | _ ->
          ignore (pop_env w_138);
          failwith "1"
      | c_86 -> failwith ("unreachable:" ^ string_of_int c_86 ^ "(137)"))
    137
  ...
  add_exp
    (fun w_137 ->
      ...
      | c_85 when c_85 = tag_None ->
          ...
          assert_env_length w_137 3;
          let keep_vals_53 = env_call w_137 [] 1 in
          w_137.state.k <- Memo.appends [ Memo.from_constructor tag_cont_54; keep_vals_53; w_137.state.k ];
          w_137.state.c <- pc_to_exp (int_to_pc 42);
          stepped w_137
      | c_85 -> failwith ("unreachable:" ^ string_of_int c_85 ^ "(138)"))
    138
  ...
  add_exp
    (fun w_139 ->
      ...
      | c_87 when c_87 = tag_Some ->
          ...
          let keep_vals_54 = env_call w_139 [ 0; 1 ] 2 in
          w_139.state.k <- Memo.appends [ Memo.from_constructor tag_cont_55; keep_vals_54; w_139.state.k ];
          w_139.state.c <- pc_to_exp (int_to_pc 105);
          stepped w_139
      | c_87 when c_87 = tag_None ->
          ...
          assert_env_length w_139 3;
          let keep_vals_55 = env_call w_139 [] 1 in
          w_139.state.k <- Memo.appends [ Memo.from_constructor tag_cont_56; keep_vals_55; w_139.state.k ];
          w_139.state.c <- pc_to_exp (int_to_pc 61);
          stepped w_139
      | c_87 -> failwith ("unreachable:" ^ string_of_int c_87 ^ "(139)"))
    139
...
let () =
  add_exp
    (fun w_141 ->
      ...
      let x_89 = resolve w_141 last_89 in
      match Word.get_value (fst x_89) with
      | c_89 when c_89 = tag_AVar ->
          let splits_99 = Memo.splits (snd x_89) in
          let split0_99 = List.nth splits_99 0 in
          ignore (pop_env w_141);
          push_env w_141 split0_99;
          failwith "unexpected function var"
      | c_89 when c_89 = tag_ANumber ->
          let splits_100 = Memo.splits (snd x_89) in
          let split0_100 = List.nth splits_100 0 in
          ignore (pop_env w_141);
          push_env w_141 split0_100;
          failwith "unexpected function number"
      | c_89 when c_89 = tag_ASymbol ->
          let splits_101 = Memo.splits (snd x_89) in
          let split0_101 = List.nth splits_101 0 in
          ignore (pop_env w_141);
          push_env w_141 split0_101;
          failwith "invalid symbol here"
      | c_89 when c_89 = tag_ANIL ->
          ignore (pop_env w_141);
          failwith "unexpected function nil"
      | c_89 -> failwith ("unreachable:" ^ string_of_int c_89 ^ "(140)"))
    140
...
let () =
  add_exp
    (fun w_140 ->
      ...
      let x_88 = resolve w_140 last_88 in
      match Word.get_value (fst x_88) with
      | c_88 when c_88 = tag_EAtom ->
          let splits_98 = Memo.splits (snd x_88) in
          let split0_98 = List.nth splits_98 0 in
          ignore (pop_env w_140);
          push_env w_140 split0_98;
          assert_env_length w_140 1;
      ...
      | c_88 when c_88 = tag_ECons ->
          ...
          let split1_49 = List.nth splits_102 1 in
          ignore (pop_env w_140);
          push_env w_140 split0_102;
          push_env w_140 split1_49;
          failwith "unexpected CONS"
      | c_88 -> failwith ("unreachable:" ^ string_of_int c_88 ^ "(141)"))
    141
...
let () =
  add_exp
    (fun w_144 ->
      ...
      | c_92 when c_92 = tag_ANumber ->
          let splits_109 = Memo.splits (snd x_92) in
          let split0_109 = List.nth splits_109 0 in
          ignore (pop_env w_144);
          push_env w_144 split0_109;
          failwith "NUMBER is not PROCEDURE"
...
let () =
  add_exp
    (fun w_145 ->
      ...
      let cond_4 = resolve w_145 (Source.E 3) in
      ...
      let if_kont_4 =
       fun _ ->
        ...
        drop_n w_145 2 0;
        assert_env_length w_145 2;
        return_n w_145 2 (pc_to_exp (int_to_pc 0))
      in
      if Word.get_value (fst cond_4) <> 0 then (
        ...
        ignore (env_call w_145 [] 2);
        w_145.state.c <- pc_to_exp (int_to_pc 116);
        stepped w_145)
      else (
        assert_env_length w_145 3;
...
let () =
  add_exp
    (fun w_146 ->
      ...
      let last_93 = Source.E 3 in
      let x_93 = resolve w_146 last_93 in
      ...
      | c_93 when c_93 = tag_Some ->
          let splits_110 = Memo.splits (snd x_93) in
          let split0_110 = List.nth splits_110 0 in
          ignore (pop_env w_146);
          push_env w_146 split0_110;
          assert_env_length w_146 4;
          ...
          let ctor_arg_32 = pop_env w_146 in
          let ctor_arg_33 = pop_env w_146 in
          push_env w_146 (Memo.appends [ Memo.from_constructor tag_VClosure; ctor_arg_33; ctor_arg_32 ]);
          assert_env_length w_146 5;
          push_env w_146 (Dynarray.get w_146.state.e 3);
          assert_env_length w_146 6;
          push_env w_146 (Dynarray.get w_146.state.e 4);
          assert_env_length w_146 7;
          let ctor_arg_34 = pop_env w_146 in
          let ctor_arg_35 = pop_env w_146 in
          push_env w_146 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_35; ctor_arg_34 ]);
          assert_env_length w_146 6;
          push_env w_146 (Dynarray.get w_146.state.e 1);
          assert_env_length w_146 7;
          let keep_vals_66 = env_call w_146 [ 0 ] 2 in
          w_146.state.k <- Memo.appends [ Memo.from_constructor tag_cont_67; keep_vals_66; w_146.state.k ];
          w_146.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_146
  ...
  add_exp
    (fun w_147 ->
      ...
      | c_94 when c_94 = tag_Some ->
          let splits_111 = Memo.splits (snd x_94) in
          let split0_111 = List.nth splits_111 0 in
          ignore (pop_env w_147);
          push_env w_147 split0_111;
          assert_env_length w_147 4;
          ...
          let ctor_arg_36 = pop_env w_147 in
          let ctor_arg_37 = pop_env w_147 in
          push_env w_147 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_37; ctor_arg_36 ]);
          assert_env_length w_147 5;
          push_env w_147 (Dynarray.get w_147.state.e 1);
          assert_env_length w_147 6;
          let keep_vals_70 = env_call w_147 [ 0 ] 2 in
          w_147.state.k <- Memo.appends [ Memo.from_constructor tag_cont_71; keep_vals_70; w_147.state.k ];
          w_147.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_147
      | c_94 -> failwith ("unreachable:" ^ string_of_int c_94 ^ "(147)"))
    147
...
let () = Words.set_constructor_degree 20 0
...
let () = Words.set_constructor_degree 50 (-4)
...
let () = Words.set_constructor_degree 79 (-2)
let () = Words.set_constructor_degree 80 (-1)
...
let () = Words.set_constructor_degree 89 (-4)
...
let () = Words.set_constructor_degree 96 (-3)
