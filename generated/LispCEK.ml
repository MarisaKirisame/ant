...
type symbol = SLambda | SDefine | SQuote | SEq | SCons | SCond | SAtom | SCar | SCdr | SNull | SError
...
let rec atom_eq memo (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 71)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done) memo
...
let rec pairlis memo (x0 : Value.seq) (x1 : Value.seq) (x2 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 99)) (Dynarray.of_list [ x0; x1; x2 ]) (Memo.from_constructor tag_cont_done) memo
...
let rec evcon memo (x0 : Value.seq) (x1 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 108)) (Dynarray.of_list [ x0; x1 ]) (Memo.from_constructor tag_cont_done) memo
...
let () =
  add_exp
    (fun w_113 ->
      ...
      let hd_0, tl_0 = resolve w_113 K in
      match Word.get_value hd_0 with
      | c_88 when c_88 = tag_cont_done -> exec_done w_113
      | c_88 when c_88 = tag_cont_1 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 115);
          stepped w_113
      | c_88 when c_88 = tag_cont_2 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 117);
          stepped w_113
      | c_88 when c_88 = tag_cont_3 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          let ctor_arg_16 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_16 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          drop_n w_113 1 0;
      ...
      | c_88 when c_88 = tag_cont_4 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          let ctor_arg_17 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_17 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          return_n w_113 1 (pc_to_exp (int_to_pc 0))
      | c_88 when c_88 = tag_cont_5 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 118);
          stepped w_113
      | c_88 when c_88 = tag_cont_6 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 119);
          stepped w_113
      | c_88 when c_88 = tag_cont_7 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          ignore (env_call w_113 [] 3);
          w_113.state.c <- pc_to_exp (int_to_pc 99);
          stepped w_113
      | c_88 when c_88 = tag_cont_8 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 120);
          stepped w_113
      | c_88 when c_88 = tag_cont_9 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 121);
          stepped w_113
      | c_88 when c_88 = tag_cont_10 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          ...
          let keep_vals_14 = env_call w_113 [ 2 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_15; keep_vals_14; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 107);
          stepped w_113
      | c_88 when c_88 = tag_cont_11 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 5;
          let keep_vals_15 = env_call w_113 [ 0; 1; 2 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_16; keep_vals_15; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_12 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          let keep_vals_16 = env_call w_113 [ 0; 1 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_17; keep_vals_16; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_113
      | c_88 when c_88 = tag_cont_13 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          w_113.state.c <- pc_to_exp (int_to_pc 123);
          stepped w_113
      | c_88 when c_88 = tag_cont_14 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          let ctor_arg_19 = pop_env w_113 in
          let ctor_arg_20 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_20; ctor_arg_19 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          return_n w_113 1 (pc_to_exp (int_to_pc 0))
      | c_88 when c_88 = tag_cont_15 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          let ctor_arg_21 = pop_env w_113 in
          let ctor_arg_22 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_22; ctor_arg_21 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          return_n w_113 1 (pc_to_exp (int_to_pc 0))
      | c_88 when c_88 = tag_cont_16 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Memo.from_constructor tag_Unit);
          assert_env_length w_113 5;
          let keep_vals_17 = env_call w_113 [ 0; 1; 2; 3 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_vals_17; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 24);
          stepped w_113
      | c_88 when c_88 = tag_cont_17 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 125);
          stepped w_113
      | c_88 when c_88 = tag_cont_18 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 4 tl_0;
          assert_env_length w_113 5;
          let keep_vals_28 = env_call w_113 [ 0; 1; 2 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_29; keep_vals_28; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 82);
          stepped w_113
      | c_88 when c_88 = tag_cont_19 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          let ctor_arg_23 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_23 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          return_n w_113 1 (pc_to_exp (int_to_pc 0))
      | c_88 when c_88 = tag_cont_20 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_29 = env_call w_113 [] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_30; keep_vals_29; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_21 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 1);
          assert_env_length w_113 4;
          let keep_vals_30 = env_call w_113 [ 0; 1 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_31; keep_vals_30; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_22 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_31 = env_call w_113 [] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_32; keep_vals_31; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_23 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_32 = env_call w_113 [] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_33; keep_vals_32; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_24 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 1);
          assert_env_length w_113 4;
          let keep_vals_33 = env_call w_113 [ 0; 1 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_34; keep_vals_33; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_25 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          ...
          w_113.state.c <- pc_to_exp (int_to_pc 108);
          stepped w_113
      | c_88 when c_88 = tag_cont_26 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_34 = env_call w_113 [] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_35; keep_vals_34; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_27 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_35 = env_call w_113 [] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_36; keep_vals_35; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_28 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 126);
          stepped w_113
      | c_88 when c_88 = tag_cont_29 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_113
      | c_88 when c_88 = tag_cont_30 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          ignore (env_call w_113 [] 1);
          w_113.state.c <- pc_to_exp (int_to_pc 95);
          stepped w_113
      | c_88 when c_88 = tag_cont_31 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_39 = env_call w_113 [ 1; 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_40; keep_vals_39; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 30);
          stepped w_113
      | c_88 when c_88 = tag_cont_32 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          ignore (env_call w_113 [] 1);
          w_113.state.c <- pc_to_exp (int_to_pc 89);
          stepped w_113
      | c_88 when c_88 = tag_cont_33 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          ignore (env_call w_113 [] 1);
          w_113.state.c <- pc_to_exp (int_to_pc 92);
          stepped w_113
      | c_88 when c_88 = tag_cont_34 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_40 = env_call w_113 [ 1; 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_41; keep_vals_40; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 30);
          stepped w_113
      | c_88 when c_88 = tag_cont_35 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          ignore (env_call w_113 [] 1);
          w_113.state.c <- pc_to_exp (int_to_pc 105);
          stepped w_113
      | c_88 when c_88 = tag_cont_36 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          assert_env_length w_113 1;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 2;
          let keep_vals_41 = env_call w_113 [] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_42; keep_vals_41; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 22);
          stepped w_113
      | c_88 when c_88 = tag_cont_37 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          let keep_vals_42 = env_call w_113 [ 0; 1 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_43; keep_vals_42; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_113
      | c_88 when c_88 = tag_cont_38 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          let keep_vals_43 = env_call w_113 [ 0; 1 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_44; keep_vals_43; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 13);
          stepped w_113
      | c_88 when c_88 = tag_cont_39 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          ...
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_40 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_44 = env_call w_113 [ 1 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_45; keep_vals_44; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_41 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_45 = env_call w_113 [ 1 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_46; keep_vals_45; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_42 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 129);
          stepped w_113
      | c_88 when c_88 = tag_cont_43 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 131);
          stepped w_113
      | c_88 when c_88 = tag_cont_44 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 132);
          stepped w_113
      | c_88 when c_88 = tag_cont_45 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          ignore (env_call w_113 [] 2);
          w_113.state.c <- pc_to_exp (int_to_pc 97);
          stepped w_113
      | c_88 when c_88 = tag_cont_46 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          let ctor_arg_26 = pop_env w_113 in
          let ctor_arg_27 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_27; ctor_arg_26 ]);
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          drop_n w_113 1 0;
          assert_env_length w_113 1;
          return_n w_113 1 (pc_to_exp (int_to_pc 0))
      | c_88 when c_88 = tag_cont_47 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          let keep_vals_51 = env_call w_113 [ 0; 1 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_52; keep_vals_51; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 102);
          stepped w_113
      | c_88 when c_88 = tag_cont_48 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          let ctor_arg_28 = pop_env w_113 in
          let ctor_arg_29 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_29; ctor_arg_28 ]);
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_52 = env_call w_113 [ 0; 1; 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_53; keep_vals_52; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 47);
          stepped w_113
      | c_88 when c_88 = tag_cont_49 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 134);
          stepped w_113
      | c_88 when c_88 = tag_cont_50 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 135);
          stepped w_113
      | c_88 when c_88 = tag_cont_51 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 0 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 137);
          stepped w_113
      | c_88 when c_88 = tag_cont_52 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 4;
          let keep_vals_54 = env_call w_113 [ 0; 1; 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_55; keep_vals_54; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 51);
          stepped w_113
      | c_88 when c_88 = tag_cont_53 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          let keep_vals_55 = env_call w_113 [ 0; 1; 2 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_56; keep_vals_55; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_113
      | c_88 when c_88 = tag_cont_54 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 2 tl_0;
          assert_env_length w_113 3;
          let ctor_arg_30 = pop_env w_113 in
          let ctor_arg_31 = pop_env w_113 in
          push_env w_113 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_31; ctor_arg_30 ]);
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          ignore (env_call w_113 [] 2);
          w_113.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_113
      | c_88 when c_88 = tag_cont_55 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 5;
          let keep_vals_56 = env_call w_113 [ 1; 2; 3 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_57; keep_vals_56; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 58);
          stepped w_113
      | c_88 when c_88 = tag_cont_56 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          w_113.state.c <- pc_to_exp (int_to_pc 138);
          stepped w_113
      | c_88 when c_88 = tag_cont_57 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 5;
          let keep_vals_58 = env_call w_113 [ 0; 1; 2 ] 2 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_59; keep_vals_58; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 107);
          stepped w_113
      | c_88 when c_88 = tag_cont_58 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 0);
          assert_env_length w_113 3;
          let keep_vals_59 = env_call w_113 [ 1 ] 1 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_60; keep_vals_59; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_113
      | c_88 when c_88 = tag_cont_59 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 3 tl_0;
          assert_env_length w_113 4;
          push_env w_113 (Dynarray.get w_113.state.e 1);
          ...
          let keep_vals_60 = env_call w_113 [ 2 ] 3 in
          w_113.state.k <- Memo.appends [ Memo.from_constructor tag_cont_61; keep_vals_60; w_113.state.k ];
          w_113.state.c <- pc_to_exp (int_to_pc 99);
          stepped w_113
      | c_88 when c_88 = tag_cont_60 ->
          w_113.state.k <- get_next_cont tl_0;
          restore_env w_113 1 tl_0;
          assert_env_length w_113 2;
          push_env w_113 (Dynarray.get w_113.state.e 1);
...
let () =
  add_exp
    (fun w_35 ->
      ...
      | c_18 -> failwith ("unreachable:" ^ string_of_int c_18 ^ "(35)"))
    35
...
let () =
  add_exp
    (fun w_41 ->
      ...
      | c_22 -> failwith ("unreachable:" ^ string_of_int c_22 ^ "(41)"))
    41
  ...
  add_exp
    (fun w_40 ->
      ...
      | c_21 when c_21 = tag_ECons ->
          ...
          stepped w_40
      | c_21 -> failwith ("unreachable:" ^ string_of_int c_21 ^ "(42)"))
    42
...
let () =
  add_exp
    (fun w_42 ->
      ...
      w_42.state.c <- pc_to_exp (int_to_pc 46);
      stepped w_42)
    43
  ...
  add_exp
    (fun w_45 ->
      ...
      | c_25 when c_25 = tag_ECons ->
          ...
          assert_env_length w_45 7;
          push_env w_45 (Dynarray.get w_45.state.e 6);
          assert_env_length w_45 8;
          drop_n w_45 8 2;
          assert_env_length w_45 6;
          drop_n w_45 6 2;
  ...
  add_exp
    (fun w_44 ->
      ...
      | c_24 when c_24 = tag_ECons ->
          ...
          push_env w_44 (Dynarray.get w_44.state.e 4);
...
let () =
  add_exp
    (fun w_43 ->
      ...
      let x_23 = resolve w_43 last_23 in
...
let () =
  add_exp
    (fun w_46 ->
      ...
      w_46.state.c <- pc_to_exp (int_to_pc 50);
      stepped w_46)
    47
...
let () =
  add_exp
    (fun w_49 ->
      ...
      | c_28 -> failwith ("unreachable:" ^ string_of_int c_28 ^ "(48)"))
    48
  ...
  add_exp
    (fun w_48 ->
      ...
      | c_27 when c_27 = tag_ECons ->
          ...
          w_48.state.c <- pc_to_exp (int_to_pc 48);
          stepped w_48
      | c_27 -> failwith ("unreachable:" ^ string_of_int c_27 ^ "(49)"))
    49
  ...
  add_exp
    (fun w_47 ->
      ...
      | c_26 when c_26 = tag_ECons ->
          ...
          stepped w_47
      | c_26 -> failwith ("unreachable:" ^ string_of_int c_26 ^ "(50)"))
    50
  ...
  add_exp
    (fun w_54 ->
      ...
      | c_32 when c_32 = tag_ECons ->
          ...
          assert_env_length w_54 9;
          push_env w_54 (Dynarray.get w_54.state.e 7);
          assert_env_length w_54 10;
          drop_n w_54 10 2;
          assert_env_length w_54 8;
          drop_n w_54 8 2;
      ...
      | c_32 -> failwith ("unreachable:" ^ string_of_int c_32 ^ "(52)"))
    52
  ...
  add_exp
    (fun w_53 ->
      ...
      | c_31 when c_31 = tag_ECons ->
          ...
          push_env w_53 (Dynarray.get w_53.state.e 6);
          w_53.state.c <- pc_to_exp (int_to_pc 52);
          stepped w_53
      | c_31 -> failwith ("unreachable:" ^ string_of_int c_31 ^ "(53)"))
    53
  ...
  add_exp
    (fun w_52 ->
      ...
      | c_30 when c_30 = tag_ECons ->
          ...
          stepped w_52
      | c_30 -> failwith ("unreachable:" ^ string_of_int c_30 ^ "(54)"))
    54
  ...
  add_exp
    (fun w_51 ->
      ...
      | c_29 when c_29 = tag_ECons ->
          ...
          stepped w_51
      | c_29 -> failwith ("unreachable:" ^ string_of_int c_29 ^ "(55)"))
    55
...
let () =
  add_exp
    (fun w_56 ->
      ...
      | c_33 -> failwith ("unreachable:" ^ string_of_int c_33 ^ "(57)"))
    57
...
let () =
  add_exp
    (fun w_59 ->
      ...
      w_59.state.c <- pc_to_exp (int_to_pc 70);
      stepped w_59)
    60
...
let () =
  add_exp
    (fun w_61 ->
      ...
      let x_36 = resolve w_61 last_36 in
      match Word.get_value (fst x_36) with
      | c_36 when c_36 = tag_SLambda ->
          ignore (pop_env w_61);
      ...
      | _ ->
          ...
          assert_env_length w_61 3;
          return_n w_61 3 (pc_to_exp (int_to_pc 0))
      | c_36 -> failwith ("unreachable:" ^ string_of_int c_36 ^ "(61)"))
    61
...
let () =
  add_exp
    (fun w_62 ->
      ...
      let x_37 = resolve w_62 last_37 in
      match Word.get_value (fst x_37) with
      | c_37 when c_37 = tag_SDefine ->
          ignore (pop_env w_62);
  ...
  add_exp
    (fun w_64 ->
      ...
      | _ ->
          ...
          assert_env_length w_64 3;
          return_n w_64 3 (pc_to_exp (int_to_pc 0))
      | c_39 -> failwith ("unreachable:" ^ string_of_int c_39 ^ "(64)"))
    64
...
let () =
  add_exp
    (fun w_65 ->
      ...
      let x_40 = resolve w_65 last_40 in
      ...
      | _ ->
          ...
          assert_env_length w_65 3;
          return_n w_65 3 (pc_to_exp (int_to_pc 0))
      | c_40 -> failwith ("unreachable:" ^ string_of_int c_40 ^ "(65)"))
    65
...
let () =
  add_exp
    (fun w_66 ->
      ...
      let x_41 = resolve w_66 last_41 in
      match Word.get_value (fst x_41) with
      | c_41 when c_41 = tag_SCond ->
          ignore (pop_env w_66);
      ...
      | _ ->
          ...
          assert_env_length w_66 3;
          return_n w_66 3 (pc_to_exp (int_to_pc 0))
      | c_41 -> failwith ("unreachable:" ^ string_of_int c_41 ^ "(66)"))
    66
...
let () =
  add_exp
    (fun w_67 ->
      ...
      let x_42 = resolve w_67 last_42 in
      match Word.get_value (fst x_42) with
      | c_42 when c_42 = tag_SAtom ->
          ignore (pop_env w_67);
      ...
      | _ ->
          ...
          assert_env_length w_67 3;
          return_n w_67 3 (pc_to_exp (int_to_pc 0))
      | c_42 -> failwith ("unreachable:" ^ string_of_int c_42 ^ "(67)"))
    67
...
let () =
  add_exp
    (fun w_68 ->
      ...
      let x_43 = resolve w_68 last_43 in
      match Word.get_value (fst x_43) with
      | c_43 when c_43 = tag_SCar ->
          ignore (pop_env w_68);
      ...
      | _ ->
          ...
          assert_env_length w_68 3;
          return_n w_68 3 (pc_to_exp (int_to_pc 0))
      | c_43 -> failwith ("unreachable:" ^ string_of_int c_43 ^ "(68)"))
    68
...
let () =
  add_exp
    (fun w_69 ->
      ...
      let x_44 = resolve w_69 last_44 in
      match Word.get_value (fst x_44) with
      | c_44 when c_44 = tag_SCdr ->
          ignore (pop_env w_69);
      ...
      | _ ->
          ...
          assert_env_length w_69 3;
          return_n w_69 3 (pc_to_exp (int_to_pc 0))
      | c_44 -> failwith ("unreachable:" ^ string_of_int c_44 ^ "(69)"))
    69
  ...
  add_exp
    (fun w_60 ->
      ...
      | c_35 when c_35 = tag_SQuote ->
          ...
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 63);
          stepped w_60
      | c_35 when c_35 = tag_SEq ->
          ...
          stepped w_60
      | c_35 when c_35 = tag_SCons ->
          ignore (pop_env w_60);
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 65);
          stepped w_60
      | c_35 when c_35 = tag_SCond ->
          ignore (pop_env w_60);
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 66);
          stepped w_60
      | c_35 when c_35 = tag_SAtom ->
          ignore (pop_env w_60);
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 67);
          stepped w_60
      | c_35 when c_35 = tag_SCar ->
          ignore (pop_env w_60);
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 68);
          stepped w_60
      | c_35 when c_35 = tag_SCdr ->
          ignore (pop_env w_60);
          assert_env_length w_60 2;
          push_env w_60 (Dynarray.get w_60.state.e 1);
          w_60.state.c <- pc_to_exp (int_to_pc 69);
          stepped w_60
      | c_35 -> failwith ("unreachable:" ^ string_of_int c_35 ^ "(70)"))
    70
...
let () =
  add_exp
    (fun w_70 ->
      ...
      w_70.state.c <- pc_to_exp (int_to_pc 78);
      stepped w_70)
    71
...
let () =
  add_exp
    (fun w_72 ->
      ...
      let last_46 = Source.E 3 in
      let x_46 = resolve w_72 last_46 in
      match Word.get_value (fst x_46) with
      | c_46 when c_46 = tag_AVar ->
          let splits_38 = Memo.splits (snd x_46) in
...
let () =
  add_exp
    (fun w_74 ->
      ...
      | c_47 -> failwith ("unreachable:" ^ string_of_int c_47 ^ "(75)"))
    75
  ...
  add_exp
    (fun w_76 ->
      ...
      | c_48 when c_48 = tag_ASymbol ->
          ...
          w_76.state.c <- pc_to_exp (int_to_pc 60);
          stepped w_76
      | _ ->
          ignore (pop_env w_76);
      ...
      | c_48 -> failwith ("unreachable:" ^ string_of_int c_48 ^ "(76)"))
    76
...
let () =
  add_exp
    (fun w_77 ->
      ...
      let x_49 = resolve w_77 last_49 in
      match Word.get_value (fst x_49) with
      | c_49 when c_49 = tag_ANIL ->
          ignore (pop_env w_77);
      ...
      | _ ->
          ...
          assert_env_length w_77 3;
          return_n w_77 3 (pc_to_exp (int_to_pc 0))
      | c_49 -> failwith ("unreachable:" ^ string_of_int c_49 ^ "(77)"))
    77
...
let () =
  add_exp
    (fun w_71 ->
      ...
      | c_45 when c_45 = tag_AVar ->
          let splits_37 = Memo.splits (snd x_45) in
          let split0_37 = List.nth splits_37 0 in
          ignore (pop_env w_71);
          push_env w_71 split0_37;
          assert_env_length w_71 3;
          push_env w_71 (Dynarray.get w_71.state.e 1);
          w_71.state.c <- pc_to_exp (int_to_pc 73);
          stepped w_71
      | c_45 when c_45 = tag_ANumber ->
          let splits_39 = Memo.splits (snd x_45) in
          let split0_39 = List.nth splits_39 0 in
          ignore (pop_env w_71);
          push_env w_71 split0_39;
          assert_env_length w_71 3;
          push_env w_71 (Dynarray.get w_71.state.e 1);
          w_71.state.c <- pc_to_exp (int_to_pc 75);
          stepped w_71
      | c_45 when c_45 = tag_ASymbol ->
          let splits_41 = Memo.splits (snd x_45) in
          let split0_41 = List.nth splits_41 0 in
          ignore (pop_env w_71);
          push_env w_71 split0_41;
          assert_env_length w_71 3;
          push_env w_71 (Dynarray.get w_71.state.e 1);
          w_71.state.c <- pc_to_exp (int_to_pc 76);
          stepped w_71
      | c_45 when c_45 = tag_ANIL ->
          ignore (pop_env w_71);
          assert_env_length w_71 2;
          push_env w_71 (Dynarray.get w_71.state.e 1);
          w_71.state.c <- pc_to_exp (int_to_pc 77);
          stepped w_71
...
let () =
  add_exp
    (fun w_80 ->
      ...
      let x_51 = resolve w_80 last_51 in
      match Word.get_value (fst x_51) with
      | c_51 when c_51 = tag_EAtom ->
          let splits_44 = Memo.splits (snd x_51) in
      ...
      | c_51 -> failwith ("unreachable:" ^ string_of_int c_51 ^ "(80)"))
    80
...
let () =
  add_exp
    (fun w_79 ->
      ...
      | c_50 -> failwith ("unreachable:" ^ string_of_int c_50 ^ "(81)"))
    81
...
let () =
  add_exp
    (fun w_81 ->
      ...
      w_81.state.c <- pc_to_exp (int_to_pc 88);
      stepped w_81)
    82
...
let () =
  add_exp
    (fun w_84 ->
      ...
      let x0_3 = resolve w_84 (Source.E 4) in
      let x1_3 = resolve w_84 (Source.E 5) in
      ignore (pop_env w_84);
      ignore (pop_env w_84);
      push_env w_84 (Memo.from_int (if Word.get_value (fst x0_3) = Word.get_value (fst x1_3) then 1 else 0));
...
let () =
  add_exp
    (fun w_83 ->
      ...
      let x_53 = resolve w_83 last_53 in
      ...
      | c_53 when c_53 = tag_VQuote ->
          let splits_48 = Memo.splits (snd x_53) in
          let split0_48 = List.nth splits_48 0 in
          ignore (pop_env w_83);
          push_env w_83 split0_48;
          assert_env_length w_83 4;
          push_env w_83 (Dynarray.get w_83.state.e 3);
          assert_env_length w_83 5;
          let keep_vals_0 = env_call w_83 [ 2 ] 1 in
          w_83.state.k <- Memo.appends [ Memo.from_constructor tag_cont_1; keep_vals_0; w_83.state.k ];
          w_83.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_83
      | _ ->
          ignore (pop_env w_83);
      ...
      | c_53 -> failwith ("unreachable:" ^ string_of_int c_53 ^ "(84)"))
    84
...
let () =
  add_exp
    (fun w_85 ->
      ...
      let x_54 = resolve w_85 last_54 in
      ...
      | c_54 when c_54 = tag_VSymbol ->
          ...
          w_85.state.c <- pc_to_exp (int_to_pc 60);
          stepped w_85
      | _ ->
          ignore (pop_env w_85);
      ...
      | c_54 -> failwith ("unreachable:" ^ string_of_int c_54 ^ "(85)"))
    85
...
let () =
  add_exp
    (fun w_86 ->
      ...
      let x_55 = resolve w_86 last_55 in
      match Word.get_value (fst x_55) with
      | c_55 when c_55 = tag_VQuote ->
          let splits_52 = Memo.splits (snd x_55) in
          ...
          ignore (env_call w_86 [] 2);
          w_86.state.c <- pc_to_exp (int_to_pc 79);
          stepped w_86
      | c_55 when c_55 = tag_VNumber ->
          let splits_53 = Memo.splits (snd x_55) in
          let split0_53 = List.nth splits_53 0 in
          ignore (pop_env w_86);
          push_env w_86 split0_53;
          assert_env_length w_86 4;
          push_env w_86 (Dynarray.get w_86.state.e 2);
          assert_env_length w_86 5;
          let keep_vals_1 = env_call w_86 [ 3 ] 1 in
          w_86.state.k <- Memo.appends [ Memo.from_constructor tag_cont_2; keep_vals_1; w_86.state.k ];
          w_86.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_86
      | _ ->
          ignore (pop_env w_86);
      ...
      | c_55 -> failwith ("unreachable:" ^ string_of_int c_55 ^ "(86)"))
    86
...
let () =
  add_exp
    (fun w_87 ->
      ...
      let x_56 = resolve w_87 last_56 in
      ...
      | _ ->
          ...
          assert_env_length w_87 3;
          return_n w_87 3 (pc_to_exp (int_to_pc 0))
      | c_56 -> failwith ("unreachable:" ^ string_of_int c_56 ^ "(87)"))
    87
...
let () =
  add_exp
    (fun w_82 ->
      ...
      let x_52 = resolve w_82 last_52 in
      ...
      | c_52 when c_52 = tag_VNumber ->
          ...
          ignore (pop_env w_82);
          push_env w_82 split0_46;
          assert_env_length w_82 3;
          push_env w_82 (Dynarray.get w_82.state.e 1);
          w_82.state.c <- pc_to_exp (int_to_pc 84);
          stepped w_82
      | c_52 when c_52 = tag_VSymbol ->
          let splits_49 = Memo.splits (snd x_52) in
          let split0_49 = List.nth splits_49 0 in
          ignore (pop_env w_82);
          push_env w_82 split0_49;
          assert_env_length w_82 3;
          push_env w_82 (Dynarray.get w_82.state.e 1);
          w_82.state.c <- pc_to_exp (int_to_pc 85);
          stepped w_82
      | c_52 when c_52 = tag_VQuote ->
          let splits_51 = Memo.splits (snd x_52) in
          let split0_51 = List.nth splits_51 0 in
          ignore (pop_env w_82);
          push_env w_82 split0_51;
          assert_env_length w_82 3;
          push_env w_82 (Dynarray.get w_82.state.e 1);
          w_82.state.c <- pc_to_exp (int_to_pc 86);
          stepped w_82
      | c_52 when c_52 = tag_VNIL ->
          ignore (pop_env w_82);
          assert_env_length w_82 2;
          push_env w_82 (Dynarray.get w_82.state.e 1);
          w_82.state.c <- pc_to_exp (int_to_pc 87);
          stepped w_82
      | c_52 when c_52 = tag_VCons ->
          let splits_54 = Memo.splits (snd x_52) in
          let split0_54 = List.nth splits_54 0 in
          let split1_27 = List.nth splits_54 1 in
          ignore (pop_env w_82);
          push_env w_82 split0_54;
          push_env w_82 split1_27;
      ...
      | c_52 when c_52 = tag_VClosure ->
          ...
          let split1_28 = List.nth splits_55 1 in
          ignore (pop_env w_82);
          push_env w_82 split0_55;
          push_env w_82 split1_28;
          assert_env_length w_82 4;
          push_env w_82 (Memo.from_int 0);
          assert_env_length w_82 5;
          drop_n w_82 5 2;
...
let () =
  add_exp
    (fun w_88 ->
      ...
      w_88.state.c <- pc_to_exp (int_to_pc 91);
      stepped w_88)
    89
...
let () =
  add_exp
    (fun w_89 ->
      ...
      let x_57 = resolve w_89 last_57 in
      ...
      | c_57 when c_57 = tag_VClosure ->
          let splits_61 = Memo.splits (snd x_57) in
          let split0_61 = List.nth splits_61 0 in
          let split1_31 = List.nth splits_61 1 in
          ignore (pop_env w_89);
...
let () =
  add_exp
    (fun w_93 ->
      ...
      let x_60 = resolve w_93 last_60 in
      ...
      | c_60 when c_60 = tag_ECons ->
          ...
          let split1_32 = List.nth splits_65 1 in
          ignore (pop_env w_93);
          push_env w_93 split0_65;
          push_env w_93 split1_32;
          assert_env_length w_93 4;
          push_env w_93 (Dynarray.get w_93.state.e 1);
          assert_env_length w_93 5;
          let keep_vals_3 = env_call w_93 [] 1 in
          w_93.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_vals_3; w_93.state.k ];
          w_93.state.c <- pc_to_exp (int_to_pc 58);
          stepped w_93
      | _ ->
          ignore (pop_env w_93);
          failwith "cdr: PAIR expected"
      | c_60 -> failwith ("unreachable:" ^ string_of_int c_60 ^ "(93)"))
    93
...
let () =
  add_exp
    (fun w_92 ->
      ...
      let x_59 = resolve w_92 last_59 in
      match Word.get_value (fst x_59) with
      | c_59 when c_59 = tag_VNumber ->
          let splits_62 = Memo.splits (snd x_59) in
      ...
      | c_59 when c_59 = tag_VCons ->
          let splits_66 = Memo.splits (snd x_59) in
          let split0_66 = List.nth splits_66 0 in
          let split1_33 = List.nth splits_66 1 in
          ignore (pop_env w_92);
          push_env w_92 split0_66;
  ...
  add_exp
    (fun w_95 ->
      ...
      | c_61 when c_61 = tag_VQuote ->
          let splits_70 = Memo.splits (snd x_61) in
      ...
      | c_61 when c_61 = tag_VNIL ->
          ...
          w_95.state.c <- pc_to_exp (int_to_pc 25);
          stepped w_95
      | c_61 when c_61 = tag_VCons ->
          let splits_71 = Memo.splits (snd x_61) in
          let split0_71 = List.nth splits_71 0 in
          let split1_35 = List.nth splits_71 1 in
          ignore (pop_env w_95);
          ...
          stepped w_95
      | c_61 when c_61 = tag_VClosure ->
          let splits_72 = Memo.splits (snd x_61) in
...
let () =
  add_exp
    (fun w_96 ->
      ...
      let keep_vals_4 = env_call w_96 [] 2 in
      w_96.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_vals_4; w_96.state.k ];
...
let () =
  add_exp
    (fun w_97 ->
      ...
      let keep_vals_5 = env_call w_97 [ 0 ] 1 in
      w_97.state.k <- Memo.appends [ Memo.from_constructor tag_cont_6; keep_vals_5; w_97.state.k ];
...
let () =
  add_exp
    (fun w_100 ->
      ...
      let last_63 = Source.E 5 in
      let x_63 = resolve w_100 last_63 in
      ...
      | c_63 when c_63 = tag_Cons ->
          ...
          ignore (pop_env w_100);
          push_env w_100 split0_74;
          push_env w_100 split1_38;
          assert_env_length w_100 7;
          push_env w_100 (Dynarray.get w_100.state.e 4);
          assert_env_length w_100 8;
          push_env w_100 (Dynarray.get w_100.state.e 6);
          assert_env_length w_100 9;
          push_env w_100 (Dynarray.get w_100.state.e 3);
          assert_env_length w_100 10;
          push_env w_100 (Dynarray.get w_100.state.e 5);
          assert_env_length w_100 11;
          let ctor_arg_12 = pop_env w_100 in
          let ctor_arg_13 = pop_env w_100 in
          push_env w_100 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_13; ctor_arg_12 ]);
          assert_env_length w_100 10;
          push_env w_100 (Dynarray.get w_100.state.e 2);
          assert_env_length w_100 11;
          let keep_vals_6 = env_call w_100 [ 7; 8 ] 2 in
          w_100.state.k <- Memo.appends [ Memo.from_constructor tag_cont_7; keep_vals_6; w_100.state.k ];
          w_100.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_100
...
let () =
  add_exp
    (fun w_99 ->
      ...
      | c_62 when c_62 = tag_Nil ->
          ignore (pop_env w_99);
          assert_env_length w_99 3;
          push_env w_99 (Dynarray.get w_99.state.e 2);
          assert_env_length w_99 4;
          return_n w_99 4 (pc_to_exp (int_to_pc 0))
      | c_62 when c_62 = tag_Cons ->
          ...
          stepped w_99
      | c_62 -> failwith ("unreachable:" ^ string_of_int c_62 ^ "(101)"))
    101
...
let () =
  add_exp
    (fun w_103 ->
      ...
      | c_65 -> failwith ("unreachable:" ^ string_of_int c_65 ^ "(103)"))
    103
...
let () =
  add_exp
    (fun w_102 ->
      ...
      let x_64 = resolve w_102 last_64 in
      ...
      | c_64 when c_64 = tag_ECons ->
          ...
          let keep_vals_7 = env_call w_102 [ 2 ] 1 in
          w_102.state.k <- Memo.appends [ Memo.from_constructor tag_cont_8; keep_vals_7; w_102.state.k ];
      ...
      | c_64 when c_64 = tag_EAtom ->
          ...
          stepped w_102
      | c_64 -> failwith ("unreachable:" ^ string_of_int c_64 ^ "(104)"))
    104
...
let () =
  add_exp
    (fun w_105 ->
      ...
      let x_66 = resolve w_105 last_66 in
      ...
      | c_66 when c_66 = tag_VQuote ->
          ...
          push_env w_105 split0_77;
          assert_env_length w_105 2;
          push_env w_105 (Dynarray.get w_105.state.e 1);
          assert_env_length w_105 3;
          let keep_vals_8 = env_call w_105 [] 1 in
          w_105.state.k <- Memo.appends [ Memo.from_constructor tag_cont_9; keep_vals_8; w_105.state.k ];
          w_105.state.c <- pc_to_exp (int_to_pc 19);
          stepped w_105
      | _ ->
          ignore (pop_env w_105);
          assert_env_length w_105 1;
          push_env w_105 (Memo.from_constructor tag_Unit);
          assert_env_length w_105 2;
          ignore (env_call w_105 [] 1);
          w_105.state.c <- pc_to_exp (int_to_pc 24);
          stepped w_105
      | c_66 -> failwith ("unreachable:" ^ string_of_int c_66 ^ "(106)"))
    106
...
let () =
  add_exp
    (fun w_106 ->
      ...
      w_106.state.c <- pc_to_exp (int_to_pc 110);
      stepped w_106)
    107
...
let () =
  add_exp
    (fun w_107 ->
      ...
      let x_67 = resolve w_107 last_67 in
      ...
      | c_67 when c_67 = tag_ECons ->
          ...
          let keep_vals_9 = env_call w_107 [ 1; 3 ] 2 in
          w_107.state.k <- Memo.appends [ Memo.from_constructor tag_cont_10; keep_vals_9; w_107.state.k ];
          w_107.state.c <- pc_to_exp (int_to_pc 109);
          stepped w_107
      | _ ->
          ignore (pop_env w_107);
          assert_env_length w_107 2;
          push_env w_107 (Memo.from_constructor tag_Nil);
          assert_env_length w_107 3;
...
let () =
  add_exp
    (fun w_109 ->
      ...
      let x_68 = resolve w_109 last_68 in
      ...
      | c_68 -> failwith ("unreachable:" ^ string_of_int c_68 ^ "(111)"))
    111
...
let () =
  add_exp
    (fun w_112 ->
      ...
      let x_70 = resolve w_112 last_70 in
      match Word.get_value (fst x_70) with
      | c_70 when c_70 = tag_AVar ->
          let splits_81 = Memo.splits (snd x_70) in
          ...
          ignore (env_call w_112 [] 2);
          w_112.state.c <- pc_to_exp (int_to_pc 98);
          stepped w_112
      | c_70 when c_70 = tag_ANumber ->
          let splits_82 = Memo.splits (snd x_70) in
          let split0_82 = List.nth splits_82 0 in
          ignore (pop_env w_112);
          push_env w_112 split0_82;
          assert_env_length w_112 4;
          push_env w_112 (Dynarray.get w_112.state.e 3);
          assert_env_length w_112 5;
          let ctor_arg_14 = pop_env w_112 in
          push_env w_112 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_14 ]);
          assert_env_length w_112 5;
          drop_n w_112 5 1;
          assert_env_length w_112 4;
          drop_n w_112 4 1;
      ...
      | c_70 when c_70 = tag_ASymbol ->
          let splits_83 = Memo.splits (snd x_70) in
          ...
          push_env w_112 (Dynarray.get w_112.state.e 3);
          assert_env_length w_112 5;
          let ctor_arg_15 = pop_env w_112 in
          push_env w_112 (Memo.appends [ Memo.from_constructor tag_VSymbol; ctor_arg_15 ]);
          assert_env_length w_112 5;
          drop_n w_112 5 1;
          assert_env_length w_112 4;
          drop_n w_112 4 1;
          assert_env_length w_112 3;
          return_n w_112 3 (pc_to_exp (int_to_pc 0))
      | c_70 when c_70 = tag_ANIL ->
          ignore (pop_env w_112);
          failwith "ill-formed expression: NIL"
      | c_70 -> failwith ("unreachable:" ^ string_of_int c_70 ^ "(112)"))
    112
  ...
  add_exp
    (fun w_111 ->
      ...
      | c_69 when c_69 = tag_ECons ->
          ...
          let keep_vals_11 = env_call w_111 [ 0; 1 ] 1 in
          w_111.state.k <- Memo.appends [ Memo.from_constructor tag_cont_12; keep_vals_11; w_111.state.k ];
          w_111.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_111
...
let () =
  add_exp
    (fun w_115 ->
      ...
      let x0_4 = resolve w_115 (Source.E 2) in
      let x1_4 = resolve w_115 (Source.E 3) in
      ignore (pop_env w_115);
      ignore (pop_env w_115);
      push_env w_115 (Memo.from_int (if Word.get_value (fst x0_4) = Word.get_value (fst x1_4) then 1 else 0));
...
let () =
  add_exp
    (fun w_114 ->
      ...
      let x_71 = resolve w_114 last_71 in
...
let () =
  add_exp
    (fun w_117 ->
      ...
      let x0_5 = resolve w_117 (Source.E 2) in
      let x1_5 = resolve w_117 (Source.E 3) in
      ignore (pop_env w_117);
      ignore (pop_env w_117);
      push_env w_117 (Memo.from_int (if Word.get_value (fst x0_5) = Word.get_value (fst x1_5) then 1 else 0));
...
let () =
  add_exp
    (fun w_116 ->
      ...
      let x_72 = resolve w_116 last_72 in
      ...
      | c_72 when c_72 = tag_Some ->
          ...
          stepped w_116
      | c_72 -> failwith ("unreachable:" ^ string_of_int c_72 ^ "(117)"))
    117
...
let () =
  add_exp
    (fun w_118 ->
      ...
      let cond_0 = resolve w_118 (Source.E 0) in
...
let () =
  add_exp
    (fun w_119 ->
      ...
      let x_73 = resolve w_119 last_73 in
      match Word.get_value (fst x_73) with
      | c_73 when c_73 = tag_Nil ->
          ignore (pop_env w_119);
          failwith "empty environment"
      | c_73 when c_73 = tag_Cons ->
          let splits_87 = Memo.splits (snd x_73) in
          let split0_87 = List.nth splits_87 0 in
          let split1_43 = List.nth splits_87 1 in
          ignore (pop_env w_119);
          push_env w_119 split0_87;
          push_env w_119 split1_43;
          assert_env_length w_119 3;
          push_env w_119 (Dynarray.get w_119.state.e 1);
          assert_env_length w_119 4;
          let keep_vals_12 = env_call w_119 [ 0; 1; 2 ] 1 in
          w_119.state.k <- Memo.appends [ Memo.from_constructor tag_cont_13; keep_vals_12; w_119.state.k ];
          w_119.state.c <- pc_to_exp (int_to_pc 6);
          stepped w_119
      | c_73 -> failwith ("unreachable:" ^ string_of_int c_73 ^ "(119)"))
    119
...
let () =
  add_exp
    (fun w_120 ->
      ...
      | c_74 when c_74 = tag_Some ->
          let splits_88 = Memo.splits (snd x_74) in
          let split0_88 = List.nth splits_88 0 in
          ignore (pop_env w_120);
          push_env w_120 split0_88;
          assert_env_length w_120 2;
          ...
          let keep_vals_13 = env_call w_120 [ 2 ] 1 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_14; keep_vals_13; w_120.state.k ];
          w_120.state.c <- pc_to_exp (int_to_pc 102);
          stepped w_120
      | _ ->
          ignore (pop_env w_120);
          failwith "destruct_names: impossible, names must be int literals"
      | c_74 -> failwith ("unreachable:" ^ string_of_int c_74 ^ "(120)"))
    120
...
let () =
  add_exp
    (fun w_121 ->
      ...
      let cond_1 = resolve w_121 (Source.E 0) in
      ...
      if Word.get_value (fst cond_1) <> 0 then (
        ...
        push_env w_121 (Memo.from_constructor tag_Unit);
        assert_env_length w_121 1;
        ...
        assert_env_length w_121 1;
        ignore (env_call w_121 [] 1);
        w_121.state.c <- pc_to_exp (int_to_pc 24);
        stepped w_121))
    121
...
let () =
  add_exp
    (fun w_123 ->
      ...
      let cond_2 = resolve w_123 (Source.E 3) in
      ...
      if Word.get_value (fst cond_2) <> 0 then (
        ...
        assert_env_length w_123 4;
        ignore (env_call w_123 [] 1);
        w_123.state.c <- pc_to_exp (int_to_pc 8);
        stepped w_123)
      else (
        assert_env_length w_123 3;
        ...
        let ctor_arg_18 = pop_env w_123 in
        push_env w_123 (Memo.appends [ Memo.from_constructor tag_MkEnv; ctor_arg_18 ]);
        assert_env_length w_123 5;
        ignore (env_call w_123 [] 2);
        w_123.state.c <- pc_to_exp (int_to_pc 98);
        stepped w_123))
    122
...
let () =
  add_exp
    (fun w_122 ->
      ...
      let x0_6 = resolve w_122 (Source.E 3) in
      let x1_6 = resolve w_122 (Source.E 4) in
      ignore (pop_env w_122);
      ignore (pop_env w_122);
      push_env w_122 (Memo.from_int (if Word.get_value (fst x0_6) = Word.get_value (fst x1_6) then 1 else 0));
...
let () =
  add_exp
    (fun w_125 ->
      ...
      let x_76 = resolve w_125 last_76 in
      ...
      | c_76 when c_76 = tag_SQuote ->
          ...
          assert_env_length w_125 4;
          let keep_vals_18 = env_call w_125 [] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_19; keep_vals_18; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SAtom ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_19 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_20; keep_vals_19; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SEq ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_20 = env_call w_125 [ 0; 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_21; keep_vals_20; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SCar ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_21 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_22; keep_vals_21; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SCdr ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_22 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_23; keep_vals_22; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SCons ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_23 = env_call w_125 [ 0; 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_24; keep_vals_23; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SCond ->
          ...
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_24 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_25; keep_vals_24; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 58);
          stepped w_125
      | c_76 when c_76 = tag_SNull ->
          ignore (pop_env w_125);
          assert_env_length w_125 3;
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_25 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_26; keep_vals_25; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | c_76 when c_76 = tag_SError ->
          ignore (pop_env w_125);
          assert_env_length w_125 3;
          push_env w_125 (Dynarray.get w_125.state.e 0);
          assert_env_length w_125 4;
          let keep_vals_26 = env_call w_125 [ 1 ] 1 in
          w_125.state.k <- Memo.appends [ Memo.from_constructor tag_cont_27; keep_vals_26; w_125.state.k ];
          w_125.state.c <- pc_to_exp (int_to_pc 34);
          stepped w_125
      | _ ->
          ignore (pop_env w_125);
...
let () =
  add_exp
    (fun w_124 ->
      ...
      let x_75 = resolve w_124 last_75 in
      match Word.get_value (fst x_75) with
      | c_75 when c_75 = tag_Some ->
          let splits_89 = Memo.splits (snd x_75) in
      ...
      | c_75 when c_75 = tag_None ->
          ...
          assert_env_length w_124 3;
          let keep_vals_27 = env_call w_124 [ 0; 1 ] 1 in
          w_124.state.k <- Memo.appends [ Memo.from_constructor tag_cont_28; keep_vals_27; w_124.state.k ];
          w_124.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_124
  ...
  add_exp
    (fun w_126 ->
      ...
      | c_77 when c_77 = tag_ECons ->
          let splits_90 = Memo.splits (snd x_77) in
          let split0_90 = List.nth splits_90 0 in
          let split1_44 = List.nth splits_90 1 in
          ignore (pop_env w_126);
          push_env w_126 split0_90;
          push_env w_126 split1_44;
          assert_env_length w_126 4;
          push_env w_126 (Dynarray.get w_126.state.e 0);
          assert_env_length w_126 5;
          let keep_vals_36 = env_call w_126 [ 0; 1 ] 1 in
          w_126.state.k <- Memo.appends [ Memo.from_constructor tag_cont_37; keep_vals_36; w_126.state.k ];
          w_126.state.c <- pc_to_exp (int_to_pc 37);
          stepped w_126
      | _ ->
          ignore (pop_env w_126);
          ...
          push_env w_126 (Dynarray.get w_126.state.e 0);
          assert_env_length w_126 3;
          let keep_vals_37 = env_call w_126 [ 0; 1 ] 1 in
          w_126.state.k <- Memo.appends [ Memo.from_constructor tag_cont_38; keep_vals_37; w_126.state.k ];
          w_126.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_126
...
let () =
  add_exp
    (fun w_127 ->
      ...
      let cond_3 = resolve w_127 (Source.E 3) in
      ...
      if Word.get_value (fst cond_3) <> 0 then (
        ...
        w_127.state.c <- pc_to_exp (int_to_pc 108);
        stepped w_127)
      else (
        assert_env_length w_127 3;
        push_env w_127 (Dynarray.get w_127.state.e 1);
        assert_env_length w_127 4;
        let keep_vals_38 = env_call w_127 [ 0 ] 1 in
        w_127.state.k <- Memo.appends [ Memo.from_constructor tag_cont_39; keep_vals_38; w_127.state.k ];
        w_127.state.c <- pc_to_exp (int_to_pc 34);
        stepped w_127))
    127
...
let () =
  add_exp
    (fun w_129 ->
      let err_0 = resolve w_129 (Source.E 1) in
...
let () =
  add_exp
    (fun w_128 ->
      ...
      let x_78 = resolve w_128 last_78 in
...
let () =
  add_exp
    (fun w_131 ->
      ...
      | c_80 when c_80 = tag_SLambda ->
          ignore (pop_env w_131);
          assert_env_length w_131 3;
          push_env w_131 (Dynarray.get w_131.state.e 0);
          assert_env_length w_131 4;
          let keep_vals_46 = env_call w_131 [ 0; 1 ] 1 in
          w_131.state.k <- Memo.appends [ Memo.from_constructor tag_cont_47; keep_vals_46; w_131.state.k ];
          w_131.state.c <- pc_to_exp (int_to_pc 47);
          stepped w_131
      | c_80 when c_80 = tag_SDefine ->
          ignore (pop_env w_131);
          assert_env_length w_131 3;
          push_env w_131 (Memo.from_constructor tag_SLambda);
          assert_env_length w_131 4;
          let ctor_arg_24 = pop_env w_131 in
          push_env w_131 (Memo.appends [ Memo.from_constructor tag_ASymbol; ctor_arg_24 ]);
          assert_env_length w_131 4;
          let ctor_arg_25 = pop_env w_131 in
          push_env w_131 (Memo.appends [ Memo.from_constructor tag_EAtom; ctor_arg_25 ]);
          assert_env_length w_131 4;
          push_env w_131 (Dynarray.get w_131.state.e 0);
          assert_env_length w_131 5;
          let keep_vals_47 = env_call w_131 [ 0; 1; 3 ] 1 in
          w_131.state.k <- Memo.appends [ Memo.from_constructor tag_cont_48; keep_vals_47; w_131.state.k ];
          w_131.state.c <- pc_to_exp (int_to_pc 43);
          stepped w_131
      | c_80 when c_80 = tag_SQuote ->
          ignore (pop_env w_131);
          failwith "unexpected function quote"
      | c_80 when c_80 = tag_SEq ->
          ignore (pop_env w_131);
          failwith "unexpected function eq"
      | c_80 when c_80 = tag_SCons ->
          ignore (pop_env w_131);
          failwith "unexpected function cons"
      | c_80 when c_80 = tag_SCond ->
          ignore (pop_env w_131);
          failwith "unexpected function cond"
      | c_80 when c_80 = tag_SAtom ->
          ignore (pop_env w_131);
          failwith "unexpected function atom"
      | c_80 when c_80 = tag_SCar ->
          ignore (pop_env w_131);
          failwith "unexpected function car"
      | c_80 when c_80 = tag_SCdr ->
          ignore (pop_env w_131);
          failwith "unexpected function cdr"
      | c_80 when c_80 = tag_SNull ->
          ignore (pop_env w_131);
          failwith "unexpected function null"
      | c_80 when c_80 = tag_SError ->
          ignore (pop_env w_131);
          failwith "unexpected function error"
      | _ ->
          ignore (pop_env w_131);
          failwith "1"
      | c_80 -> failwith ("unreachable:" ^ string_of_int c_80 ^ "(130)"))
    130
  ...
  add_exp
    (fun w_130 ->
      ...
      | c_79 when c_79 = tag_None ->
          ...
          assert_env_length w_130 3;
          let keep_vals_48 = env_call w_130 [] 1 in
          w_130.state.k <- Memo.appends [ Memo.from_constructor tag_cont_49; keep_vals_48; w_130.state.k ];
          w_130.state.c <- pc_to_exp (int_to_pc 37);
          stepped w_130
      | c_79 -> failwith ("unreachable:" ^ string_of_int c_79 ^ "(131)"))
    131
  ...
  add_exp
    (fun w_132 ->
      ...
      | c_81 when c_81 = tag_Some ->
          ...
          let keep_vals_49 = env_call w_132 [ 0; 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_50; keep_vals_49; w_132.state.k ];
      ...
      | c_81 when c_81 = tag_None ->
          ...
          assert_env_length w_132 3;
          let keep_vals_50 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_51; keep_vals_50; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 56);
          stepped w_132
  ...
  add_exp
    (fun w_133 ->
      ...
      | c_82 when c_82 = tag_ECons ->
          ...
          let split1_45 = List.nth splits_98 1 in
          ignore (pop_env w_133);
          push_env w_133 split0_98;
          push_env w_133 split1_45;
...
let () =
  add_exp
    (fun w_135 ->
      ...
      | c_84 when c_84 = tag_VNumber ->
          let splits_99 = Memo.splits (snd x_84) in
          let split0_99 = List.nth splits_99 0 in
          ignore (pop_env w_135);
          push_env w_135 split0_99;
          failwith "NUMBER is not PROCEDURE"
      | c_84 when c_84 = tag_VSymbol ->
          let splits_100 = Memo.splits (snd x_84) in
          let split0_100 = List.nth splits_100 0 in
          ignore (pop_env w_135);
          push_env w_135 split0_100;
          failwith "SYMBOL is not PROCEDURE"
      | c_84 when c_84 = tag_VQuote ->
          let splits_101 = Memo.splits (snd x_84) in
          let split0_101 = List.nth splits_101 0 in
          ignore (pop_env w_135);
          push_env w_135 split0_101;
          failwith "QUOTE is not PROCEDURE"
      | c_84 when c_84 = tag_VNIL ->
          ignore (pop_env w_135);
          failwith "NIL is not PROCEDURE"
      | c_84 when c_84 = tag_VCons ->
          let splits_102 = Memo.splits (snd x_84) in
          let split0_102 = List.nth splits_102 0 in
          let split1_46 = List.nth splits_102 1 in
          ignore (pop_env w_135);
          push_env w_135 split0_102;
          push_env w_135 split1_46;
          failwith "PAIR is not PROCEDURE"
      | c_84 when c_84 = tag_VClosure ->
          let splits_103 = Memo.splits (snd x_84) in
          let split0_103 = List.nth splits_103 0 in
          let split1_47 = List.nth splits_103 1 in
          ignore (pop_env w_135);
          push_env w_135 split0_103;
          push_env w_135 split1_47;
          ...
          let keep_vals_53 = env_call w_135 [ 1; 4 ] 1 in
          w_135.state.k <- Memo.appends [ Memo.from_constructor tag_cont_54; keep_vals_53; w_135.state.k ];
          w_135.state.c <- pc_to_exp (int_to_pc 58);
          stepped w_135
      | c_84 -> failwith ("unreachable:" ^ string_of_int c_84 ^ "(135)"))
    135
  ...
  add_exp
    (fun w_137 ->
      ...
      | _ ->
          ignore (pop_env w_137);
          failwith "impossible"
      | c_86 -> failwith ("unreachable:" ^ string_of_int c_86 ^ "(136)"))
    136
...
let () =
  add_exp
    (fun w_136 ->
      ...
      let last_85 = Source.E 0 in
      let x_85 = resolve w_136 last_85 in
      match Word.get_value (fst x_85) with
      | c_85 when c_85 = tag_EAtom ->
          let splits_104 = Memo.splits (snd x_85) in
          let split0_104 = List.nth splits_104 0 in
          ignore (pop_env w_136);
          push_env w_136 split0_104;
          assert_env_length w_136 1;
      ...
      | _ ->
          ignore (pop_env w_136);
          failwith "impossible"
      | c_85 -> failwith ("unreachable:" ^ string_of_int c_85 ^ "(137)"))
    137
...
let () =
  add_exp
    (fun w_138 ->
      ...
      let x_87 = resolve w_138 last_87 in
      ...
      | c_87 when c_87 = tag_Some ->
          ...
          let ctor_arg_32 = pop_env w_138 in
          let ctor_arg_33 = pop_env w_138 in
          push_env w_138 (Memo.appends [ Memo.from_constructor tag_VClosure; ctor_arg_33; ctor_arg_32 ]);
          assert_env_length w_138 5;
          push_env w_138 (Dynarray.get w_138.state.e 3);
          assert_env_length w_138 6;
          push_env w_138 (Dynarray.get w_138.state.e 4);
          assert_env_length w_138 7;
          let ctor_arg_34 = pop_env w_138 in
          let ctor_arg_35 = pop_env w_138 in
          push_env w_138 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_35; ctor_arg_34 ]);
          assert_env_length w_138 6;
          push_env w_138 (Dynarray.get w_138.state.e 1);
          assert_env_length w_138 7;
          let keep_vals_57 = env_call w_138 [ 0 ] 2 in
          w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_58; keep_vals_57; w_138.state.k ];
          w_138.state.c <- pc_to_exp (int_to_pc 28);
          stepped w_138
      | c_87 -> failwith ("unreachable:" ^ string_of_int c_87 ^ "(138)"))
    138
...
let () = Words.set_constructor_degree 18 0
...
let () = Words.set_constructor_degree 41 (-3)
...
let () = Words.set_constructor_degree 46 (-3)
let () = Words.set_constructor_degree 47 (-2)
let () = Words.set_constructor_degree 48 (-4)
...
let () = Words.set_constructor_degree 59 (-3)
...
let () = Words.set_constructor_degree 89 (-3)
