...
let tag_cont_126 = 163
let tag_cont_127 = 164
...
let () =
  add_exp
    (fun w_132 ->
      ...
      let hd_0, tl_0 = resolve w_132 K in
      match Word.get_value hd_0 with
      | c_100 when c_100 = tag_cont_done -> exec_done w_132
      | c_100 when c_100 = tag_cont_1 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_44 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_45; keep_vals_44; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 66);
          stepped w_132
      | c_100 when c_100 = tag_cont_2 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 134);
          stepped w_132
      | c_100 when c_100 = tag_cont_3 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 136);
          stepped w_132
      | c_100 when c_100 = tag_cont_4 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let ctor_arg_33 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_33 ]);
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_5 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let ctor_arg_34 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_VQuote; ctor_arg_34 ]);
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_8 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_9 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_10 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_14 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_15 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_16 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_21 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_22 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_23 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_26 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_27 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 137);
          stepped w_132
      | c_100 when c_100 = tag_cont_28 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_29 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_30 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_31 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 138);
          stepped w_132
      | c_100 when c_100 = tag_cont_32 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          w_132.state.c <- pc_to_exp (int_to_pc 140);
          stepped w_132
      | c_100 when c_100 = tag_cont_33 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          let ctor_arg_35 = pop_env w_132 in
          let ctor_arg_36 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_36; ctor_arg_35 ]);
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_34 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 141);
          stepped w_132
      | c_100 when c_100 = tag_cont_35 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 142);
          stepped w_132
      | c_100 when c_100 = tag_cont_36 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_37 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_38 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_52 = env_call w_132 [ 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_53; keep_vals_52; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 122);
          stepped w_132
      | c_100 when c_100 = tag_cont_39 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 5;
          let keep_vals_53 = env_call w_132 [ 2 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_54; keep_vals_53; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 125);
          stepped w_132
      | c_100 when c_100 = tag_cont_40 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 5;
          let keep_vals_54 = env_call w_132 [ 0; 1; 2 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_55; keep_vals_54; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_41 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          ...
          w_132.state.c <- pc_to_exp (int_to_pc 108);
          stepped w_132
      | c_100 when c_100 = tag_cont_42 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_43 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_44 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let keep_vals_55 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_56; keep_vals_55; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_132
      | c_100 when c_100 = tag_cont_45 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 143);
          stepped w_132
      | c_100 when c_100 = tag_cont_46 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_47 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_48 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_49 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_50 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          let ctor_arg_37 = pop_env w_132 in
          let ctor_arg_38 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_38; ctor_arg_37 ]);
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_52 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_53 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          ignore (env_call w_132 [] 2);
          w_132.state.c <- pc_to_exp (int_to_pc 104);
          stepped w_132
      | c_100 when c_100 = tag_cont_54 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          let ctor_arg_39 = pop_env w_132 in
          let ctor_arg_40 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_40; ctor_arg_39 ]);
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_55 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          let keep_vals_56 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_57; keep_vals_56; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 29);
          stepped w_132
      | c_100 when c_100 = tag_cont_56 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 145);
          stepped w_132
      | c_100 when c_100 = tag_cont_57 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 146);
          stepped w_132
      | c_100 when c_100 = tag_cont_58 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let keep_vals_73 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_74; keep_vals_73; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 122);
          stepped w_132
      | c_100 when c_100 = tag_cont_59 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_74 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_75; keep_vals_74; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_60 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_75 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_76; keep_vals_75; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_61 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_76 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_77; keep_vals_76; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_62 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          assert_env_length w_132 4;
          let keep_vals_77 = env_call w_132 [ 0; 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_78; keep_vals_77; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_63 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_78 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_79; keep_vals_78; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_64 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_79 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_80; keep_vals_79; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_65 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_80 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_81; keep_vals_80; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 31);
          stepped w_132
      | c_100 when c_100 = tag_cont_66 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          assert_env_length w_132 4;
          let keep_vals_81 = env_call w_132 [ 0; 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_82; keep_vals_81; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_67 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          ignore (env_call w_132 [] 2);
          w_132.state.c <- pc_to_exp (int_to_pc 126);
          stepped w_132
      | c_100 when c_100 = tag_cont_68 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_82 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_83; keep_vals_82; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_69 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_83 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_84; keep_vals_83; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_70 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          assert_env_length w_132 4;
          let keep_vals_84 = env_call w_132 [ 0; 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_85; keep_vals_84; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_71 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_85 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_86; keep_vals_85; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_72 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 147);
          stepped w_132
      | c_100 when c_100 = tag_cont_73 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
      ...
      | c_100 when c_100 = tag_cont_74 ->
          ...
          w_132.state.c <- pc_to_exp (int_to_pc 108);
          stepped w_132
      | c_100 when c_100 = tag_cont_75 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 94);
          stepped w_132
      | c_100 when c_100 = tag_cont_76 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 98);
          stepped w_132
      | c_100 when c_100 = tag_cont_77 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 101);
          stepped w_132
      | c_100 when c_100 = tag_cont_78 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_88 = env_call w_132 [ 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_89; keep_vals_88; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 31);
          stepped w_132
      | c_100 when c_100 = tag_cont_79 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let keep_vals_89 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_90; keep_vals_89; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 87);
          stepped w_132
      | c_100 when c_100 = tag_cont_80 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let keep_vals_90 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_91; keep_vals_90; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 91);
          stepped w_132
      | c_100 when c_100 = tag_cont_81 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 5;
          let keep_vals_91 = env_call w_132 [ 1; 2; 3 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_92; keep_vals_91; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 35);
          stepped w_132
      | c_100 when c_100 = tag_cont_82 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_92 = env_call w_132 [ 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_93; keep_vals_92; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 31);
          stepped w_132
      | c_100 when c_100 = tag_cont_83 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 120);
          stepped w_132
      | c_100 when c_100 = tag_cont_84 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 96);
          stepped w_132
      | c_100 when c_100 = tag_cont_85 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let keep_vals_93 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_94; keep_vals_93; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 29);
          stepped w_132
      | c_100 when c_100 = tag_cont_86 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 2;
          let keep_vals_94 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_95; keep_vals_94; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 22);
          stepped w_132
      | c_100 when c_100 = tag_cont_87 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let keep_vals_95 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_96; keep_vals_95; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 10);
          stepped w_132
      | c_100 when c_100 = tag_cont_88 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let keep_vals_96 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_97; keep_vals_96; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 13);
          stepped w_132
      | c_100 when c_100 = tag_cont_89 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_97 = env_call w_132 [ 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_98; keep_vals_97; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_90 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
      ...
      | c_100 when c_100 = tag_cont_92 ->
          ...
          let keep_vals_98 = env_call w_132 [ 0; 2; 3 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_99; keep_vals_98; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_93 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_99 = env_call w_132 [ 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_100; keep_vals_99; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_94 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 148);
          stepped w_132
      | c_100 when c_100 = tag_cont_95 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 150);
          stepped w_132
      | c_100 when c_100 = tag_cont_96 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 152);
          stepped w_132
      | c_100 when c_100 = tag_cont_97 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 153);
          stepped w_132
      | c_100 when c_100 = tag_cont_98 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          ignore (env_call w_132 [] 2);
          w_132.state.c <- pc_to_exp (int_to_pc 103);
          stepped w_132
      | c_100 when c_100 = tag_cont_99 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 3);
          assert_env_length w_132 5;
          let keep_vals_108 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_109; keep_vals_108; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 29);
          stepped w_132
      | c_100 when c_100 = tag_cont_100 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          let keep_vals_109 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_110; keep_vals_109; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 104);
          stepped w_132
      | c_100 when c_100 = tag_cont_101 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_102 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          let keep_vals_110 = env_call w_132 [] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_111; keep_vals_110; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_103 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let keep_vals_111 = env_call w_132 [ 0; 1 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_112; keep_vals_111; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 117);
          stepped w_132
      | c_100 when c_100 = tag_cont_104 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          let ctor_arg_43 = pop_env w_132 in
          let ctor_arg_44 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_44; ctor_arg_43 ]);
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_112 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_113; keep_vals_112; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 53);
          stepped w_132
      | c_100 when c_100 = tag_cont_105 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          assert_env_length w_132 4;
          let keep_vals_113 = env_call w_132 [ 0; 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_114; keep_vals_113; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_106 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 155);
          stepped w_132
      | c_100 when c_100 = tag_cont_107 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 156);
          stepped w_132
      | c_100 when c_100 = tag_cont_108 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 158);
          stepped w_132
      | c_100 when c_100 = tag_cont_109 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 159);
          stepped w_132
      | c_100 when c_100 = tag_cont_110 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          ignore (env_call w_132 [] 1);
          w_132.state.c <- pc_to_exp (int_to_pc 108);
          stepped w_132
      | c_100 when c_100 = tag_cont_111 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          let keep_vals_115 = env_call w_132 [] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_116; keep_vals_115; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 29);
          stepped w_132
      | c_100 when c_100 = tag_cont_112 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_116 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_117; keep_vals_116; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 57);
          stepped w_132
      | c_100 when c_100 = tag_cont_113 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          let keep_vals_117 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_118; keep_vals_117; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_132
      | c_100 when c_100 = tag_cont_114 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 4;
          let keep_vals_118 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_119; keep_vals_118; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 53);
          stepped w_132
      | c_100 when c_100 = tag_cont_115 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 2 tl_0;
          assert_env_length w_132 3;
          let ctor_arg_45 = pop_env w_132 in
          let ctor_arg_46 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_46; ctor_arg_45 ]);
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 3;
          ignore (env_call w_132 [] 2);
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_116 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 160);
          stepped w_132
      | c_100 when c_100 = tag_cont_117 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 5;
          let keep_vals_121 = env_call w_132 [ 1; 2; 3 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_122; keep_vals_121; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 64);
          stepped w_132
      | c_100 when c_100 = tag_cont_118 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 161);
          stepped w_132
      | c_100 when c_100 = tag_cont_119 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          let keep_vals_123 = env_call w_132 [ 0; 1; 2 ] 1 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_124; keep_vals_123; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 16);
          stepped w_132
      | c_100 when c_100 = tag_cont_120 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 0 tl_0;
          assert_env_length w_132 1;
          drop_n w_132 1 0;
      ...
      | c_100 when c_100 = tag_cont_121 ->
          ...
          assert_env_length w_132 1;
          return_n w_132 1 (pc_to_exp (int_to_pc 0))
      | c_100 when c_100 = tag_cont_122 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 0);
          assert_env_length w_132 5;
          let keep_vals_124 = env_call w_132 [ 0; 1; 2 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_125; keep_vals_124; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 125);
          stepped w_132
      | c_100 when c_100 = tag_cont_123 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          ...
          w_132.state.c <- pc_to_exp (int_to_pc 127);
          stepped w_132
      | c_100 when c_100 = tag_cont_124 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          w_132.state.c <- pc_to_exp (int_to_pc 162);
          stepped w_132
      | c_100 when c_100 = tag_cont_125 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 3 tl_0;
          assert_env_length w_132 4;
          push_env w_132 (Dynarray.get w_132.state.e 1);
          ...
          let keep_vals_126 = env_call w_132 [ 2 ] 3 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_127; keep_vals_126; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 114);
          stepped w_132
      | c_100 when c_100 = tag_cont_126 ->
          w_132.state.k <- get_next_cont tl_0;
          restore_env w_132 1 tl_0;
          assert_env_length w_132 2;
          push_env w_132 (Dynarray.get w_132.state.e 1);
...
let () =
  add_exp
    (fun w_121 ->
      ...
      w_121.state.c <- pc_to_exp (int_to_pc 124);
      stepped w_121)
    122
...
let () =
  add_exp
    (fun w_123 ->
      ...
      let x_76 = resolve w_123 last_76 in
      match Word.get_value (fst x_76) with
      | c_76 when c_76 = tag_ANIL ->
          ignore (pop_env w_123);
          assert_env_length w_123 2;
          push_env w_123 (Memo.from_constructor tag_VNIL);
          assert_env_length w_123 3;
          drop_n w_123 3 1;
          assert_env_length w_123 2;
          return_n w_123 2 (pc_to_exp (int_to_pc 0))
      | c_76 when c_76 = tag_AVar ->
          let splits_112 = Memo.splits (snd x_76) in
          let split0_112 = List.nth splits_112 0 in
          ignore (pop_env w_123);
          push_env w_123 split0_112;
          assert_env_length w_123 3;
          push_env w_123 (Memo.from_constructor tag_SVar);
          assert_env_length w_123 4;
          let ctor_arg_24 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VSymbol; ctor_arg_24 ]);
          assert_env_length w_123 4;
          push_env w_123 (Dynarray.get w_123.state.e 2);
          assert_env_length w_123 5;
          let ctor_arg_25 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_25 ]);
          assert_env_length w_123 5;
          push_env w_123 (Memo.from_constructor tag_VNIL);
          assert_env_length w_123 6;
          let ctor_arg_26 = pop_env w_123 in
          let ctor_arg_27 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_27; ctor_arg_26 ]);
          assert_env_length w_123 5;
          let ctor_arg_28 = pop_env w_123 in
          let ctor_arg_29 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VCons; ctor_arg_29; ctor_arg_28 ]);
          assert_env_length w_123 4;
          drop_n w_123 4 1;
          assert_env_length w_123 3;
          drop_n w_123 3 1;
          assert_env_length w_123 2;
          return_n w_123 2 (pc_to_exp (int_to_pc 0))
      | c_76 when c_76 = tag_ANumber ->
          let splits_113 = Memo.splits (snd x_76) in
          let split0_113 = List.nth splits_113 0 in
          ignore (pop_env w_123);
          push_env w_123 split0_113;
          assert_env_length w_123 3;
          push_env w_123 (Dynarray.get w_123.state.e 2);
          assert_env_length w_123 4;
          let ctor_arg_30 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_30 ]);
          assert_env_length w_123 4;
          drop_n w_123 4 1;
          assert_env_length w_123 3;
          drop_n w_123 3 1;
          assert_env_length w_123 2;
          return_n w_123 2 (pc_to_exp (int_to_pc 0))
      | c_76 when c_76 = tag_ASymbol ->
          let splits_114 = Memo.splits (snd x_76) in
          let split0_114 = List.nth splits_114 0 in
          ignore (pop_env w_123);
          push_env w_123 split0_114;
          assert_env_length w_123 3;
          push_env w_123 (Dynarray.get w_123.state.e 2);
          assert_env_length w_123 4;
          let ctor_arg_31 = pop_env w_123 in
          push_env w_123 (Memo.appends [ Memo.from_constructor tag_VSymbol; ctor_arg_31 ]);
          assert_env_length w_123 4;
          drop_n w_123 4 1;
          assert_env_length w_123 3;
          drop_n w_123 3 1;
          assert_env_length w_123 2;
          return_n w_123 2 (pc_to_exp (int_to_pc 0))
      | c_76 -> failwith ("unreachable:" ^ string_of_int c_76 ^ "(123)"))
    123
  ...
  add_exp
    (fun w_122 ->
      ...
      | c_75 when c_75 = tag_EAtom ->
          ...
          w_122.state.c <- pc_to_exp (int_to_pc 123);
          stepped w_122
      | c_75 when c_75 = tag_ECons ->
          let splits_115 = Memo.splits (snd x_75) in
          let split0_115 = List.nth splits_115 0 in
          let split1_54 = List.nth splits_115 1 in
          ignore (pop_env w_122);
          push_env w_122 split0_115;
          push_env w_122 split1_54;
          assert_env_length w_122 3;
          push_env w_122 (Dynarray.get w_122.state.e 1);
          assert_env_length w_122 4;
          let keep_vals_37 = env_call w_122 [ 2 ] 1 in
          ...
          stepped w_122
      | c_75 -> failwith ("unreachable:" ^ string_of_int c_75 ^ "(124)"))
    124
...
let () =
  add_exp
    (fun w_126 ->
      ...
      w_126.state.c <- pc_to_exp (int_to_pc 129);
      stepped w_126)
    126
  ...
  add_exp
    (fun w_125 ->
      ...
      | c_77 when c_77 = tag_ECons ->
          let splits_116 = Memo.splits (snd x_77) in
          let split0_116 = List.nth splits_116 0 in
          let split1_55 = List.nth splits_116 1 in
          ignore (pop_env w_125);
          push_env w_125 split0_116;
          push_env w_125 split1_55;
          ...
          let keep_vals_38 = env_call w_125 [ 1; 3 ] 2 in
      ...
      | _ ->
          ...
          push_env w_125 (Memo.from_constructor tag_Nil);
          assert_env_length w_125 3;
...
let () =
  add_exp
    (fun w_131 ->
      ...
      let last_81 = Source.E 4 in
      let x_81 = resolve w_131 last_81 in
      match Word.get_value (fst x_81) with
      | c_81 when c_81 = tag_STrue ->
          ignore (pop_env w_131);
          assert_env_length w_131 4;
          let keep_vals_41 = env_call w_131 [] 0 in
          ...
          stepped w_131
      | c_81 when c_81 = tag_SFalse ->
          ignore (pop_env w_131);
          assert_env_length w_131 4;
          let keep_vals_42 = env_call w_131 [] 0 in
      ...
      | c_81 -> failwith ("unreachable:" ^ string_of_int c_81 ^ "(130)"))
    130
...
let () =
  add_exp
    (fun w_130 ->
      ...
      let last_80 = Source.E 3 in
      let x_80 = resolve w_130 last_80 in
      match Word.get_value (fst x_80) with
      | c_80 when c_80 = tag_AVar ->
          let splits_119 = Memo.splits (snd x_80) in
          let split0_119 = List.nth splits_119 0 in
          ignore (pop_env w_130);
          push_env w_130 split0_119;
          assert_env_length w_130 4;
          push_env w_130 (Dynarray.get w_130.state.e 3);
          assert_env_length w_130 5;
          push_env w_130 (Dynarray.get w_130.state.e 1);
          assert_env_length w_130 6;
          let keep_vals_40 = env_call w_130 [] 2 in
          w_130.state.k <- Memo.appends [ Memo.from_constructor tag_cont_41; keep_vals_40; w_130.state.k ];
          w_130.state.c <- pc_to_exp (int_to_pc 112);
          stepped w_130
      | c_80 when c_80 = tag_ANumber ->
          let splits_120 = Memo.splits (snd x_80) in
          let split0_120 = List.nth splits_120 0 in
          ignore (pop_env w_130);
          push_env w_130 split0_120;
          assert_env_length w_130 4;
          push_env w_130 (Dynarray.get w_130.state.e 3);
          assert_env_length w_130 5;
          let ctor_arg_32 = pop_env w_130 in
          push_env w_130 (Memo.appends [ Memo.from_constructor tag_VNumber; ctor_arg_32 ]);
          assert_env_length w_130 5;
          drop_n w_130 5 1;
          assert_env_length w_130 4;
          drop_n w_130 4 1;
          assert_env_length w_130 3;
          return_n w_130 3 (pc_to_exp (int_to_pc 0))
      | c_80 when c_80 = tag_ASymbol ->
          let splits_121 = Memo.splits (snd x_80) in
          let split0_121 = List.nth splits_121 0 in
          ignore (pop_env w_130);
          push_env w_130 split0_121;
          assert_env_length w_130 4;
          push_env w_130 (Dynarray.get w_130.state.e 3);
          w_130.state.c <- pc_to_exp (int_to_pc 130);
          stepped w_130
      | c_80 when c_80 = tag_ANIL ->
          ignore (pop_env w_130);
...
let () =
  add_exp
    (fun w_134 ->
      ...
      let x0_4 = resolve w_134 (Source.E 2) in
      let x1_4 = resolve w_134 (Source.E 3) in
      ignore (pop_env w_134);
      ignore (pop_env w_134);
      push_env w_134 (Memo.from_int (if Word.get_value (fst x0_4) = Word.get_value (fst x1_4) then 1 else 0));
...
let () =
  add_exp
    (fun w_133 ->
      ...
      let x_82 = resolve w_133 last_82 in
      match Word.get_value (fst x_82) with
      | c_82 when c_82 = tag_None ->
          ignore (pop_env w_133);
          assert_env_length w_133 1;
          push_env w_133 (Memo.from_int 0);
          assert_env_length w_133 2;
          drop_n w_133 2 0;
          assert_env_length w_133 2;
          drop_n w_133 2 1;
...
let () =
  add_exp
    (fun w_136 ->
      ...
      let x0_5 = resolve w_136 (Source.E 2) in
      let x1_5 = resolve w_136 (Source.E 3) in
      ignore (pop_env w_136);
      ignore (pop_env w_136);
      push_env w_136 (Memo.from_int (if Word.get_value (fst x0_5) = Word.get_value (fst x1_5) then 1 else 0));
...
let () =
  add_exp
    (fun w_135 ->
      ...
      let x_83 = resolve w_135 last_83 in
      match Word.get_value (fst x_83) with
      | c_83 when c_83 = tag_None ->
          ignore (pop_env w_135);
          assert_env_length w_135 1;
          push_env w_135 (Memo.from_int 0);
          assert_env_length w_135 2;
          drop_n w_135 2 1;
          assert_env_length w_135 1;
          drop_n w_135 1 0;
      ...
      | c_83 when c_83 = tag_Some ->
          let splits_124 = Memo.splits (snd x_83) in
          let split0_124 = List.nth splits_124 0 in
          ignore (pop_env w_135);
          push_env w_135 split0_124;
          assert_env_length w_135 2;
          ...
          stepped w_135
      | c_83 -> failwith ("unreachable:" ^ string_of_int c_83 ^ "(136)"))
    136
...
let () =
  add_exp
    (fun w_137 ->
      ...
      let last_84 = Source.E 0 in
      let x_84 = resolve w_137 last_84 in
      match Word.get_value (fst x_84) with
      | c_84 when c_84 = tag_Some ->
          let splits_125 = Memo.splits (snd x_84) in
          let split0_125 = List.nth splits_125 0 in
          ignore (pop_env w_137);
          push_env w_137 split0_125;
          assert_env_length w_137 1;
          let keep_vals_45 = env_call w_137 [] 0 in
          w_137.state.k <- Memo.appends [ Memo.from_constructor tag_cont_46; keep_vals_45; w_137.state.k ];
          w_137.state.c <- pc_to_exp (int_to_pc 24);
          stepped w_137
      | _ ->
          ignore (pop_env w_137);
          assert_env_length w_137 0;
          let keep_vals_46 = env_call w_137 [] 0 in
          w_137.state.k <- Memo.appends [ Memo.from_constructor tag_cont_47; keep_vals_46; w_137.state.k ];
          w_137.state.c <- pc_to_exp (int_to_pc 25);
          stepped w_137
      | c_84 -> failwith ("unreachable:" ^ string_of_int c_84 ^ "(137)"))
    137
...
let () =
  add_exp
    (fun w_138 ->
      ...
      let cond_0 = resolve w_138 (Source.E 0) in
      ignore (pop_env w_138);
      if Word.get_value (fst cond_0) <> 0 then (
        assert_env_length w_138 0;
        let keep_vals_48 = env_call w_138 [] 0 in
        w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_48; keep_vals_48; w_138.state.k ];
        w_138.state.c <- pc_to_exp (int_to_pc 24);
        stepped w_138)
      else (
        assert_env_length w_138 0;
        let keep_vals_47 = env_call w_138 [] 0 in
        w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_49; keep_vals_47; w_138.state.k ];
...
let () =
  add_exp
    (fun w_140 ->
      ...
      let cond_1 = resolve w_140 (Source.E 3) in
      ...
      if Word.get_value (fst cond_1) <> 0 then (
        ...
        w_140.state.c <- pc_to_exp (int_to_pc 8);
        stepped w_140)
      else (
        assert_env_length w_140 3;
        ...
        w_140.state.c <- pc_to_exp (int_to_pc 112);
        stepped w_140))
    139
...
let () =
  add_exp
    (fun w_139 ->
      ...
      let x0_6 = resolve w_139 (Source.E 3) in
      let x1_6 = resolve w_139 (Source.E 4) in
      ignore (pop_env w_139);
      ignore (pop_env w_139);
      push_env w_139 (Memo.from_int (if Word.get_value (fst x0_6) = Word.get_value (fst x1_6) then 1 else 0));
  ...
  add_exp
    (fun w_141 ->
      ...
      | c_85 when c_85 = tag_Some ->
          ...
          let keep_vals_49 = env_call w_141 [ 2 ] 1 in
          w_141.state.k <- Memo.appends [ Memo.from_constructor tag_cont_50; keep_vals_49; w_141.state.k ];
          w_141.state.c <- pc_to_exp (int_to_pc 117);
          stepped w_141
      | _ ->
          ignore (pop_env w_141);
...
let () =
  add_exp
    (fun w_142 ->
      ...
      let cond_2 = resolve w_142 (Source.E 0) in
      ignore (pop_env w_142);
      if Word.get_value (fst cond_2) <> 0 then (
        assert_env_length w_142 0;
        let keep_vals_51 = env_call w_142 [] 0 in
        w_142.state.k <- Memo.appends [ Memo.from_constructor tag_cont_51; keep_vals_51; w_142.state.k ];
        w_142.state.c <- pc_to_exp (int_to_pc 24);
        stepped w_142)
      else (
        assert_env_length w_142 0;
        let keep_vals_50 = env_call w_142 [] 0 in
        w_142.state.k <- Memo.appends [ Memo.from_constructor tag_cont_52; keep_vals_50; w_142.state.k ];
...
let () =
  add_exp
    (fun w_143 ->
      ...
      let x0_7 = resolve w_143 (Source.E 0) in
      let x1_7 = resolve w_143 (Source.E 1) in
      ignore (pop_env w_143);
      ignore (pop_env w_143);
      push_env w_143 (Memo.from_int (if Word.get_value (fst x0_7) = Word.get_value (fst x1_7) then 1 else 0));
...
let () =
  add_exp
    (fun w_145 ->
      ...
      | c_87 when c_87 = tag_SQuote ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_57 = env_call w_145 [] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_58; keep_vals_57; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SAtom ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_58 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_59; keep_vals_58; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SPair ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_59 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_60; keep_vals_59; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SSymbol ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_60 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_61; keep_vals_60; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SEq ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_61 = env_call w_145 [ 0; 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_62; keep_vals_61; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SCar ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_62 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_63; keep_vals_62; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SCdr ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_63 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_64; keep_vals_63; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SIf ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_64 = env_call w_145 [ 0; 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_65; keep_vals_64; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SCons ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_65 = env_call w_145 [ 0; 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_66; keep_vals_65; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SCond ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_66 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_67; keep_vals_66; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 64);
          stepped w_145
      | c_87 when c_87 = tag_SNull ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_67 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_68; keep_vals_67; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      ...
      | c_87 when c_87 = tag_SVar ->
          ignore (pop_env w_145);
          failwith "eval: symbol var is not intended to be used this way"
      | c_87 when c_87 = tag_SNum ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_68 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_69; keep_vals_68; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SAnd ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_69 = env_call w_145 [ 0; 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_70; keep_vals_69; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | c_87 when c_87 = tag_SError ->
          ignore (pop_env w_145);
          assert_env_length w_145 3;
          push_env w_145 (Dynarray.get w_145.state.e 0);
          assert_env_length w_145 4;
          let keep_vals_70 = env_call w_145 [ 1 ] 1 in
          w_145.state.k <- Memo.appends [ Memo.from_constructor tag_cont_71; keep_vals_70; w_145.state.k ];
          w_145.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_145
      | _ ->
          ignore (pop_env w_145);
          failwith "invalid symbol here1"
      | c_87 -> failwith ("unreachable:" ^ string_of_int c_87 ^ "(144)"))
    144
  ...
  add_exp
    (fun w_144 ->
      ...
      | c_86 when c_86 = tag_Some ->
          let splits_127 = Memo.splits (snd x_86) in
          let split0_127 = List.nth splits_127 0 in
          ignore (pop_env w_144);
          push_env w_144 split0_127;
          assert_env_length w_144 3;
      ...
      | c_86 when c_86 = tag_None ->
          ...
          assert_env_length w_144 3;
          let keep_vals_71 = env_call w_144 [ 0; 1 ] 1 in
          w_144.state.k <- Memo.appends [ Memo.from_constructor tag_cont_72; keep_vals_71; w_144.state.k ];
          w_144.state.c <- pc_to_exp (int_to_pc 62);
          stepped w_144
      | c_86 -> failwith ("unreachable:" ^ string_of_int c_86 ^ "(145)"))
    145
  ...
  add_exp
    (fun w_146 ->
      ...
      if Word.get_value (fst cond_3) <> 0 then (
        ...
        w_146.state.c <- pc_to_exp (int_to_pc 126);
        stepped w_146)
      else (
        assert_env_length w_146 3;
        push_env w_146 (Dynarray.get w_146.state.e 1);
        assert_env_length w_146 4;
        let keep_vals_72 = env_call w_146 [ 0 ] 1 in
        w_146.state.k <- Memo.appends [ Memo.from_constructor tag_cont_73; keep_vals_72; w_146.state.k ];
        w_146.state.c <- pc_to_exp (int_to_pc 40);
        stepped w_146))
    146
  ...
  add_exp
    (fun w_147 ->
      ...
      | _ ->
          ...
          push_env w_147 (Dynarray.get w_147.state.e 0);
          assert_env_length w_147 3;
          let keep_vals_87 = env_call w_147 [ 0; 1 ] 1 in
          w_147.state.k <- Memo.appends [ Memo.from_constructor tag_cont_88; keep_vals_87; w_147.state.k ];
          w_147.state.c <- pc_to_exp (int_to_pc 62);
          stepped w_147
      | c_88 -> failwith ("unreachable:" ^ string_of_int c_88 ^ "(147)"))
    147
...
let () =
  add_exp
    (fun w_148 ->
      ...
      let cond_4 = resolve w_148 (Source.E 2) in
      ignore (pop_env w_148);
      if Word.get_value (fst cond_4) <> 0 then (
        assert_env_length w_148 2;
        let keep_vals_101 = env_call w_148 [] 0 in
        w_148.state.k <- Memo.appends [ Memo.from_constructor tag_cont_101; keep_vals_101; w_148.state.k ];
        w_148.state.c <- pc_to_exp (int_to_pc 25);
        stepped w_148)
      else (
        assert_env_length w_148 2;
        push_env w_148 (Dynarray.get w_148.state.e 0);
        assert_env_length w_148 3;
        let keep_vals_100 = env_call w_148 [ 1 ] 1 in
        w_148.state.k <- Memo.appends [ Memo.from_constructor tag_cont_102; keep_vals_100; w_148.state.k ];
        w_148.state.c <- pc_to_exp (int_to_pc 31);
        stepped w_148))
    148
  ...
  add_exp
    (fun w_149 ->
      ...
      | c_89 when c_89 = tag_Some ->
          let splits_129 = Memo.splits (snd x_89) in
          let split0_129 = List.nth splits_129 0 in
          ignore (pop_env w_149);
          push_env w_149 split0_129;
          assert_env_length w_149 1;
...
let () =
  add_exp
    (fun w_152 ->
      ...
      let last_91 = Source.E 3 in
      let x_91 = resolve w_152 last_91 in
      match Word.get_value (fst x_91) with
      | c_91 when c_91 = tag_SLambda ->
          ignore (pop_env w_152);
          assert_env_length w_152 3;
          push_env w_152 (Dynarray.get w_152.state.e 0);
          assert_env_length w_152 4;
          let keep_vals_102 = env_call w_152 [ 0; 1 ] 1 in
          w_152.state.k <- Memo.appends [ Memo.from_constructor tag_cont_103; keep_vals_102; w_152.state.k ];
          w_152.state.c <- pc_to_exp (int_to_pc 53);
          stepped w_152
      | c_91 when c_91 = tag_SDefine ->
          ignore (pop_env w_152);
          assert_env_length w_152 3;
          push_env w_152 (Memo.from_constructor tag_SLambda);
          assert_env_length w_152 4;
          let ctor_arg_41 = pop_env w_152 in
          push_env w_152 (Memo.appends [ Memo.from_constructor tag_ASymbol; ctor_arg_41 ]);
          assert_env_length w_152 4;
          let ctor_arg_42 = pop_env w_152 in
          push_env w_152 (Memo.appends [ Memo.from_constructor tag_EAtom; ctor_arg_42 ]);
          assert_env_length w_152 4;
          push_env w_152 (Dynarray.get w_152.state.e 0);
          assert_env_length w_152 5;
          let keep_vals_103 = env_call w_152 [ 0; 1; 3 ] 1 in
          w_152.state.k <- Memo.appends [ Memo.from_constructor tag_cont_104; keep_vals_103; w_152.state.k ];
          w_152.state.c <- pc_to_exp (int_to_pc 49);
          stepped w_152
      | c_91 when c_91 = tag_SDefvar ->
          ignore (pop_env w_152);
          assert_env_length w_152 3;
          push_env w_152 (Dynarray.get w_152.state.e 0);
          assert_env_length w_152 4;
          let keep_vals_104 = env_call w_152 [ 0; 1 ] 1 in
          w_152.state.k <- Memo.appends [ Memo.from_constructor tag_cont_105; keep_vals_104; w_152.state.k ];
          w_152.state.c <- pc_to_exp (int_to_pc 57);
          stepped w_152
      | c_91 when c_91 = tag_SQuote ->
          ignore (pop_env w_152);
          failwith "unexpected function quote"
      | c_91 when c_91 = tag_SEq ->
          ignore (pop_env w_152);
          failwith "unexpected function eq"
      | c_91 when c_91 = tag_SCons ->
          ignore (pop_env w_152);
          failwith "unexpected function cons"
      | c_91 when c_91 = tag_SIf ->
          ignore (pop_env w_152);
          failwith "unexpected function if"
      | c_91 when c_91 = tag_SCond ->
          ignore (pop_env w_152);
          failwith "unexpected function cond"
      | c_91 when c_91 = tag_SAtom ->
          ignore (pop_env w_152);
          failwith "unexpected function atom"
      | c_91 when c_91 = tag_SPair ->
          ignore (pop_env w_152);
          failwith "unexpected function pair"
      | c_91 when c_91 = tag_SSymbol ->
          ignore (pop_env w_152);
          failwith "unexpected function symbol"
      | c_91 when c_91 = tag_STrue ->
          ignore (pop_env w_152);
          failwith "unexpected function true"
      | c_91 when c_91 = tag_SFalse ->
          ignore (pop_env w_152);
          failwith "unexpected function false"
      | c_91 when c_91 = tag_SCar ->
          ignore (pop_env w_152);
          failwith "unexpected function car"
      | c_91 when c_91 = tag_SCdr ->
          ignore (pop_env w_152);
          failwith "unexpected function cdr"
      | c_91 when c_91 = tag_SNull ->
          ignore (pop_env w_152);
          failwith "unexpected function null"
      | c_91 when c_91 = tag_SError ->
          ignore (pop_env w_152);
          failwith "unexpected function error"
      | c_91 when c_91 = tag_SNum ->
          ignore (pop_env w_152);
          failwith "unexpected function num"
      | c_91 when c_91 = tag_SAnd ->
          ignore (pop_env w_152);
          failwith "unexpected function and"
      | c_91 when c_91 = tag_SVar ->
          ignore (pop_env w_152);
          failwith "eval: symbol var is not intended to be used this way"
      | _ ->
          ignore (pop_env w_152);
  ...
  add_exp
    (fun w_151 ->
      ...
      | c_90 when c_90 = tag_None ->
          ...
          w_151.state.c <- pc_to_exp (int_to_pc 43);
          stepped w_151
      | c_90 -> failwith ("unreachable:" ^ string_of_int c_90 ^ "(152)"))
    152
...
let () =
  add_exp
    (fun w_153 ->
      ...
      let x_92 = resolve w_153 last_92 in
      match Word.get_value (fst x_92) with
      | c_92 when c_92 = tag_Some ->
          let splits_131 = Memo.splits (snd x_92) in
          ...
          let keep_vals_106 = env_call w_153 [ 0; 1 ] 2 in
          w_153.state.k <- Memo.appends [ Memo.from_constructor tag_cont_107; keep_vals_106; w_153.state.k ];
          w_153.state.c <- pc_to_exp (int_to_pc 112);
          stepped w_153
      | c_92 when c_92 = tag_None ->
          ignore (pop_env w_153);
          assert_env_length w_153 2;
          push_env w_153 (Dynarray.get w_153.state.e 0);
          assert_env_length w_153 3;
          let keep_vals_107 = env_call w_153 [] 1 in
          w_153.state.k <- Memo.appends [ Memo.from_constructor tag_cont_108; keep_vals_107; w_153.state.k ];
          w_153.state.c <- pc_to_exp (int_to_pc 62);
          stepped w_153
...
let () =
  add_exp
    (fun w_154 ->
      ...
      | c_93 -> failwith ("unreachable:" ^ string_of_int c_93 ^ "(155)"))
    155
...
let () =
  add_exp
    (fun w_156 ->
      ...
      let x_95 = resolve w_156 last_95 in
      match Word.get_value (fst x_95) with
      | c_95 when c_95 = tag_VNumber ->
          let splits_137 = Memo.splits (snd x_95) in
          let split0_137 = List.nth splits_137 0 in
          ignore (pop_env w_156);
          push_env w_156 split0_137;
          failwith "NUMBER is not PROCEDURE"
      | c_95 when c_95 = tag_VSymbol ->
          let splits_138 = Memo.splits (snd x_95) in
          let split0_138 = List.nth splits_138 0 in
          ignore (pop_env w_156);
          push_env w_156 split0_138;
          failwith "SYMBOL is not PROCEDURE"
      | c_95 when c_95 = tag_VQuote ->
          let splits_139 = Memo.splits (snd x_95) in
          let split0_139 = List.nth splits_139 0 in
          ignore (pop_env w_156);
          push_env w_156 split0_139;
          failwith "QUOTE is not PROCEDURE"
      | c_95 when c_95 = tag_VNIL ->
          ignore (pop_env w_156);
          failwith "NIL is not PROCEDURE"
      | c_95 when c_95 = tag_VCons ->
          let splits_140 = Memo.splits (snd x_95) in
          let split0_140 = List.nth splits_140 0 in
          let split1_60 = List.nth splits_140 1 in
          ignore (pop_env w_156);
          push_env w_156 split0_140;
          push_env w_156 split1_60;
          failwith "PAIR is not PROCEDURE"
      | c_95 when c_95 = tag_VClosure ->
          let splits_141 = Memo.splits (snd x_95) in
          let split0_141 = List.nth splits_141 0 in
          let split1_61 = List.nth splits_141 1 in
          ignore (pop_env w_156);
          push_env w_156 split0_141;
          push_env w_156 split1_61;
          ...
          let keep_vals_114 = env_call w_156 [ 1; 4 ] 1 in
          w_156.state.k <- Memo.appends [ Memo.from_constructor tag_cont_115; keep_vals_114; w_156.state.k ];
          w_156.state.c <- pc_to_exp (int_to_pc 64);
          stepped w_156
...
let () =
  add_exp
    (fun w_158 ->
      ...
      let last_97 = Source.E 1 in
      let x_97 = resolve w_158 last_97 in
      match Word.get_value (fst x_97) with
      | c_97 when c_97 = tag_ANumber ->
          let splits_143 = Memo.splits (snd x_97) in
          let split0_143 = List.nth splits_143 0 in
          ignore (pop_env w_158);
          push_env w_158 split0_143;
          failwith "NUMBER is not PROCEDURE"
      ...
      | _ ->
          ignore (pop_env w_158);
          failwith "impossible"
      | c_97 -> failwith ("unreachable:" ^ string_of_int c_97 ^ "(157)"))
    157
  ...
  add_exp
    (fun w_157 ->
      ...
      | _ ->
          ignore (pop_env w_157);
          failwith "impossible"
      | c_96 -> failwith ("unreachable:" ^ string_of_int c_96 ^ "(158)"))
    158
...
let () =
  add_exp
    (fun w_159 ->
      ...
      let cond_5 = resolve w_159 (Source.E 3) in
      ...
      if Word.get_value (fst cond_5) <> 0 then (
        ...
        w_159.state.c <- pc_to_exp (int_to_pc 127);
        stepped w_159)
      else (
        assert_env_length w_159 3;
...
let () =
  add_exp
    (fun w_160 ->
      ...
      let cond_6 = resolve w_160 (Source.E 0) in
      ignore (pop_env w_160);
      if Word.get_value (fst cond_6) <> 0 then (
        assert_env_length w_160 0;
        let keep_vals_120 = env_call w_160 [] 0 in
        w_160.state.k <- Memo.appends [ Memo.from_constructor tag_cont_120; keep_vals_120; w_160.state.k ];
        w_160.state.c <- pc_to_exp (int_to_pc 25);
        stepped w_160)
      else (
        assert_env_length w_160 0;
        let keep_vals_119 = env_call w_160 [] 0 in
        w_160.state.k <- Memo.appends [ Memo.from_constructor tag_cont_121; keep_vals_119; w_160.state.k ];
...
let () =
  add_exp
    (fun w_161 ->
      ...
      let x_98 = resolve w_161 last_98 in
      ...
      | c_98 when c_98 = tag_Some ->
          let splits_144 = Memo.splits (snd x_98) in
          let split0_144 = List.nth splits_144 0 in
          ignore (pop_env w_161);
          push_env w_161 split0_144;
          assert_env_length w_161 4;
          ...
          let ctor_arg_47 = pop_env w_161 in
          let ctor_arg_48 = pop_env w_161 in
          push_env w_161 (Memo.appends [ Memo.from_constructor tag_VClosure; ctor_arg_48; ctor_arg_47 ]);
          assert_env_length w_161 5;
          push_env w_161 (Dynarray.get w_161.state.e 3);
          assert_env_length w_161 6;
          push_env w_161 (Dynarray.get w_161.state.e 4);
          assert_env_length w_161 7;
          let ctor_arg_49 = pop_env w_161 in
          let ctor_arg_50 = pop_env w_161 in
          push_env w_161 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_50; ctor_arg_49 ]);
          assert_env_length w_161 6;
          push_env w_161 (Dynarray.get w_161.state.e 1);
          assert_env_length w_161 7;
          let ctor_arg_51 = pop_env w_161 in
          let ctor_arg_52 = pop_env w_161 in
          push_env w_161 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_52; ctor_arg_51 ]);
          assert_env_length w_161 6;
          push_env w_161 (Dynarray.get w_161.state.e 0);
          assert_env_length w_161 7;
          let keep_vals_122 = env_call w_161 [ 5 ] 1 in
          w_161.state.k <- Memo.appends [ Memo.from_constructor tag_cont_123; keep_vals_122; w_161.state.k ];
          w_161.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_161
      | c_98 -> failwith ("unreachable:" ^ string_of_int c_98 ^ "(161)"))
    161
...
let () =
  add_exp
    (fun w_162 ->
      ...
      let last_99 = Source.E 3 in
      let x_99 = resolve w_162 last_99 in
      ...
      | c_99 when c_99 = tag_Some ->
          let splits_145 = Memo.splits (snd x_99) in
          let split0_145 = List.nth splits_145 0 in
          ignore (pop_env w_162);
          push_env w_162 split0_145;
          assert_env_length w_162 4;
          push_env w_162 (Dynarray.get w_162.state.e 3);
          ...
          assert_env_length w_162 6;
          let ctor_arg_53 = pop_env w_162 in
          let ctor_arg_54 = pop_env w_162 in
          push_env w_162 (Memo.appends [ Memo.from_constructor tag_EnvEntry; ctor_arg_54; ctor_arg_53 ]);
          assert_env_length w_162 5;
          push_env w_162 (Dynarray.get w_162.state.e 1);
          assert_env_length w_162 6;
          let ctor_arg_55 = pop_env w_162 in
          let ctor_arg_56 = pop_env w_162 in
          push_env w_162 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_56; ctor_arg_55 ]);
          assert_env_length w_162 5;
          push_env w_162 (Dynarray.get w_162.state.e 0);
          assert_env_length w_162 6;
          let keep_vals_125 = env_call w_162 [ 4 ] 1 in
          w_162.state.k <- Memo.appends [ Memo.from_constructor tag_cont_126; keep_vals_125; w_162.state.k ];
          w_162.state.c <- pc_to_exp (int_to_pc 40);
          stepped w_162
      | c_99 -> failwith ("unreachable:" ^ string_of_int c_99 ^ "(162)"))
    162
...
let () = Words.set_constructor_degree 87 (-1)
...
let () = Words.set_constructor_degree 100 (-1)
...
let () = Words.set_constructor_degree 105 (-1)
...
let () = Words.set_constructor_degree 110 (-1)
...
let () = Words.set_constructor_degree 116 0
let () = Words.set_constructor_degree 117 0
...
let () = Words.set_constructor_degree 123 0
let () = Words.set_constructor_degree 124 (-2)
let () = Words.set_constructor_degree 125 (-2)
let () = Words.set_constructor_degree 126 (-2)
let () = Words.set_constructor_degree 127 0
let () = Words.set_constructor_degree 128 0
let () = Words.set_constructor_degree 129 (-3)
let () = Words.set_constructor_degree 130 (-2)
let () = Words.set_constructor_degree 131 (-2)
let () = Words.set_constructor_degree 132 0
let () = Words.set_constructor_degree 133 (-2)
let () = Words.set_constructor_degree 134 (-2)
let () = Words.set_constructor_degree 135 (-1)
let () = Words.set_constructor_degree 136 (-3)
let () = Words.set_constructor_degree 137 (-1)
let () = Words.set_constructor_degree 138 0
let () = Words.set_constructor_degree 139 (-1)
let () = Words.set_constructor_degree 140 (-2)
let () = Words.set_constructor_degree 141 (-3)
let () = Words.set_constructor_degree 142 (-2)
let () = Words.set_constructor_degree 143 0
let () = Words.set_constructor_degree 144 (-2)
...
let () = Words.set_constructor_degree 150 (-3)
let () = Words.set_constructor_degree 151 (-2)
let () = Words.set_constructor_degree 152 (-2)
let () = Words.set_constructor_degree 153 0
let () = Words.set_constructor_degree 154 (-3)
let () = Words.set_constructor_degree 155 (-3)
let () = Words.set_constructor_degree 156 (-3)
let () = Words.set_constructor_degree 157 0
let () = Words.set_constructor_degree 158 0
let () = Words.set_constructor_degree 159 (-3)
let () = Words.set_constructor_degree 160 (-1)
let () = Words.set_constructor_degree 161 (-3)
let () = Words.set_constructor_degree 162 (-3)
let () = Words.set_constructor_degree 163 (-1)
let () = Words.set_constructor_degree 164 (-1)
