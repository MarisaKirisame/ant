...
let populate_state () =
  ...
  add_exp
    (fun w_13 ->
      ...
      let hd_0, tl_0 = resolve w_13 K in
      match Word.get_value hd_0 with
      | 0 (* tag_cont_done *) -> exec_done w_13
      | 4 (* tag_cont_1 *) ->
          w_13.state.k <- get_next_cont tl_0;
          restore_env w_13 1 tl_0;
      ...
      | 6 (* tag_cont_3 *) ->
          ...
          let ctor_arg_13 = pop_env w_13 in
          push_env w_13 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_13; ctor_arg_12 ]);
          assert_env_length w_13 1;
          drop_n w_13 1 0;
          assert_env_length w_13 1;
          drop_n w_13 1 0;
      ...
      | 8 (* tag_cont_5 *) ->
          ...
          let keep_5 = env_call w_13 [ 1 ] 1 in
      ...
      | 9 (* tag_cont_6 *) ->
          ...
          w_13.state.c <- pc_to_exp (int_to_pc 6)
      | _ -> failwith "unreachable (0)")
    0;
  add_exp
    (fun w_0 ->
      assert_env_length w_0 2;
      push_env w_0 (Dynarray.get w_0.state.e 1);
      w_0.state.c <- pc_to_exp (int_to_pc 4))
    1;
  add_exp
    (fun w_3 ->
      assert_env_length w_3 7;
      let last_2 = Source.E 6 in
      let x_2 = resolve w_3 last_2 in
      ...
      | 1 (* tag_Nil *) ->
          ...
          assert_env_length w_3 7;
          push_env w_3 (Memo.from_constructor tag_Nil);
          assert_env_length w_3 8;
          let ctor_arg_4 = pop_env w_3 in
          let ctor_arg_5 = pop_env w_3 in
          push_env w_3 (Memo.appends [ Memo.from_constructor tag_P; ctor_arg_5; ctor_arg_4 ]);
          assert_env_length w_3 7;
          drop_n w_3 7 2;
      ...
      | 2 (* tag_Cons *) ->
          ...
          assert_env_length w_3 8;
          push_env w_3 (Dynarray.get w_3.state.e 7);
          assert_env_length w_3 9;
          push_env w_3 (Dynarray.get w_3.state.e 5);
          assert_env_length w_3 10;
          let keep_0 = env_call w_3 [ 6 ] 2 in
          w_3.state.k <- Memo.appends [ Memo.from_constructor tag_cont_1; keep_0; w_3.state.k ];
  ...
  add_exp
    (fun w_2 ->
      ...
      | 1 (* tag_Nil *) ->
          ...
          push_env w_2 (Memo.from_constructor tag_Nil);
          assert_env_length w_2 5;
          push_env w_2 (Dynarray.get w_2.state.e 0);
          assert_env_length w_2 6;
          let ctor_arg_2 = pop_env w_2 in
          let ctor_arg_3 = pop_env w_2 in
          push_env w_2 (Memo.appends [ Memo.from_constructor tag_P; ctor_arg_3; ctor_arg_2 ]);
          assert_env_length w_2 5;
          drop_n w_2 5 2;
  ...
  add_exp
    (fun w_1 ->
      ...
      | 1 (* tag_Nil *) ->
          ...
          push_env w_1 (Memo.appends [ Memo.from_constructor tag_P; ctor_arg_1; ctor_arg_0 ]);
          assert_env_length w_1 3;
  ...
  add_exp
    (fun w_9 ->
      ...
      let cond_0 = resolve w_9 (Source.E 6) in
      ignore (pop_env w_9);
      if Word.get_value (fst cond_0) <> 0 then (
        ...
        assert_env_length w_9 8;
        push_env w_9 (Dynarray.get w_9.state.e 5);
        assert_env_length w_9 9;
        let keep_1 = env_call w_9 [ 6 ] 2 in
  ...
  add_exp
    (fun w_8 ->
      ...
      let x0_0 = resolve w_8 (Source.E 6) in
      let x1_0 = resolve w_8 (Source.E 7) in
      ignore (pop_env w_8);
      ignore (pop_env w_8);
  ...
  add_exp
    (fun w_12 ->
      ...
      let x_6 = resolve w_12 last_6 in
      ...
      | 2 (* tag_Cons *) ->
          ...
          ignore (pop_env w_12);
          push_env w_12 split0_6;
          push_env w_12 split1_6;
          assert_env_length w_12 5;
          push_env w_12 (Dynarray.get w_12.state.e 0);
          assert_env_length w_12 6;
          let keep_3 = env_call w_12 [] 1 in
          w_12.state.k <- Memo.appends [ Memo.from_constructor tag_cont_4; keep_3; w_12.state.k ];
          w_12.state.c <- pc_to_exp (int_to_pc 5)
  ...
  add_exp
    (fun w_14 ->
      ...
      | 3 (* tag_P *) ->
          ...
          let ctor_arg_6 = pop_env w_14 in
          let ctor_arg_7 = pop_env w_14 in
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_7; ctor_arg_6 ]);
          assert_env_length w_14 4;
          push_env w_14 (Dynarray.get w_14.state.e 2);
          assert_env_length w_14 5;
          let ctor_arg_8 = pop_env w_14 in
          let ctor_arg_9 = pop_env w_14 in
          push_env w_14 (Memo.appends [ Memo.from_constructor tag_P; ctor_arg_9; ctor_arg_8 ]);
          assert_env_length w_14 4;
          drop_n w_14 4 2;
          assert_env_length w_14 2;
          drop_n w_14 2 1;
  ...
  add_exp
    (fun w_15 ->
      ...
      | 3 (* tag_P *) ->
          ...
          ignore (pop_env w_15);
          push_env w_15 split0_8;
          push_env w_15 split1_8;
          assert_env_length w_15 2;
          push_env w_15 (Dynarray.get w_15.state.e 0);
          assert_env_length w_15 3;
          let keep_4 = env_call w_15 [ 1 ] 1 in
          w_15.state.k <- Memo.appends [ Memo.from_constructor tag_cont_5; keep_4; w_15.state.k ];
