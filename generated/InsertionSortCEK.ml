...
let populate_state () =
  ...
  add_exp
    (fun w_6 ->
      ...
      let hd_0, tl_0 = resolve w_6 K in
      match Word.get_value hd_0 with
      | 0 (* tag_cont_done *) -> exec_done w_6
      | 3 (* tag_cont_1 *) ->
          w_6.state.k <- get_next_cont tl_0;
          restore_env w_6 1 tl_0;
          assert_env_length w_6 2;
          let ctor_arg_4 = pop_env w_6 in
          let ctor_arg_5 = pop_env w_6 in
          push_env w_6 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_5; ctor_arg_4 ]);
          assert_env_length w_6 1;
          drop_n w_6 1 0;
          assert_env_length w_6 1;
          return_n w_6 1 (pc_to_exp (int_to_pc 0))
      | 4 (* tag_cont_2 *) ->
          w_6.state.k <- get_next_cont tl_0;
          restore_env w_6 1 tl_0;
          assert_env_length w_6 2;
          ignore (env_call w_6 [] 2);
  ...
  add_exp
    (fun w_3 ->
      ...
      let cond_0 = resolve w_3 (Source.E 4) in
      ignore (pop_env w_3);
      if Word.get_value (fst cond_0) <> 0 then (
        ...
        let ctor_arg_2 = pop_env w_3 in
        let ctor_arg_3 = pop_env w_3 in
        push_env w_3 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_3; ctor_arg_2 ]);
        assert_env_length w_3 5;
        drop_n w_3 5 2;
        ...
        push_env w_3 (Dynarray.get w_3.state.e 0);
        assert_env_length w_3 6;
        push_env w_3 (Dynarray.get w_3.state.e 3);
        assert_env_length w_3 7;
        let keep_0 = env_call w_3 [ 4 ] 2 in
  ...
  add_exp
    (fun w_2 ->
      ...
      ignore (pop_env w_2);
      ignore (pop_env w_2);
      push_env w_2 (Memo.from_int (if Word.get_value (fst x0_0) <= Word.get_value (fst x1_0) then 1 else 0));
  ...
  add_exp
    (fun w_5 ->
      ...
      let x_1 = resolve w_5 last_1 in
      match Word.get_value (fst x_1) with
      | 1 (* tag_Nil *) ->
          ignore (pop_env w_5);
          assert_env_length w_5 1;
          push_env w_5 (Memo.from_constructor tag_Nil);
          assert_env_length w_5 2;
      ...
      | 2 (* tag_Cons *) ->
          ...
          ignore (pop_env w_5);
          push_env w_5 split0_1;
          push_env w_5 split1_1;
