...
let tag_cont_98 = 110
let tag_cont_99 = 111
let tag_cont_100 = 112
let tag_cont_101 = 113
let tag_cont_102 = 114
let tag_cont_103 = 115
let tag_cont_104 = 116
let tag_cont_105 = 117
let tag_cont_106 = 118
let tag_cont_107 = 119
let tag_cont_108 = 120
let tag_cont_109 = 121
let tag_cont_110 = 122
let tag_cont_111 = 123
let tag_cont_112 = 124
let tag_cont_113 = 125
let tag_cont_114 = 126
let tag_cont_115 = 127
let tag_cont_116 = 128
...
let rec diffx memo (x0 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 88)) (Dynarray.of_list [ x0 ]) (Memo.from_constructor tag_cont_done) memo

let rec eval memo (x0 : Value.seq) (x1 : Value.seq) (x2 : Value.seq) : exec_result =
  exec_cek (pc_to_exp (int_to_pc 91)) (Dynarray.of_list [ x0; x1; x2 ]) (Memo.from_constructor tag_cont_done) memo
...
let populate_state () =
  ...
  add_exp
    (fun w_94 ->
      ...
      let hd_0, tl_0 = resolve w_94 K in
      match Word.get_value hd_0 with
      | 0 (* tag_cont_done *) -> exec_done w_94
      | 13 (* tag_cont_1 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let keep_37 = env_call w_94 [ 0; 1; 2 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_40; keep_37; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 3)
      | 14 (* tag_cont_2 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_38 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_41; keep_38; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 1)
      | 15 (* tag_cont_3 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          let keep_39 = env_call w_94 [ 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_42; keep_39; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 16 (* tag_cont_4 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_40 = env_call w_94 [ 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_43; keep_40; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 17 (* tag_cont_5 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 95)
      | 18 (* tag_cont_6 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
      ...
      | 19 (* tag_cont_7 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let keep_43 = env_call w_94 [ 0; 1; 2 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_46; keep_43; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 13)
      | 20 (* tag_cont_8 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 98)
      | 21 (* tag_cont_9 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          assert_env_length w_94 5;
          push_env w_94 (Dynarray.get w_94.state.e 4);
          w_94.state.c <- pc_to_exp (int_to_pc 99)
      | 22 (* tag_cont_10 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_32 = pop_env w_94 in
          let ctor_arg_33 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_33; ctor_arg_32 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
      ...
      | 23 (* tag_cont_11 *) ->
          ...
          w_94.state.c <- pc_to_exp (int_to_pc 101)
      | 24 (* tag_cont_12 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          ignore (env_call w_94 [] 2);
          w_94.state.c <- pc_to_exp (int_to_pc 34)
      | 25 (* tag_cont_13 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_47 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_50; keep_47; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 41)
      | 26 (* tag_cont_14 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_48 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_51; keep_48; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 45)
      | 27 (* tag_cont_15 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_49 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_52; keep_49; w_94.state.k ];
      ...
      | 28 (* tag_cont_16 *) ->
          ...
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          w_94.state.c <- pc_to_exp (int_to_pc 104)
      | 29 (* tag_cont_17 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_36 = pop_env w_94 in
          let ctor_arg_37 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_37; ctor_arg_36 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 30 (* tag_cont_18 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_52 = env_call w_94 [ 0 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_55; keep_52; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 53)
      | 31 (* tag_cont_19 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_53 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_56; keep_53; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 45)
      | 32 (* tag_cont_20 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Memo.from_constructor tag_ENil);
          assert_env_length w_94 2;
          let ctor_arg_38 = pop_env w_94 in
          let ctor_arg_39 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_39; ctor_arg_38 ]);
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 33 (* tag_cont_21 *) ->
          w_94.state.k <- get_next_cont tl_0;
          ...
          let keep_54 = env_call w_94 [ 0; 1; 3; 4 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_57; keep_54; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 23)
      | 34 (* tag_cont_22 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 4;
          let keep_55 = env_call w_94 [ 1; 2 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_58; keep_55; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 23)
      | 35 (* tag_cont_23 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 2);
          assert_env_length w_94 8;
          let ctor_arg_40 = pop_env w_94 in
          let ctor_arg_41 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_41; ctor_arg_40 ]);
          assert_env_length w_94 7;
          let keep_56 = env_call w_94 [ 0; 1; 3; 4 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_59; keep_56; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 36 (* tag_cont_24 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          assert_env_length w_94 4;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 7;
          let ctor_arg_42 = pop_env w_94 in
          let ctor_arg_43 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_43; ctor_arg_42 ]);
          assert_env_length w_94 6;
          let keep_57 = env_call w_94 [ 0; 1; 2; 3 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_60; keep_57; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 37 (* tag_cont_25 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 105)
      | 38 (* tag_cont_26 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_44 = pop_env w_94 in
          let ctor_arg_45 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_45; ctor_arg_44 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 39 (* tag_cont_27 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_60 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_63; keep_60; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 72)
      | 40 (* tag_cont_28 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_61 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_64; keep_61; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 36)
      | 41 (* tag_cont_29 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_62 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_65; keep_62; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 41)
      | 42 (* tag_cont_30 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          w_94.state.c <- pc_to_exp (int_to_pc 106)
      | 43 (* tag_cont_31 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          assert_env_length w_94 4;
          push_env w_94 (Memo.from_int 1);
          w_94.state.c <- pc_to_exp (int_to_pc 107)
      | 44 (* tag_cont_32 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_65 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_68; keep_65; w_94.state.k ];
      ...
      | 45 (* tag_cont_33 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_66 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_69; keep_66; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 85)
      | 46 (* tag_cont_34 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Memo.from_int 6);
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let keep_67 = env_call w_94 [ 0 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_70; keep_67; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 79)
      | 47 (* tag_cont_35 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_68 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_71; keep_68; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 88)
      | 48 (* tag_cont_36 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let ctor_arg_46 = pop_env w_94 in
          let ctor_arg_47 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_47; ctor_arg_46 ]);
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 4;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_69 = env_call w_94 [ 2; 3 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_72; keep_69; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 88)
      | 49 (* tag_cont_37 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 7;
          let keep_70 = env_call w_94 [ 3 ] 3 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_73; keep_70; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 91)
      | 50 (* tag_cont_38 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          assert_env_length w_94 4;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 7;
          let keep_71 = env_call w_94 [ 3 ] 3 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_74; keep_71; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 91)
      | 51 (* tag_cont_39 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_72 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_75; keep_72; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 88)
      | 52 (* tag_cont_40 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          ...
          assert_env_length w_94 5;
          push_env w_94 (Dynarray.get w_94.state.e 3);
          w_94.state.c <- pc_to_exp (int_to_pc 122)
      | 53 (* tag_cont_41 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 123)
      | 54 (* tag_cont_42 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 124)
      | 55 (* tag_cont_43 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 125)
      | 56 (* tag_cont_44 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 126)
      | 57 (* tag_cont_45 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 127)
      | 58 (* tag_cont_46 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          assert_env_length w_94 4;
          ...
          assert_env_length w_94 5;
          push_env w_94 (Dynarray.get w_94.state.e 3);
          w_94.state.c <- pc_to_exp (int_to_pc 131)
      | 59 (* tag_cont_47 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          assert_env_length w_94 4;
          push_env w_94 (Dynarray.get w_94.state.e 3);
          w_94.state.c <- pc_to_exp (int_to_pc 132)
      | 60 (* tag_cont_48 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          assert_env_length w_94 5;
          push_env w_94 (Dynarray.get w_94.state.e 4);
          w_94.state.c <- pc_to_exp (int_to_pc 133)
      | 61 (* tag_cont_49 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_57 = pop_env w_94 in
          let ctor_arg_58 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_58; ctor_arg_57 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 62 (* tag_cont_50 *) ->
          ...
          assert_env_length w_94 2;
          ignore (env_call w_94 [] 2);
          w_94.state.c <- pc_to_exp (int_to_pc 32)
      | 63 (* tag_cont_51 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
      ...
      | 64 (* tag_cont_52 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 134)
      | 65 (* tag_cont_53 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
      ...
      | 67 (* tag_cont_55 *) ->
          ...
          assert_env_length w_94 3;
          push_env w_94 (Memo.from_int 0);
          w_94.state.c <- pc_to_exp (int_to_pc 136)
      | 68 (* tag_cont_56 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let keep_79 = env_call w_94 [] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_18; keep_79; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 32)
      | 69 (* tag_cont_57 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 3);
          assert_env_length w_94 7;
          let keep_80 = env_call w_94 [ 0; 1; 2; 3; 4 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_82; keep_80; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 70 (* tag_cont_58 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 6;
          ignore (env_call w_94 [] 3);
          w_94.state.c <- pc_to_exp (int_to_pc 61)
      | 71 (* tag_cont_59 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 137)
      | 72 (* tag_cont_60 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 4 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 138)
      | 73 (* tag_cont_61 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_62 = pop_env w_94 in
          let ctor_arg_63 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_63; ctor_arg_62 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      ...
      | 75 (* tag_cont_63 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_84 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_86; keep_84; w_94.state.k ];
      ...
      | 76 (* tag_cont_64 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_85 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_87; keep_85; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 65)
      | 77 (* tag_cont_65 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let keep_86 = env_call w_94 [] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_28; keep_86; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 32)
      | 78 (* tag_cont_66 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 2);
          assert_env_length w_94 5;
          let keep_87 = env_call w_94 [ 0; 1; 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_88; keep_87; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 78)
      | 79 (* tag_cont_67 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 2);
          assert_env_length w_94 5;
          let keep_88 = env_call w_94 [ 0; 1; 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_89; keep_88; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 60)
      | 80 (* tag_cont_68 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
      ...
      | 82 (* tag_cont_70 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 3;
          let keep_89 = env_call w_94 [ 0 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_90; keep_89; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 85)
      | 83 (* tag_cont_71 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_64 = pop_env w_94 in
          let ctor_arg_65 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_65; ctor_arg_64 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 84 (* tag_cont_72 *) ->
          ...
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          let ctor_arg_66 = pop_env w_94 in
          let ctor_arg_67 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_67; ctor_arg_66 ]);
          assert_env_length w_94 2;
          let ctor_arg_68 = pop_env w_94 in
          let ctor_arg_69 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_69; ctor_arg_68 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          return_n w_94 1 (pc_to_exp (int_to_pc 0))
      | 85 (* tag_cont_73 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 139)
      | 86 (* tag_cont_74 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 140)
      | 87 (* tag_cont_75 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          ...
          assert_env_length w_94 2;
          ignore (env_call w_94 [] 1);
          w_94.state.c <- pc_to_exp (int_to_pc 87)
      | 88 (* tag_cont_76 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_90 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_91; keep_90; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 1)
      | 89 (* tag_cont_77 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          assert_env_length w_94 4;
          push_env w_94 (Memo.from_int 0);
          w_94.state.c <- pc_to_exp (int_to_pc 142)
      | 90 (* tag_cont_78 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          assert_env_length w_94 4;
          push_env w_94 (Memo.from_int 0);
          w_94.state.c <- pc_to_exp (int_to_pc 144)
      | 91 (* tag_cont_79 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          push_env w_94 (Memo.from_int 0);
          w_94.state.c <- pc_to_exp (int_to_pc 146)
      | 92 (* tag_cont_80 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          w_94.state.c <- pc_to_exp (int_to_pc 147)
      | 93 (* tag_cont_81 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 3;
          let keep_91 = env_call w_94 [ 0 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_92; keep_91; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 57)
      | 94 (* tag_cont_82 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 5 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 149)
      | 95 (* tag_cont_83 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
      ...
      | 96 (* tag_cont_84 *) ->
          ...
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let ctor_arg_73 = pop_env w_94 in
          let ctor_arg_74 = pop_env w_94 in
          push_env w_94 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_74; ctor_arg_73 ]);
          assert_env_length w_94 1;
          drop_n w_94 1 0;
          assert_env_length w_94 1;
          drop_n w_94 1 0;
      ...
      | 97 (* tag_cont_85 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 150)
      | 98 (* tag_cont_86 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_93 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_94; keep_93; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 72)
      | 99 (* tag_cont_87 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_94 = env_call w_94 [ 0 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_95; keep_94; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 77)
      | 100 (* tag_cont_88 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          assert_env_length w_94 4;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 6;
          let keep_95 = env_call w_94 [ 0; 3 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_96; keep_95; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 78)
      | 101 (* tag_cont_89 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 6;
          let keep_96 = env_call w_94 [ 0; 3 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_97; keep_96; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 60)
      | 102 (* tag_cont_90 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let keep_97 = env_call w_94 [ 1 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_98; keep_97; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 103 (* tag_cont_91 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          assert_env_length w_94 3;
          push_env w_94 (Dynarray.get w_94.state.e 1);
          w_94.state.c <- pc_to_exp (int_to_pc 155)
      | 104 (* tag_cont_92 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          ...
          assert_env_length w_94 3;
          push_env w_94 (Memo.from_int 1);
          w_94.state.c <- pc_to_exp (int_to_pc 157)
      | 105 (* tag_cont_93 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          assert_env_length w_94 4;
          push_env w_94 (Memo.from_int 0);
          w_94.state.c <- pc_to_exp (int_to_pc 159)
      | 106 (* tag_cont_94 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_99 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_100; keep_99; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 67)
      | 107 (* tag_cont_95 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_100 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_102; keep_100; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 40)
      | 108 (* tag_cont_96 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          assert_env_length w_94 3;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 2);
          assert_env_length w_94 5;
          let keep_101 = env_call w_94 [ 0; 1 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_103; keep_101; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 78)
      | 109 (* tag_cont_97 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 2);
          assert_env_length w_94 5;
          let keep_102 = env_call w_94 [ 0; 1 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_104; keep_102; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 60)
      | 110 (* tag_cont_98 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 160)
      | 111 (* tag_cont_99 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
      ...
      | 112 (* tag_cont_100 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_103 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_105; keep_103; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 72)
      | 113 (* tag_cont_101 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_104 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_106; keep_104; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 74)
      | 114 (* tag_cont_102 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          assert_env_length w_94 2;
          let keep_105 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_101; keep_105; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 77)
      | 115 (* tag_cont_103 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_106 = env_call w_94 [ 0; 1 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_107; keep_106; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 78)
      | 116 (* tag_cont_104 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_107 = env_call w_94 [ 0; 1 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_108; keep_107; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 60)
      | 117 (* tag_cont_105 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_108 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_109; keep_108; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 67)
      | 118 (* tag_cont_106 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 1 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 3;
          let keep_109 = env_call w_94 [ 1 ] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_110; keep_109; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 74)
      | 119 (* tag_cont_107 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_110 = env_call w_94 [ 0; 1; 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_111; keep_110; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 120 (* tag_cont_108 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 2 tl_0;
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 5;
          let keep_111 = env_call w_94 [ 0; 1; 2 ] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_112; keep_111; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 6)
      | 121 (* tag_cont_109 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
      ...
      | 122 (* tag_cont_110 *) ->
          ...
          push_env w_94 (Dynarray.get w_94.state.e 1);
          assert_env_length w_94 4;
          let keep_112 = env_call w_94 [] 2 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_113; keep_112; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 15)
      | 123 (* tag_cont_111 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 162)
      | 124 (* tag_cont_112 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 3 tl_0;
          w_94.state.c <- pc_to_exp (int_to_pc 164)
      | 125 (* tag_cont_113 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          push_env w_94 (Dynarray.get w_94.state.e 0);
          assert_env_length w_94 2;
          let keep_113 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_116; keep_113; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 41)
      | 126 (* tag_cont_114 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
      ...
      | 127 (* tag_cont_115 *) ->
          ...
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          let keep_114 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_114; keep_114; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 65)
      | 128 (* tag_cont_116 *) ->
          w_94.state.k <- get_next_cont tl_0;
          restore_env w_94 0 tl_0;
          assert_env_length w_94 1;
          let keep_115 = env_call w_94 [] 1 in
          w_94.state.k <- Memo.appends [ Memo.from_constructor tag_cont_115; keep_115; w_94.state.k ];
          w_94.state.c <- pc_to_exp (int_to_pc 36)
  ...
  add_exp
    (fun w_78 ->
      ...
      w_78.state.c <- pc_to_exp (int_to_pc 84))
    79;
  add_exp
    (fun w_82 ->
      assert_env_length w_82 6;
      let x0_7 = resolve w_82 (Source.E 4) in
      let x1_7 = resolve w_82 (Source.E 5) in
      ignore (pop_env w_82);
      ignore (pop_env w_82);
      push_env w_82 (Memo.from_int (Word.get_value (fst x0_7) - Word.get_value (fst x1_7)));
      assert_env_length w_82 5;
      push_env w_82 (Dynarray.get w_82.state.e 2);
      assert_env_length w_82 6;
      let keep_27 = env_call w_82 [ 0; 3 ] 2 in
      w_82.state.k <- Memo.appends [ Memo.from_constructor tag_cont_30; keep_27; w_82.state.k ];
      w_82.state.c <- pc_to_exp (int_to_pc 79))
    80;
  add_exp
    (fun w_83 ->
      assert_env_length w_83 6;
      let x0_8 = resolve w_83 (Source.E 4) in
      let x1_8 = resolve w_83 (Source.E 5) in
      ignore (pop_env w_83);
      ignore (pop_env w_83);
      push_env w_83 (Memo.from_int (Word.get_value (fst x0_8) - Word.get_value (fst x1_8)));
      assert_env_length w_83 5;
      push_env w_83 (Dynarray.get w_83.state.e 2);
      assert_env_length w_83 6;
      let keep_28 = env_call w_83 [ 0; 3 ] 2 in
      w_83.state.k <- Memo.appends [ Memo.from_constructor tag_cont_31; keep_28; w_83.state.k ];
      w_83.state.c <- pc_to_exp (int_to_pc 79))
    81;
  add_exp
    (fun w_81 ->
      assert_env_length w_81 3;
      let last_36 = Source.E 2 in
      let x_36 = resolve w_81 last_36 in
      ...
      | 5 (* tag_Add *) ->
          ...
          ignore (pop_env w_81);
          push_env w_81 split0_47;
          push_env w_81 split1_29;
  ...
  add_exp
    (fun w_80 ->
      ...
      let cond_4 = resolve w_80 (Source.E 2) in
      ignore (pop_env w_80);
  ...
  add_exp
    (fun w_79 ->
      ...
      let x0_6 = resolve w_79 (Source.E 2) in
      let x1_6 = resolve w_79 (Source.E 3) in
      ignore (pop_env w_79);
      ignore (pop_env w_79);
      push_env w_79 (Memo.from_int (if Word.get_value (fst x0_6) = Word.get_value (fst x1_6) then 1 else 0));
  ...
  add_exp
    (fun w_85 ->
      ...
      | 4 (* tag_Var *) ->
          let splits_50 = Memo.splits (snd x_37) in
          ...
          return_n w_85 2 (pc_to_exp (int_to_pc 0))
      | 5 (* tag_Add *) ->
          let splits_51 = Memo.splits (snd x_37) in
          let split0_51 = List.nth splits_51 0 in
          let split1_31 = List.nth splits_51 1 in
          ignore (pop_env w_85);
          ...
          let keep_29 = env_call w_85 [ 2 ] 1 in
          w_85.state.k <- Memo.appends [ Memo.from_constructor tag_cont_32; keep_29; w_85.state.k ];
          w_85.state.c <- pc_to_exp (int_to_pc 85)
      | 6 (* tag_Mul *) ->
          let splits_52 = Memo.splits (snd x_37) in
          let split0_52 = List.nth splits_52 0 in
          let split1_32 = List.nth splits_52 1 in
          ignore (pop_env w_85);
          push_env w_85 split0_52;
          push_env w_85 split1_32;
          assert_env_length w_85 3;
          push_env w_85 (Dynarray.get w_85.state.e 1);
          assert_env_length w_85 4;
          let keep_30 = env_call w_85 [ 2 ] 1 in
  ...
  add_exp
    (fun w_86 ->
      ...
      let keep_31 = env_call w_86 [ 0 ] 1 in
      w_86.state.k <- Memo.appends [ Memo.from_constructor tag_cont_34; keep_31; w_86.state.k ];
      w_86.state.c <- pc_to_exp (int_to_pc 85))
    87;
  add_exp
    (fun w_87 ->
  ...
  add_exp
    (fun w_89 ->
      ...
      let x_39 = resolve w_89 last_39 in
      match Word.get_value (fst x_39) with
      | 1 (* tag_X *) ->
          ignore (pop_env w_89);
          assert_env_length w_89 2;
          push_env w_89 (Memo.from_int 1);
          assert_env_length w_89 3;
          let ctor_arg_24 = pop_env w_89 in
          push_env w_89 (Memo.appends [ Memo.from_constructor tag_Const; ctor_arg_24 ]);
          assert_env_length w_89 3;
          drop_n w_89 3 1;
          assert_env_length w_89 2;
      ...
      | 2 (* tag_Y *) ->
          ignore (pop_env w_89);
          assert_env_length w_89 2;
          push_env w_89 (Memo.from_int 0);
          assert_env_length w_89 3;
          let ctor_arg_25 = pop_env w_89 in
          push_env w_89 (Memo.appends [ Memo.from_constructor tag_Const; ctor_arg_25 ]);
          assert_env_length w_89 3;
          drop_n w_89 3 1;
          assert_env_length w_89 2;
          return_n w_89 2 (pc_to_exp (int_to_pc 0))
  ...
  add_exp
    (fun w_88 ->
      ...
      let x_38 = resolve w_88 last_38 in
      ...
      | 3 (* tag_Const *) ->
          ...
          let ctor_arg_23 = pop_env w_88 in
          push_env w_88 (Memo.appends [ Memo.from_constructor tag_Const; ctor_arg_23 ]);
          assert_env_length w_88 3;
          drop_n w_88 3 1;
          assert_env_length w_88 2;
          return_n w_88 2 (pc_to_exp (int_to_pc 0))
      | 4 (* tag_Var *) ->
          let splits_54 = Memo.splits (snd x_38) in
          let split0_54 = List.nth splits_54 0 in
          ignore (pop_env w_88);
          push_env w_88 split0_54;
          assert_env_length w_88 2;
          push_env w_88 (Dynarray.get w_88.state.e 1);
          w_88.state.c <- pc_to_exp (int_to_pc 89)
      | 5 (* tag_Add *) ->
          let splits_55 = Memo.splits (snd x_38) in
          let split0_55 = List.nth splits_55 0 in
          let split1_33 = List.nth splits_55 1 in
          ignore (pop_env w_88);
          push_env w_88 split0_55;
          push_env w_88 split1_33;
          assert_env_length w_88 3;
          push_env w_88 (Dynarray.get w_88.state.e 1);
          assert_env_length w_88 4;
          let keep_32 = env_call w_88 [ 2 ] 1 in
          w_88.state.k <- Memo.appends [ Memo.from_constructor tag_cont_35; keep_32; w_88.state.k ];
          w_88.state.c <- pc_to_exp (int_to_pc 88)
      | 6 (* tag_Mul *) ->
          let splits_56 = Memo.splits (snd x_38) in
          let split0_56 = List.nth splits_56 0 in
          let split1_34 = List.nth splits_56 1 in
          ignore (pop_env w_88);
          push_env w_88 split0_56;
          push_env w_88 split1_34;
          assert_env_length w_88 3;
          push_env w_88 (Dynarray.get w_88.state.e 1);
          assert_env_length w_88 4;
          let keep_33 = env_call w_88 [ 1; 2 ] 1 in
          w_88.state.k <- Memo.appends [ Memo.from_constructor tag_cont_36; keep_33; w_88.state.k ];
          w_88.state.c <- pc_to_exp (int_to_pc 88)
  ...
  add_exp
    (fun w_92 ->
      ...
      let last_41 = Source.E 4 in
      let x_41 = resolve w_92 last_41 in
      ...
      | 1 (* tag_X *) ->
          ...
          drop_n w_92 5 1;
          assert_env_length w_92 4;
          return_n w_92 4 (pc_to_exp (int_to_pc 0))
      | 2 (* tag_Y *) ->
          ignore (pop_env w_92);
          assert_env_length w_92 4;
  ...
  add_exp
    (fun w_91 ->
      ...
      let last_40 = Source.E 3 in
      let x_40 = resolve w_91 last_40 in
      match Word.get_value (fst x_40) with
      | 3 (* tag_Const *) ->
          let splits_57 = Memo.splits (snd x_40) in
          let split0_57 = List.nth splits_57 0 in
          ignore (pop_env w_91);
          push_env w_91 split0_57;
          assert_env_length w_91 4;
          push_env w_91 (Dynarray.get w_91.state.e 3);
          assert_env_length w_91 5;
          drop_n w_91 5 1;
          assert_env_length w_91 4;
          return_n w_91 4 (pc_to_exp (int_to_pc 0))
      | 4 (* tag_Var *) ->
          let splits_58 = Memo.splits (snd x_40) in
          let split0_58 = List.nth splits_58 0 in
          ignore (pop_env w_91);
          push_env w_91 split0_58;
          assert_env_length w_91 4;
          push_env w_91 (Dynarray.get w_91.state.e 3);
          w_91.state.c <- pc_to_exp (int_to_pc 92)
      | 5 (* tag_Add *) ->
          let splits_59 = Memo.splits (snd x_40) in
          let split0_59 = List.nth splits_59 0 in
          let split1_35 = List.nth splits_59 1 in
          ignore (pop_env w_91);
          push_env w_91 split0_59;
          push_env w_91 split1_35;
          assert_env_length w_91 5;
          push_env w_91 (Dynarray.get w_91.state.e 3);
          ...
          let keep_34 = env_call w_91 [ 1; 2; 4 ] 3 in
          w_91.state.k <- Memo.appends [ Memo.from_constructor tag_cont_37; keep_34; w_91.state.k ];
          w_91.state.c <- pc_to_exp (int_to_pc 91)
      | 6 (* tag_Mul *) ->
          let splits_60 = Memo.splits (snd x_40) in
          let split0_60 = List.nth splits_60 0 in
          let split1_36 = List.nth splits_60 1 in
          ignore (pop_env w_91);
          push_env w_91 split0_60;
          push_env w_91 split1_36;
          assert_env_length w_91 5;
          push_env w_91 (Dynarray.get w_91.state.e 3);
          assert_env_length w_91 6;
          push_env w_91 (Dynarray.get w_91.state.e 1);
          ...
          push_env w_91 (Dynarray.get w_91.state.e 2);
          assert_env_length w_91 8;
          let keep_35 = env_call w_91 [ 1; 2; 4 ] 3 in
          w_91.state.k <- Memo.appends [ Memo.from_constructor tag_cont_38; keep_35; w_91.state.k ];
          w_91.state.c <- pc_to_exp (int_to_pc 91)
  ...
  add_exp
    (fun w_93 ->
      ...
      let keep_36 = env_call w_93 [] 1 in
      w_93.state.k <- Memo.appends [ Memo.from_constructor tag_cont_39; keep_36; w_93.state.k ];
      w_93.state.c <- pc_to_exp (int_to_pc 88))
    94;
  add_exp
    (fun w_95 ->
      assert_env_length w_95 3;
      let x0_9 = resolve w_95 (Source.E 1) in
      let x1_9 = resolve w_95 (Source.E 2) in
      ignore (pop_env w_95);
      ignore (pop_env w_95);
      push_env w_95 (Memo.from_int (Word.get_value (fst x0_9) + Word.get_value (fst x1_9)));
      assert_env_length w_95 2;
      push_env w_95 (Dynarray.get w_95.state.e 0);
      assert_env_length w_95 3;
      let keep_41 = env_call w_95 [ 1 ] 1 in
      w_95.state.k <- Memo.appends [ Memo.from_constructor tag_cont_44; keep_41; w_95.state.k ];
      w_95.state.c <- pc_to_exp (int_to_pc 13))
    95;
  add_exp
    (fun w_96 ->
      assert_env_length w_96 3;
      let x0_10 = resolve w_96 (Source.E 1) in
      let x1_10 = resolve w_96 (Source.E 2) in
      ignore (pop_env w_96);
      ignore (pop_env w_96);
      push_env w_96 (Memo.from_int (Word.get_value (fst x0_10) + Word.get_value (fst x1_10)));
      assert_env_length w_96 2;
      push_env w_96 (Dynarray.get w_96.state.e 0);
      assert_env_length w_96 3;
      let keep_42 = env_call w_96 [ 1 ] 1 in
  ...
  add_exp
    (fun w_98 ->
      ...
      let x_42 = resolve w_98 last_42 in
      match Word.get_value (fst x_42) with
      | 6 (* tag_Mul *) ->
          let splits_61 = Memo.splits (snd x_42) in
          let split0_61 = List.nth splits_61 0 in
          let split1_37 = List.nth splits_61 1 in
          ignore (pop_env w_98);
          push_env w_98 split0_61;
          ...
          let keep_44 = env_call w_98 [ 0; 2; 3 ] 2 in
      ...
      | _ ->
          ...
          push_env w_98 (Memo.from_constructor tag_Missing);
          assert_env_length w_98 3;
  ...
  add_exp
    (fun w_97 ->
      ...
      let cond_5 = resolve w_97 (Source.E 2) in
      ignore (pop_env w_97);
      if Word.get_value (fst cond_5) <> 0 then (
        assert_env_length w_97 2;
        push_env w_97 (Memo.from_int 1);
        assert_env_length w_97 3;
        let ctor_arg_26 = pop_env w_97 in
        push_env w_97 (Memo.appends [ Memo.from_constructor tag_Const; ctor_arg_26 ]);
        assert_env_length w_97 3;
        let ctor_arg_27 = pop_env w_97 in
        push_env w_97 (Memo.appends [ Memo.from_constructor tag_Found; ctor_arg_27 ]);
        assert_env_length w_97 3;
  ...
  add_exp
    (fun w_99 ->
      ...
      let x_43 = resolve w_99 last_43 in
      match Word.get_value (fst x_43) with
      | 8 (* tag_Found *) ->
          let splits_62 = Memo.splits (snd x_43) in
          let split0_62 = List.nth splits_62 0 in
          ignore (pop_env w_99);
          push_env w_99 split0_62;
          assert_env_length w_99 6;
          push_env w_99 (Dynarray.get w_99.state.e 2);
          assert_env_length w_99 7;
          push_env w_99 (Dynarray.get w_99.state.e 3);
          assert_env_length w_99 8;
          push_env w_99 (Dynarray.get w_99.state.e 5);
          assert_env_length w_99 9;
          let ctor_arg_28 = pop_env w_99 in
          let ctor_arg_29 = pop_env w_99 in
          push_env w_99 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_29; ctor_arg_28 ]);
          assert_env_length w_99 8;
          let ctor_arg_30 = pop_env w_99 in
          let ctor_arg_31 = pop_env w_99 in
          push_env w_99 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_31; ctor_arg_30 ]);
          assert_env_length w_99 7;
          drop_n w_99 7 1;
          assert_env_length w_99 6;
          drop_n w_99 6 1;
      ...
      | 7 (* tag_Missing *) ->
          ...
          assert_env_length w_99 7;
          let keep_45 = env_call w_99 [ 0; 1; 2; 3 ] 2 in
          w_99.state.k <- Memo.appends [ Memo.from_constructor tag_cont_48; keep_45; w_99.state.k ];
          w_99.state.c <- pc_to_exp (int_to_pc 29)
      | _ -> failwith "unreachable (99)")
    99;
  add_exp
    (fun w_101 ->
      assert_env_length w_101 5;
      let cond_6 = resolve w_101 (Source.E 4) in
      ...
      if Word.get_value (fst cond_6) <> 0 then (
        ...
        let ctor_arg_34 = pop_env w_101 in
        let ctor_arg_35 = pop_env w_101 in
        push_env w_101 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_35; ctor_arg_34 ]);
        assert_env_length w_101 5;
        drop_n w_101 5 2;
        ...
        let keep_46 = env_call w_101 [ 4 ] 2 in
        w_101.state.k <- Memo.appends [ Memo.from_constructor tag_cont_49; keep_46; w_101.state.k ];
        w_101.state.c <- pc_to_exp (int_to_pc 34)))
    100;
  add_exp
    (fun w_100 ->
      assert_env_length w_100 6;
      let x0_11 = resolve w_100 (Source.E 4) in
      let x1_11 = resolve w_100 (Source.E 5) in
      ignore (pop_env w_100);
      ignore (pop_env w_100);
      push_env w_100 (Memo.from_int (if Word.get_value (fst x0_11) <= Word.get_value (fst x1_11) then 1 else 0));
      w_100.state.c <- pc_to_exp (int_to_pc 100))
    101;
  add_exp
    (fun w_104 ->
      assert_env_length w_104 4;
      let cond_7 = resolve w_104 (Source.E 3) in
      ...
      if Word.get_value (fst cond_7) <> 0 then (
        ...
        assert_env_length w_104 4;
        ignore (env_call w_104 [] 1);
        w_104.state.c <- pc_to_exp (int_to_pc 55))
      else (
        assert_env_length w_104 3;
        ...
        let keep_50 = env_call w_104 [ 3 ] 1 in
        w_104.state.k <- Memo.appends [ Memo.from_constructor tag_cont_53; keep_50; w_104.state.k ];
        w_104.state.c <- pc_to_exp (int_to_pc 55)))
    102;
  add_exp
    (fun w_103 ->
      assert_env_length w_103 5;
      let x0_12 = resolve w_103 (Source.E 3) in
      let x1_12 = resolve w_103 (Source.E 4) in
      ignore (pop_env w_103);
      ignore (pop_env w_103);
      push_env w_103 (Memo.from_int (if Word.get_value (fst x0_12) = Word.get_value (fst x1_12) then 1 else 0));
  ...
  add_exp
    (fun w_102 ->
      ...
      let x_44 = resolve w_102 last_44 in
      ...
      | _ ->
          ...
          assert_env_length w_102 4;
          let keep_51 = env_call w_102 [ 2 ] 1 in
          w_102.state.k <- Memo.appends [ Memo.from_constructor tag_cont_54; keep_51; w_102.state.k ];
          w_102.state.c <- pc_to_exp (int_to_pc 55)
  ...
  add_exp
    (fun w_105 ->
      ...
      let x_45 = resolve w_105 last_45 in
      ...
      | 11 (* tag_NoPick *) ->
          ...
          let keep_58 = env_call w_105 [ 2 ] 1 in
          w_105.state.k <- Memo.appends [ Memo.from_constructor tag_cont_61; keep_58; w_105.state.k ];
          w_105.state.c <- pc_to_exp (int_to_pc 72)
      | 12 (* tag_Pick *) ->
          let splits_64 = Memo.splits (snd x_45) in
          let split0_64 = List.nth splits_64 0 in
          let split1_38 = List.nth splits_64 1 in
          ignore (pop_env w_105);
          push_env w_105 split0_64;
          push_env w_105 split1_38;
          assert_env_length w_105 4;
          ...
          let keep_59 = env_call w_105 [] 2 in
          w_105.state.k <- Memo.appends [ Memo.from_constructor tag_cont_62; keep_59; w_105.state.k ];
  ...
  add_exp
    (fun w_106 ->
      ...
      let x0_13 = resolve w_106 (Source.E 3) in
      let x1_13 = resolve w_106 (Source.E 4) in
      ignore (pop_env w_106);
      ignore (pop_env w_106);
      push_env w_106 (Memo.from_int (Word.get_value (fst x0_13) - Word.get_value (fst x1_13)));
      assert_env_length w_106 4;
      push_env w_106 (Dynarray.get w_106.state.e 1);
      assert_env_length w_106 5;
      let keep_63 = env_call w_106 [ 0; 2 ] 2 in
      w_106.state.k <- Memo.appends [ Memo.from_constructor tag_cont_66; keep_63; w_106.state.k ];
      w_106.state.c <- pc_to_exp (int_to_pc 79))
    106;
  add_exp
    (fun w_107 ->
      assert_env_length w_107 5;
      let x0_14 = resolve w_107 (Source.E 3) in
      let x1_14 = resolve w_107 (Source.E 4) in
      ignore (pop_env w_107);
      ignore (pop_env w_107);
      push_env w_107 (Memo.from_int (Word.get_value (fst x0_14) - Word.get_value (fst x1_14)));
      assert_env_length w_107 4;
      push_env w_107 (Dynarray.get w_107.state.e 1);
      assert_env_length w_107 5;
      let keep_64 = env_call w_107 [ 0; 2 ] 2 in
      w_107.state.k <- Memo.appends [ Memo.from_constructor tag_cont_67; keep_64; w_107.state.k ];
      w_107.state.c <- pc_to_exp (int_to_pc 79))
    107;
  add_exp
    (fun w_117 ->
      assert_env_length w_117 7;
      let cond_11 = resolve w_117 (Source.E 6) in
  ...
  add_exp
    (fun w_116 ->
      ...
      let x0_18 = resolve w_116 (Source.E 6) in
      let x1_18 = resolve w_116 (Source.E 7) in
      ignore (pop_env w_116);
      ignore (pop_env w_116);
      push_env w_116 (Memo.from_int (if Word.get_value (fst x0_18) > Word.get_value (fst x1_18) then 1 else 0));
      w_116.state.c <- pc_to_exp (int_to_pc 108))
    109;
  add_exp
    (fun w_118 ->
      assert_env_length w_118 8;
      let x0_19 = resolve w_118 (Source.E 6) in
      let x1_19 = resolve w_118 (Source.E 7) in
      ignore (pop_env w_118);
      ignore (pop_env w_118);
      push_env w_118 (Memo.from_int (Word.get_value (fst x0_19) - Word.get_value (fst x1_19)));
      assert_env_length w_118 7;
      drop_n w_118 7 1;
  ...
  add_exp
    (fun w_115 ->
      ...
      let cond_10 = resolve w_115 (Source.E 6) in
      ignore (pop_env w_115);
      if Word.get_value (fst cond_10) <> 0 then (
        assert_env_length w_115 6;
        push_env w_115 (Memo.from_int 0);
        assert_env_length w_115 7;
        push_env w_115 (Memo.from_int 1);
        w_115.state.c <- pc_to_exp (int_to_pc 110))
      else (
        assert_env_length w_115 6;
        push_env w_115 (Dynarray.get w_115.state.e 4);
        assert_env_length w_115 7;
        push_env w_115 (Dynarray.get w_115.state.e 5);
        w_115.state.c <- pc_to_exp (int_to_pc 109)))
    111;
  add_exp
    (fun w_114 ->
      assert_env_length w_114 8;
      let x0_17 = resolve w_114 (Source.E 6) in
      let x1_17 = resolve w_114 (Source.E 7) in
      ignore (pop_env w_114);
      ignore (pop_env w_114);
      push_env w_114 (Memo.from_int (if Word.get_value (fst x0_17) < Word.get_value (fst x1_17) then 1 else 0));
      w_114.state.c <- pc_to_exp (int_to_pc 111))
    112;
  add_exp
    (fun w_113 ->
      assert_env_length w_113 6;
      let last_47 = Source.E 5 in
      let x_47 = resolve w_113 last_47 in
      ...
      | 3 (* tag_Const *) ->
          ...
          push_env w_113 split0_66;
          assert_env_length w_113 6;
          push_env w_113 (Dynarray.get w_113.state.e 4);
          assert_env_length w_113 7;
          push_env w_113 (Dynarray.get w_113.state.e 5);
          w_113.state.c <- pc_to_exp (int_to_pc 112)
      | _ -> failwith "unreachable (113)")
    113;
  add_exp
    (fun w_119 ->
      assert_env_length w_119 6;
      let last_48 = Source.E 5 in
      let x_48 = resolve w_119 last_48 in
      match Word.get_value (fst x_48) with
      | 4 (* tag_Var *) ->
          let splits_68 = Memo.splits (snd x_48) in
          let split0_68 = List.nth splits_68 0 in
          ignore (pop_env w_119);
          push_env w_119 split0_68;
          assert_env_length w_119 6;
          push_env w_119 (Dynarray.get w_119.state.e 4);
          assert_env_length w_119 7;
          let keep_73 = env_call w_119 [ 5 ] 1 in
          w_119.state.k <- Memo.appends [ Memo.from_constructor tag_cont_76; keep_73; w_119.state.k ];
          w_119.state.c <- pc_to_exp (int_to_pc 1)
      | _ -> failwith "unreachable (114)")
    114;
  add_exp
    (fun w_120 ->
      assert_env_length w_120 7;
      let last_49 = Source.E 6 in
      let x_49 = resolve w_120 last_49 in
      match Word.get_value (fst x_49) with
      | 5 (* tag_Add *) ->
          let splits_70 = Memo.splits (snd x_49) in
          let split0_70 = List.nth splits_70 0 in
          let split1_40 = List.nth splits_70 1 in
          ignore (pop_env w_120);
          push_env w_120 split0_70;
          push_env w_120 split1_40;
          assert_env_length w_120 8;
          push_env w_120 (Dynarray.get w_120.state.e 4);
          assert_env_length w_120 9;
          push_env w_120 (Dynarray.get w_120.state.e 6);
          assert_env_length w_120 10;
          let keep_74 = env_call w_120 [ 5; 7 ] 2 in
          w_120.state.k <- Memo.appends [ Memo.from_constructor tag_cont_77; keep_74; w_120.state.k ];
  ...
  add_exp
    (fun w_121 ->
      ...
      let x_50 = resolve w_121 last_50 in
      match Word.get_value (fst x_50) with
      | 6 (* tag_Mul *) ->
          let splits_72 = Memo.splits (snd x_50) in
          let split0_72 = List.nth splits_72 0 in
          let split1_42 = List.nth splits_72 1 in
          ignore (pop_env w_121);
          push_env w_121 split0_72;
          push_env w_121 split1_42;
          assert_env_length w_121 8;
          push_env w_121 (Dynarray.get w_121.state.e 4);
          assert_env_length w_121 9;
          push_env w_121 (Dynarray.get w_121.state.e 6);
          assert_env_length w_121 10;
          let keep_75 = env_call w_121 [ 5; 7 ] 2 in
          w_121.state.k <- Memo.appends [ Memo.from_constructor tag_cont_78; keep_75; w_121.state.k ];
          w_121.state.c <- pc_to_exp (int_to_pc 5)
      | _ -> failwith "unreachable (116)")
    116;
  add_exp
    (fun w_112 ->
      assert_env_length w_112 5;
      let last_46 = Source.E 4 in
      let x_46 = resolve w_112 last_46 in
      ...
      | 3 (* tag_Const *) ->
          ...
          push_env w_112 split0_65;
          assert_env_length w_112 5;
          push_env w_112 (Dynarray.get w_112.state.e 1);
          w_112.state.c <- pc_to_exp (int_to_pc 113)
      | 4 (* tag_Var *) ->
          let splits_67 = Memo.splits (snd x_46) in
          let split0_67 = List.nth splits_67 0 in
          ignore (pop_env w_112);
          push_env w_112 split0_67;
          assert_env_length w_112 5;
          push_env w_112 (Dynarray.get w_112.state.e 1);
          w_112.state.c <- pc_to_exp (int_to_pc 114)
      | 5 (* tag_Add *) ->
          let splits_69 = Memo.splits (snd x_46) in
          let split0_69 = List.nth splits_69 0 in
          let split1_39 = List.nth splits_69 1 in
          ignore (pop_env w_112);
          push_env w_112 split0_69;
          push_env w_112 split1_39;
          assert_env_length w_112 6;
          push_env w_112 (Dynarray.get w_112.state.e 1);
          w_112.state.c <- pc_to_exp (int_to_pc 115)
      | 6 (* tag_Mul *) ->
          let splits_71 = Memo.splits (snd x_46) in
          let split0_71 = List.nth splits_71 0 in
          let split1_41 = List.nth splits_71 1 in
          ignore (pop_env w_112);
          push_env w_112 split0_71;
  ...
  add_exp
    (fun w_111 ->
      ...
      let cond_9 = resolve w_111 (Source.E 4) in
      ...
      if Word.get_value (fst cond_9) <> 0 then (
        ...
        w_111.state.c <- pc_to_exp (int_to_pc 117)))
    118;
  add_exp
    (fun w_110 ->
      assert_env_length w_110 6;
      let x0_16 = resolve w_110 (Source.E 4) in
      let x1_16 = resolve w_110 (Source.E 5) in
      ignore (pop_env w_110);
      ignore (pop_env w_110);
      push_env w_110 (Memo.from_int (if Word.get_value (fst x0_16) > Word.get_value (fst x1_16) then 1 else 0));
      w_110.state.c <- pc_to_exp (int_to_pc 118))
    119;
  add_exp
    (fun w_122 ->
      assert_env_length w_122 6;
      let x0_20 = resolve w_122 (Source.E 4) in
      let x1_20 = resolve w_122 (Source.E 5) in
  ...
  add_exp
    (fun w_109 ->
      ...
      let cond_8 = resolve w_109 (Source.E 4) in
      ignore (pop_env w_109);
      if Word.get_value (fst cond_8) <> 0 then (
        assert_env_length w_109 4;
        push_env w_109 (Memo.from_int 0);
        assert_env_length w_109 5;
        push_env w_109 (Memo.from_int 1);
        ...
        w_109.state.c <- pc_to_exp (int_to_pc 119)))
    121;
  add_exp
    (fun w_108 ->
      assert_env_length w_108 6;
      let x0_15 = resolve w_108 (Source.E 4) in
      let x1_15 = resolve w_108 (Source.E 5) in
      ignore (pop_env w_108);
      ignore (pop_env w_108);
      push_env w_108 (Memo.from_int (if Word.get_value (fst x0_15) < Word.get_value (fst x1_15) then 1 else 0));
      w_108.state.c <- pc_to_exp (int_to_pc 121))
    122;
  add_exp
    (fun w_123 ->
      assert_env_length w_123 2;
      let x0_21 = resolve w_123 (Source.E 0) in
      let x1_21 = resolve w_123 (Source.E 1) in
      ...
      drop_n w_123 1 0;
      assert_env_length w_123 1;
      return_n w_123 1 (pc_to_exp (int_to_pc 0)))
    123;
  add_exp
    (fun w_124 ->
      assert_env_length w_124 2;
      let x0_22 = resolve w_124 (Source.E 0) in
      let x1_22 = resolve w_124 (Source.E 1) in
      ignore (pop_env w_124);
      ignore (pop_env w_124);
      push_env w_124
        (Memo.from_int (if Word.get_value (fst x0_22) <> 0 && Word.get_value (fst x1_22) <> 0 then 1 else 0));
      assert_env_length w_124 1;
      drop_n w_124 1 0;
      assert_env_length w_124 1;
      drop_n w_124 1 0;
      assert_env_length w_124 1;
      return_n w_124 1 (pc_to_exp (int_to_pc 0)))
    124;
  add_exp
    (fun w_125 ->
      assert_env_length w_125 2;
      let x0_23 = resolve w_125 (Source.E 0) in
      let x1_23 = resolve w_125 (Source.E 1) in
      ignore (pop_env w_125);
      ignore (pop_env w_125);
      push_env w_125
        (Memo.from_int (if Word.get_value (fst x0_23) <> 0 && Word.get_value (fst x1_23) <> 0 then 1 else 0));
  ...
  add_exp
    (fun w_126 ->
      ...
      let x0_24 = resolve w_126 (Source.E 0) in
      let x1_24 = resolve w_126 (Source.E 1) in
      ignore (pop_env w_126);
      ignore (pop_env w_126);
      push_env w_126 (Memo.from_int (Word.get_value (fst x0_24) + Word.get_value (fst x1_24)));
  ...
  add_exp
    (fun w_127 ->
      ...
      let x0_25 = resolve w_127 (Source.E 0) in
      let x1_25 = resolve w_127 (Source.E 1) in
      ignore (pop_env w_127);
      ignore (pop_env w_127);
      push_env w_127 (Memo.from_int (Word.get_value (fst x0_25) + Word.get_value (fst x1_25)));
  ...
  add_exp
    (fun w_131 ->
      ...
      let cond_13 = resolve w_131 (Source.E 4) in
      ...
      if Word.get_value (fst cond_13) <> 0 then (
        ...
        let keep_76 = env_call w_131 [ 0; 1 ] 2 in
        w_131.state.k <- Memo.appends [ Memo.from_constructor tag_cont_79; keep_76; w_131.state.k ];
        w_131.state.c <- pc_to_exp (int_to_pc 5)))
    128;
  add_exp
    (fun w_130 ->
      assert_env_length w_130 6;
      let x0_27 = resolve w_130 (Source.E 4) in
      let x1_27 = resolve w_130 (Source.E 5) in
      ignore (pop_env w_130);
      ignore (pop_env w_130);
      push_env w_130 (Memo.from_int (if Word.get_value (fst x0_27) < Word.get_value (fst x1_27) then 1 else 0));
      w_130.state.c <- pc_to_exp (int_to_pc 128))
    129;
  add_exp
    (fun w_129 ->
      assert_env_length w_129 5;
      let cond_12 = resolve w_129 (Source.E 4) in
      ...
      if Word.get_value (fst cond_12) <> 0 then (
        ...
        return_n w_129 3 (pc_to_exp (int_to_pc 0)))
      else (
        assert_env_length w_129 4;
  ...
  add_exp
    (fun w_128 ->
      ...
      let x0_26 = resolve w_128 (Source.E 4) in
      let x1_26 = resolve w_128 (Source.E 5) in
      ignore (pop_env w_128);
      ignore (pop_env w_128);
      push_env w_128 (Memo.from_int (if Word.get_value (fst x0_26) < Word.get_value (fst x1_26) then 1 else 0));
      w_128.state.c <- pc_to_exp (int_to_pc 130))
    131;
  add_exp
    (fun w_132 ->
      assert_env_length w_132 5;
      let last_51 = Source.E 4 in
      let x_51 = resolve w_132 last_51 in
      ...
      | 8 (* tag_Found *) ->
          ...
          let ctor_arg_48 = pop_env w_132 in
          let ctor_arg_49 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_49; ctor_arg_48 ]);
          assert_env_length w_132 6;
          let ctor_arg_50 = pop_env w_132 in
          push_env w_132 (Memo.appends [ Memo.from_constructor tag_Found; ctor_arg_50 ]);
          assert_env_length w_132 6;
          drop_n w_132 6 1;
          assert_env_length w_132 5;
          drop_n w_132 5 1;
      ...
      | 7 (* tag_Missing *) ->
          ...
          push_env w_132 (Dynarray.get w_132.state.e 2);
          assert_env_length w_132 6;
          let keep_77 = env_call w_132 [ 1 ] 2 in
          w_132.state.k <- Memo.appends [ Memo.from_constructor tag_cont_80; keep_77; w_132.state.k ];
          w_132.state.c <- pc_to_exp (int_to_pc 29)
      | _ -> failwith "unreachable (132)")
    132;
  add_exp
    (fun w_133 ->
      assert_env_length w_133 6;
      let last_52 = Source.E 5 in
      let x_52 = resolve w_133 last_52 in
      ...
      | 8 (* tag_Found *) ->
          ...
          let ctor_arg_51 = pop_env w_133 in
          let ctor_arg_52 = pop_env w_133 in
          push_env w_133 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_52; ctor_arg_51 ]);
          assert_env_length w_133 8;
          let ctor_arg_53 = pop_env w_133 in
          let ctor_arg_54 = pop_env w_133 in
          push_env w_133 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_54; ctor_arg_53 ]);
          assert_env_length w_133 7;
          drop_n w_133 7 1;
          assert_env_length w_133 6;
          drop_n w_133 6 1;
      ...
      | 7 (* tag_Missing *) ->
          ...
          assert_env_length w_133 7;
          let ctor_arg_55 = pop_env w_133 in
          let ctor_arg_56 = pop_env w_133 in
          push_env w_133 (Memo.appends [ Memo.from_constructor tag_Add; ctor_arg_56; ctor_arg_55 ]);
          assert_env_length w_133 6;
          drop_n w_133 6 1;
          assert_env_length w_133 5;
          drop_n w_133 5 0;
          ...
          assert_env_length w_133 3;
          return_n w_133 3 (pc_to_exp (int_to_pc 0))
      | _ -> failwith "unreachable (133)")
    133;
  add_exp
    (fun w_134 ->
      assert_env_length w_134 2;
      let x0_28 = resolve w_134 (Source.E 0) in
      let x1_28 = resolve w_134 (Source.E 1) in
      ignore (pop_env w_134);
      ignore (pop_env w_134);
      push_env w_134 (Memo.from_int (Word.get_value (fst x0_28) * Word.get_value (fst x1_28)));
  ...
  add_exp
    (fun w_136 ->
      ...
      let cond_14 = resolve w_136 (Source.E 2) in
      ignore (pop_env w_136);
      if Word.get_value (fst cond_14) <> 0 then (
        assert_env_length w_136 2;
        push_env w_136 (Memo.from_int 0);
        assert_env_length w_136 3;
        let ctor_arg_59 = pop_env w_136 in
        push_env w_136 (Memo.appends [ Memo.from_constructor tag_Const; ctor_arg_59 ]);
        assert_env_length w_136 3;
        drop_n w_136 3 1;
        assert_env_length w_136 2;
        drop_n w_136 2 1;
        ...
        assert_env_length w_136 3;
        let keep_78 = env_call w_136 [ 1 ] 1 in
        w_136.state.k <- Memo.appends [ Memo.from_constructor tag_cont_81; keep_78; w_136.state.k ];
        w_136.state.c <- pc_to_exp (int_to_pc 55)))
    135;
  add_exp
    (fun w_135 ->
      assert_env_length w_135 4;
      let x0_29 = resolve w_135 (Source.E 2) in
      let x1_29 = resolve w_135 (Source.E 3) in
      ignore (pop_env w_135);
      ignore (pop_env w_135);
      push_env w_135 (Memo.from_int (if Word.get_value (fst x0_29) = Word.get_value (fst x1_29) then 1 else 0));
      w_135.state.c <- pc_to_exp (int_to_pc 135))
    136;
  add_exp
    (fun w_137 ->
      assert_env_length w_137 5;
      let cond_15 = resolve w_137 (Source.E 4) in
      ...
      if Word.get_value (fst cond_15) <> 0 then (
        ...
        let keep_82 = env_call w_137 [ 4 ] 1 in
        w_137.state.k <- Memo.appends [ Memo.from_constructor tag_cont_84; keep_82; w_137.state.k ];
        w_137.state.c <- pc_to_exp (int_to_pc 67))
      else (
        assert_env_length w_137 4;
        push_env w_137 (Dynarray.get w_137.state.e 3);
        assert_env_length w_137 5;
        push_env w_137 (Dynarray.get w_137.state.e 2);
        assert_env_length w_137 6;
        let keep_81 = env_call w_137 [] 2 in
        w_137.state.k <- Memo.appends [ Memo.from_constructor tag_cont_83; keep_81; w_137.state.k ];
        w_137.state.c <- pc_to_exp (int_to_pc 34)))
    137;
  add_exp
    (fun w_138 ->
      assert_env_length w_138 5;
      let cond_16 = resolve w_138 (Source.E 4) in
      ...
      if Word.get_value (fst cond_16) <> 0 then (
        ...
        let keep_83 = env_call w_138 [ 1 ] 2 in
        w_138.state.k <- Memo.appends [ Memo.from_constructor tag_cont_85; keep_83; w_138.state.k ];
        w_138.state.c <- pc_to_exp (int_to_pc 70))
      else (
        assert_env_length w_138 4;
        ...
        push_env w_138 (Dynarray.get w_138.state.e 2);
        assert_env_length w_138 6;
        let ctor_arg_60 = pop_env w_138 in
        let ctor_arg_61 = pop_env w_138 in
        push_env w_138 (Memo.appends [ Memo.from_constructor tag_Pick; ctor_arg_61; ctor_arg_60 ]);
        assert_env_length w_138 5;
        drop_n w_138 5 1;
        assert_env_length w_138 4;
        drop_n w_138 4 2;
  ...
  add_exp
    (fun w_139 ->
      ...
      let x0_30 = resolve w_139 (Source.E 0) in
      let x1_30 = resolve w_139 (Source.E 1) in
      ignore (pop_env w_139);
      ignore (pop_env w_139);
      push_env w_139 (Memo.from_int (Word.get_value (fst x0_30) + Word.get_value (fst x1_30)));
  ...
  add_exp
    (fun w_140 ->
      ...
      let x0_31 = resolve w_140 (Source.E 0) in
      let x1_31 = resolve w_140 (Source.E 1) in
      ignore (pop_env w_140);
      ignore (pop_env w_140);
      push_env w_140 (Memo.from_int (Word.get_value (fst x0_31) * Word.get_value (fst x1_31)));
  ...
  add_exp
    (fun w_142 ->
      ...
      let cond_17 = resolve w_142 (Source.E 3) in
      ...
      if Word.get_value (fst cond_17) <> 0 then (
        ...
        w_142.state.c <- pc_to_exp (int_to_pc 5))
      else (
        assert_env_length w_142 3;
  ...
  add_exp
    (fun w_141 ->
      ...
      let x0_32 = resolve w_141 (Source.E 3) in
      let x1_32 = resolve w_141 (Source.E 4) in
      ignore (pop_env w_141);
      ignore (pop_env w_141);
      push_env w_141 (Memo.from_int (if Word.get_value (fst x0_32) = Word.get_value (fst x1_32) then 1 else 0));
      w_141.state.c <- pc_to_exp (int_to_pc 141))
    142;
  add_exp
    (fun w_144 ->
      assert_env_length w_144 4;
      let cond_18 = resolve w_144 (Source.E 3) in
      ...
      if Word.get_value (fst cond_18) <> 0 then (
        ...
        w_144.state.c <- pc_to_exp (int_to_pc 5))
      else (
        assert_env_length w_144 3;
        ...
        drop_n w_144 1 0;
        assert_env_length w_144 1;
        return_n w_144 1 (pc_to_exp (int_to_pc 0))))
    143;
  add_exp
    (fun w_143 ->
      assert_env_length w_143 5;
      let x0_33 = resolve w_143 (Source.E 3) in
      let x1_33 = resolve w_143 (Source.E 4) in
      ignore (pop_env w_143);
      ignore (pop_env w_143);
      push_env w_143 (Memo.from_int (if Word.get_value (fst x0_33) = Word.get_value (fst x1_33) then 1 else 0));
      w_143.state.c <- pc_to_exp (int_to_pc 143))
    144;
  add_exp
    (fun w_146 ->
      assert_env_length w_146 3;
      let cond_19 = resolve w_146 (Source.E 2) in
      ...
      if Word.get_value (fst cond_19) <> 0 then (
        ...
        drop_n w_146 3 0;
        assert_env_length w_146 3;
        return_n w_146 3 (pc_to_exp (int_to_pc 0)))
      else (
        assert_env_length w_146 2;
  ...
  add_exp
    (fun w_145 ->
      ...
      let x0_34 = resolve w_145 (Source.E 2) in
      let x1_34 = resolve w_145 (Source.E 3) in
      ignore (pop_env w_145);
      ignore (pop_env w_145);
      push_env w_145 (Memo.from_int (if Word.get_value (fst x0_34) <= Word.get_value (fst x1_34) then 1 else 0));
  ...
  add_exp
    (fun w_147 ->
      ...
      let x_53 = resolve w_147 last_53 in
      ...
      | 8 (* tag_Found *) ->
          ...
          let ctor_arg_70 = pop_env w_147 in
          let ctor_arg_71 = pop_env w_147 in
          push_env w_147 (Memo.appends [ Memo.from_constructor tag_Mul; ctor_arg_71; ctor_arg_70 ]);
          assert_env_length w_147 4;
          let ctor_arg_72 = pop_env w_147 in
          push_env w_147 (Memo.appends [ Memo.from_constructor tag_Found; ctor_arg_72 ]);
          assert_env_length w_147 4;
          drop_n w_147 4 1;
          assert_env_length w_147 3;
          drop_n w_147 3 1;
      ...
      | 7 (* tag_Missing *) ->
          ignore (pop_env w_147);
          assert_env_length w_147 2;
          push_env w_147 (Memo.from_constructor tag_Missing);
          assert_env_length w_147 3;
          drop_n w_147 3 1;
          assert_env_length w_147 2;
          drop_n w_147 2 0;
  ...
  add_exp
    (fun w_149 ->
      assert_env_length w_149 8;
      let x0_35 = resolve w_149 (Source.E 6) in
      let x1_35 = resolve w_149 (Source.E 7) in
      ignore (pop_env w_149);
      ignore (pop_env w_149);
      push_env w_149 (Memo.from_int (Word.get_value (fst x0_35) + Word.get_value (fst x1_35)));
      assert_env_length w_149 7;
      push_env w_149 (Dynarray.get w_149.state.e 2);
      assert_env_length w_149 8;
      ignore (env_call w_149 [] 3);
      w_149.state.c <- pc_to_exp (int_to_pc 61))
    148;
  add_exp
    (fun w_148 ->
      assert_env_length w_148 6;
      let cond_20 = resolve w_148 (Source.E 5) in
      ...
      if Word.get_value (fst cond_20) <> 0 then (
        ...
        let keep_92 = env_call w_148 [ 0; 1 ] 3 in
        w_148.state.k <- Memo.appends [ Memo.from_constructor tag_cont_93; keep_92; w_148.state.k ];
        w_148.state.c <- pc_to_exp (int_to_pc 61)))
    149;
  add_exp
    (fun w_150 ->
      assert_env_length w_150 2;
      let last_54 = Source.E 1 in
      let x_54 = resolve w_150 last_54 in
      match Word.get_value (fst x_54) with
      | 11 (* tag_NoPick *) ->
          ignore (pop_env w_150);
          assert_env_length w_150 1;
          push_env w_150 (Memo.from_constructor tag_NoPick);
          assert_env_length w_150 2;
          drop_n w_150 2 0;
          assert_env_length w_150 2;
          drop_n w_150 2 1;
      ...
      | 12 (* tag_Pick *) ->
          ...
          ignore (pop_env w_150);
          push_env w_150 split0_76;
          push_env w_150 split1_43;
          ...
          push_env w_150 (Dynarray.get w_150.state.e 2);
          assert_env_length w_150 6;
          let ctor_arg_75 = pop_env w_150 in
          let ctor_arg_76 = pop_env w_150 in
          push_env w_150 (Memo.appends [ Memo.from_constructor tag_ECons; ctor_arg_76; ctor_arg_75 ]);
          assert_env_length w_150 5;
          let ctor_arg_77 = pop_env w_150 in
          let ctor_arg_78 = pop_env w_150 in
          push_env w_150 (Memo.appends [ Memo.from_constructor tag_Pick; ctor_arg_78; ctor_arg_77 ]);
          assert_env_length w_150 4;
          drop_n w_150 4 2;
          assert_env_length w_150 2;
          drop_n w_150 2 0;
  ...
  add_exp
    (fun w_154 ->
      ...
      if Word.get_value (fst cond_22) <> 0 then (
        ...
        assert_env_length w_154 2;
        push_env w_154 (Memo.from_int 0);
        assert_env_length w_154 3;
        drop_n w_154 3 1;
        assert_env_length w_154 2;
        drop_n w_154 2 1;
  ...
  add_exp
    (fun w_153 ->
      ...
      let x0_37 = resolve w_153 (Source.E 2) in
      let x1_37 = resolve w_153 (Source.E 3) in
      ignore (pop_env w_153);
      ignore (pop_env w_153);
      push_env w_153 (Memo.from_int (if Word.get_value (fst x0_37) > Word.get_value (fst x1_37) then 1 else 0));
      w_153.state.c <- pc_to_exp (int_to_pc 151))
    152;
  add_exp
    (fun w_155 ->
      assert_env_length w_155 4;
      let x0_38 = resolve w_155 (Source.E 2) in
      let x1_38 = resolve w_155 (Source.E 3) in
      ignore (pop_env w_155);
      ignore (pop_env w_155);
      push_env w_155 (Memo.from_int (Word.get_value (fst x0_38) - Word.get_value (fst x1_38)));
  ...
  add_exp
    (fun w_152 ->
      ...
      let cond_21 = resolve w_152 (Source.E 2) in
      ignore (pop_env w_152);
      if Word.get_value (fst cond_21) <> 0 then (
        assert_env_length w_152 2;
        push_env w_152 (Memo.from_int 0);
        assert_env_length w_152 3;
        push_env w_152 (Memo.from_int 1);
        w_152.state.c <- pc_to_exp (int_to_pc 153))
      else (
        assert_env_length w_152 2;
  ...
  add_exp
    (fun w_151 ->
      ...
      let x0_36 = resolve w_151 (Source.E 2) in
      let x1_36 = resolve w_151 (Source.E 3) in
      ignore (pop_env w_151);
      ignore (pop_env w_151);
      push_env w_151 (Memo.from_int (if Word.get_value (fst x0_36) < Word.get_value (fst x1_36) then 1 else 0));
      w_151.state.c <- pc_to_exp (int_to_pc 154))
    155;
  add_exp
    (fun w_157 ->
      ...
      if Word.get_value (fst cond_23) <> 0 then (
        ...
        w_157.state.c <- pc_to_exp (int_to_pc 16)))
    156;
  add_exp
    (fun w_156 ->
      assert_env_length w_156 4;
      let x0_39 = resolve w_156 (Source.E 2) in
      let x1_39 = resolve w_156 (Source.E 3) in
      ignore (pop_env w_156);
      ignore (pop_env w_156);
      push_env w_156 (Memo.from_int (if Word.get_value (fst x0_39) = Word.get_value (fst x1_39) then 1 else 0));
      w_156.state.c <- pc_to_exp (int_to_pc 156))
    157;
  add_exp
    (fun w_159 ->
      assert_env_length w_159 4;
      let cond_24 = resolve w_159 (Source.E 3) in
      ...
      if Word.get_value (fst cond_24) <> 0 then (
        ...
        drop_n w_159 3 0;
        assert_env_length w_159 3;
        return_n w_159 3 (pc_to_exp (int_to_pc 0)))
      else (
        assert_env_length w_159 3;
        ...
        let keep_98 = env_call w_159 [ 2 ] 2 in
        w_159.state.k <- Memo.appends [ Memo.from_constructor tag_cont_99; keep_98; w_159.state.k ];
        w_159.state.c <- pc_to_exp (int_to_pc 16)))
    158;
  add_exp
    (fun w_158 ->
      assert_env_length w_158 5;
      let x0_40 = resolve w_158 (Source.E 3) in
      let x1_40 = resolve w_158 (Source.E 4) in
      ignore (pop_env w_158);
      ignore (pop_env w_158);
      push_env w_158 (Memo.from_int (if Word.get_value (fst x0_40) = Word.get_value (fst x1_40) then 1 else 0));
      w_158.state.c <- pc_to_exp (int_to_pc 158))
    159;
  add_exp
    (fun w_160 ->
      assert_env_length w_160 2;
      let cond_25 = resolve w_160 (Source.E 1) in
      ...
      if Word.get_value (fst cond_25) <> 0 then (
        ...
        push_env w_160 (Dynarray.get w_160.state.e 0);
        assert_env_length w_160 2;
        ignore (env_call w_160 [] 1);
        w_160.state.c <- pc_to_exp (int_to_pc 87)))
    160;
  add_exp
    (fun w_162 ->
      assert_env_length w_162 5;
      let x0_41 = resolve w_162 (Source.E 3) in
      let x1_41 = resolve w_162 (Source.E 4) in
      ignore (pop_env w_162);
      ignore (pop_env w_162);
      push_env w_162 (Memo.from_int (Word.get_value (fst x0_41) - Word.get_value (fst x1_41)));
      assert_env_length w_162 4;
      push_env w_162 (Dynarray.get w_162.state.e 2);
      assert_env_length w_162 5;
      ignore (env_call w_162 [] 2);
      w_162.state.c <- pc_to_exp (int_to_pc 79))
    161;
  add_exp
    (fun w_161 ->
      assert_env_length w_161 4;
      let cond_26 = resolve w_161 (Source.E 3) in
      ...
      if Word.get_value (fst cond_26) <> 0 then (
        ...
        drop_n w_161 2 0;
        assert_env_length w_161 2;
        return_n w_161 2 (pc_to_exp (int_to_pc 0)))
      else (
        assert_env_length w_161 3;
        push_env w_161 (Dynarray.get w_161.state.e 0);
        assert_env_length w_161 4;
        push_env w_161 (Memo.from_int 1);
        w_161.state.c <- pc_to_exp (int_to_pc 161)))
    162;
  add_exp
    (fun w_164 ->
      assert_env_length w_164 5;
      let x0_42 = resolve w_164 (Source.E 3) in
      let x1_42 = resolve w_164 (Source.E 4) in
      ignore (pop_env w_164);
      ignore (pop_env w_164);
      push_env w_164 (Memo.from_int (Word.get_value (fst x0_42) - Word.get_value (fst x1_42)));
      assert_env_length w_164 4;
      push_env w_164 (Dynarray.get w_164.state.e 2);
      assert_env_length w_164 5;
      ignore (env_call w_164 [] 2);
      w_164.state.c <- pc_to_exp (int_to_pc 79))
    163;
  add_exp
    (fun w_163 ->
      assert_env_length w_163 4;
      let cond_27 = resolve w_163 (Source.E 3) in
      ...
      if Word.get_value (fst cond_27) <> 0 then (
        ...
        drop_n w_163 2 0;
        assert_env_length w_163 2;
        return_n w_163 2 (pc_to_exp (int_to_pc 0)))
      else (
        assert_env_length w_163 3;
        push_env w_163 (Dynarray.get w_163.state.e 0);
        assert_env_length w_163 4;
        push_env w_163 (Memo.from_int 1);
  ...
  Words.set_constructor_degree 21 (-4);
  ...
  Words.set_constructor_degree 33 (-4);
  Words.set_constructor_degree 34 (-2);
  Words.set_constructor_degree 35 (-4);
  Words.set_constructor_degree 36 (-3);
  Words.set_constructor_degree 37 (-2);
  ...
  Words.set_constructor_degree 50 (-3);
  Words.set_constructor_degree 51 0;
  ...
  Words.set_constructor_degree 126 0;
