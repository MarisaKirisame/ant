...
let populate_state () =
  ...
  add_exp
    (fun w_4 ->
      ...
      | 0 (* tag_cont_done *) -> exec_done w_4
      | 3 (* tag_cont_1 *) ->
          w_4.state.k <- get_next_cont tl_0;
          restore_env w_4 1 tl_0;
          assert_env_length w_4 2;
          let ctor_arg_0 = pop_env w_4 in
          let ctor_arg_1 = pop_env w_4 in
          push_env w_4 (Memo.appends [ Memo.from_constructor tag_Cons; ctor_arg_1; ctor_arg_0 ]);
          assert_env_length w_4 1;
          drop_n w_4 1 0;
          assert_env_length w_4 1;
          return_n w_4 1 (pc_to_exp (int_to_pc 0))
  ...
  add_exp
    (fun w_3 ->
      ...
      let cond_0 = resolve w_3 (Source.E 3) in
      ignore (pop_env w_3);
      if Word.get_value (fst cond_0) <> 0 then (
        ...
        let keep_0 = env_call w_3 [ 3 ] 1 in
